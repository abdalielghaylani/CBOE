...
namespace CambridgeSoft.NCDS_DataLoader.Controls
{
    ...
    public partial class UIBase : UserControl
    {
        ...
        public static Icon GetIcon(string vstrIcon)
        {
            ...
            // string[] strResourceNames = oAssembly.GetManifestResourceNames();
            string strName = oAssembly.GetName().Name;
            System.IO.Stream oStream = oAssembly.GetManifestResourceStream(strName + "." + "Resources" + "." + vstrIcon + ".ico");
            //System.IO.Stream oStream = oAssembly.GetManifestResourceStream("CambridgeSoft.NCDS_DataLoader.Resources.Arrow_Right_B.ico");
                ...
                case ButtonType.Next:
                    {
                        ...
                        button.Text = "Next";
                        button.Location = new System.Drawing.Point(535, 380);
                        break;
                    }
                case ButtonType.Back:
                    {
                        ...
                        button.Text = "Back";
                        button.Location = new System.Drawing.Point(460, 380);
                        break;
                    }
