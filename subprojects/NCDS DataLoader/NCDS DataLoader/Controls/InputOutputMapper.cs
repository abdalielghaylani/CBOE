...
namespace CambridgeSoft.NCDS_DataLoader.Controls
{
    public partial class InputOutputMapper : UIBase
    {
        ...
        private readonly System.Windows.Forms.CheckBox _SkipCheck= new System.Windows.Forms.CheckBox();
            ...
            get
            {
                ...
                if (_MainGridInputOutputSource != null)
                {
                    ...
                    for (int nOutputField = 0; nOutputField < _MainGridInputOutputSource.Length; nOutputField++)
                    {
                        ...
                        {
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Default:
                                {
                                    break;
                                }
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Map:
                                {
                                    EditMapping(
                            ...
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Textbox:
                                {
                                    EditMapping(
                                        _MainGridInputOutputSource,
                                        nOutputField,
                            ...
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Date:
                                {
                                    EditMapping(
                                        _MainGridInputOutputSource,
                                        nOutputField,
                            ...
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Checkbox:
                                {
                                    EditMapping(
                                        _MainGridInputOutputSource,
                                        nOutputField,
                            ...
                            case CambridgeSoft.NCDS_DataLoader.Controls.InputOutputSource.Showing.Picklist:
                                {
                                    EditMapping(
                                        _MainGridInputOutputSource,
                                        nOutputField,
            ...
            ref COEXmlTextWriter oCOEXmlTextWriter)
        {
            ...
            if (strObjectBindingType.ToLower() == "mixturecsladatasource")
            {
        ...
        public InputOutputMapper()
        {
            ...
            this._SkipCheck.AutoSize = true;
            this._SkipCheck.Name = "_SkipCheck";
            this._SkipCheck.Size = new System.Drawing.Size(86, 17);
            this._SkipCheck.TabIndex = 7;
            this._SkipCheck.Text = "Skip DuplicateCheck!";
            this._SkipCheck.UseVisualStyleBackColor = true;
            Controls.Add(_SkipCheck);
            // _LoadButton
                    ...
                    if (strObjectBindingPath.ToLower().Contains("fragmentslist"))
                    {
                        ...
                        else
                        {
                            if (index == 2)
                            {
                                ...
                                {
                                    MessageBox.Show("Fragments must be different.", "NCDS DataLoader", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                    return;
                                }
                            }
                        }
        ...
        private void InputOutputMapper_Layout(object sender, System.Windows.Forms.LayoutEventArgs e)
        {
            if ((e.AffectedComponent == e.AffectedControl) && (e.AffectedProperty == "Bounds"))
            {
                ...
                _SaveButton.Top = y;
                _LoadButton.Top = y;
                _SkipCheck.Top = y + _SkipCheck.Height/2;
                ...
                _LoadButton.Left = x;
                x += _LoadButton.Width;
                _SkipCheck.Left = x + _SkipCheck.Width/3;
                x += _SkipCheck.Width;
                if (Width < x) Width = x;
                // Horizontal
                x = 0;
                ...
                if (_MainGrid.Width != x)
                {
                    ...
                    if (x > 0)
                    {
                        ...
                        _MainGrid.ColumnStyles[3].Width = (newWidth > 0) ? ( newWidth - 50 ) : 0;
                    }
                }
        ...
        public void SetForm()
        {
            ...
            _xmlOutputFieldSpec = fr.ConfigurationSet(string.Empty, FormGroup.DisplayMode.Add, string.Empty, string.Empty, string.Empty, _HaveStructure);
