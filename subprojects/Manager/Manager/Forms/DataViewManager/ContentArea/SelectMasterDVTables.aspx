<%@ Page Language="C#" AutoEventWireup="true" Inherits="Forms_DataViewManager_ContentArea_SelectMasterDVTables" Codebehind="SelectMasterDVTables.aspx.cs" MasterPageFile="~/Forms/Master/DataViewManager.Master" EnableEventValidation="false" %>
...
<script type="text/JavaScript" language="JavaScript">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" ScriptMode="Release" AsyncPostBackTimeout="2000" />
            ...
            <td align="left">
                <asp:UpdatePanel ID="TableListUpdatePanel" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="AddSchemasUserControl" EventName="SchemaAdded" />
                        <asp:AsyncPostBackTrigger ControlID="AddSchemasUserControl" EventName="ErrorOcurred" />
                        <asp:AsyncPostBackTrigger ControlID="AddSchemasUserControl" EventName="Cancel" />
                        ...
                        <asp:AsyncPostBackTrigger ControlID="Toolbar" EventName="RefreshSchema" />
                ...
                <asp:UpdatePanel ID="ContentUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="BaseTable" style="width:558px;text-align:left;">
                            <cm:AddSchemas ID="AddSchemasUserControl" runat="server" visible="false"/>
