<%@ Control Language="C#" AutoEventWireup="true" Inherits="Forms_Public_UserControls_LabelWithPopUp" Codebehind="LabelWithPopUp.ascx.cs" %>
...
<div class="TextBoxWithPop" runat="server" id="TextBoxWithPop">
    ...
    <asp:Label runat="server" ID="MoreDetailsLabel" ></asp:Label>
</div>