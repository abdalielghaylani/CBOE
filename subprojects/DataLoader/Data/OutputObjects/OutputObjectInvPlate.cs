...
{
    /// <summary>
    /// <see cref="OutputObject"/> for adding plates to inventory
    /// </summary>
    class OutputObjectInvPlate : OutputObject
    {
        private int _nAddSubstanceTo = 0;
        private int _nDuplicateAction = 0;
        public OutputObjectInvPlate()
        {
            OutputType = "Load substances into plates in inventory";       // "Load Structures into Plates"
