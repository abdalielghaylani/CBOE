...
namespace CambridgeSoft.COE.DataLoader.Windows.Controls
{
    ...
    public partial class JobSpec : UserControl
    {
        ...
        private string _strOutputType = string.Empty;
        private string _strOutputConfiguration = string.Empty;
        private string _strInputDb = string.Empty;
        private string _strInputTable = string.Empty;
        private string _strInputConfiguration = string.Empty;
        private string _strInputFieldSort = string.Empty;
        private string _strInputFieldSpec = string.Empty;
        private Int32 _nJobCount = 0;
        private Int32 _nJobStart = 0;
        private string _strMappings = string.Empty;
        private string _strOutputDb = string.Empty;
        #endregion
        ...
        public string User
        {
            ...
            set
            {
                _strUser = (value != null) ? value : string.Empty;
        ...
        private void MappingsPopulateNode(TreeNode vtnParent, string vxmlConfiguration)
        {
            ...
            foreach (XmlNode oXmlNodeForm in oXmlNodeRoot)
            {
                TreeNode oTreeNodeForm = new TreeNode();
                string strFormText = string.Empty;
                string strFormName = string.Empty;
                {
                    XmlAttribute oXmlAttribute = oXmlNodeForm.Attributes["name"];
                    strFormName = oXmlAttribute.Value;
                }
                foreach (XmlNode oXmlNode in oXmlNodeForm)
                {
                    TreeNode oTreeNode = new TreeNode();
                    string strText = string.Empty;
                    ...
                    oTreeNode.Text = strText;
                    oTreeNodeForm.Nodes.Add(oTreeNode);
                }
                strFormText = "name: " + strFormName;
                oTreeNodeForm.Text = strFormText;
                vtnParent.Nodes.Add(oTreeNodeForm);
            }
            return;
        } // FieldSpecPopulateNode()
