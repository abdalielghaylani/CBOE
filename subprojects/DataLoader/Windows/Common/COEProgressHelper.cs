...
namespace CambridgeSoft.COE.DataLoader.Windows.Common
{
    ...
    public class COEProgressHelper
    {
        ...
        //Here we increased Progress bar Intervas from 500 to 1000.
        //To fix some progress bar display issue
        private UInt32 _uIntervalMs = 1000;
        ...
        public string StatusText
        {
            set
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        /* A GDI+ exception may occur here.
                         * This is likely caused by the progress meter itself trying to draw the bitmap outside
                         * its legal bounds (I have actually seen this affect).
                         * */
                    }
                    else
                        throw;
        ...
        public void ProgressSection(ProgressHelper_TimeConsumingCode TimeConsumingCode)
        {
            ...
            string strStatusSave = (_ToolStripStatusLabel != null) ? _ToolStripStatusLabel.Text : string.Empty;
        ...
        void COEWait_Cancel(object sender, EventArgs e)
        {
            ...
            if (CancelConfirmation != string.Empty)
            {
