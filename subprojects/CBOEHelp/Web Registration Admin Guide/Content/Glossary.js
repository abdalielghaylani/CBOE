...
xmlGlossaryData += '<html xmlns:MadCap=\"http://www.madcapsoftware.com/Schemas/MadCap.xsd\" MadCap:tocPath=\"\" MadCap:InPreviewMode=\"false\" MadCap:PreloadImages=\"false\" MadCap:RuntimeFileType=\"Glossary\" MadCap:TargetType=\"WebHelp\" lang=\"en-us\" xml:lang=\"en-us\" MadCap:PathToHelpSystem=\"../\" MadCap:HelpSystemFileName=\"Registration  Administrator Guide.xml\">';
...
xmlGlossaryData += '                    <a href=\"javascript:void(0);\" class=\"GlossaryPageTerm\" id=\"MCDropDownHotSpot_1978501909_0\" onclick=\"FMCDropDown( this ); FMCScrollToVisible( window, this.parentNode.parentNode ); return false;\">My Term</a>';
xmlGlossaryData += '                    <a name=\"1978501909_anchor1\">';
xmlGlossaryData += '                    </a>';
xmlGlossaryData += '                </div>';
xmlGlossaryData += '                <div class=\"GlossaryPageDefinition\" id=\"MCDropDownBody_1978501909_0\" style=\"display: none;\">My definition</div>';
xmlGlossaryData += '            </div>';
xmlGlossaryData += '        </div>';
xmlGlossaryData += '        <p>&#160;</p>';
