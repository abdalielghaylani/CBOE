...
namespace CambridgeSoft.COE.ConfigLoader.Data
{
    ...
    public class Job
    {
        ...
        public string InputConfiguration
        {
            ...
            set
            {
                if (Input != null)
                {
                    ...
                    if (InputConfiguration == "") Input.Configuration = strInputConfiguration;   // Silently restore iif ""
                }
                return;
            }
        } // InputConfiguration
        ...
        public string InputFieldSort
        {
            get
            {
                return (Input != null) ? Input.InputFieldSort : "";
            }
            set
            {
                if (Input != null)
        ...
        public string InputFieldSpec
        {
            get
            {
                return (Input != null) ? Input.InputFieldSpec : "";
            }
            set
            {
                if (Input != null)
        ...
        public string InputFilter
        {
            get
            {
                return (Input != null) ? Input.InputFilter : "";
            }
            set
            {
                if (Input != null)
        ...
        public string OutputConfiguration
        {
            ...
            set
            {
                if (Output != null)
                {
                    string strOutputConfiguration = OutputConfiguration;
                    Output.Configuration = value;
                    OnChanges(new JobChangesEventArgs("OutputConfiguration"));
                    if (OutputConfiguration == "") Output.Configuration = strOutputConfiguration;   // Silently restore iif ""
                }
                return;
            }
        } // OutputConfiguration
        ...
        public string OutputFieldSpec
        {
            get
            {
                return (Output != null) ? Output.OutputFieldSpec : "";
            }
        } // OutputFieldSpec
        ...
        public string OutputFilter
        {
            get
            {
                return (Output != null) ? Output.Filter : "";
            }
        } // OutputFilter
                ...
                Ph.ProgressSection(delegate() /* Job::Execute (Records?, Cancel) */
                {
                    while (cProcessed < cLimit)
                    {
                        if (Ph.IsRunning)
                        {
                            ...
                            Ph.StatusText = "Processing..." + cProcessed.ToString() + ((cLimit != int.MaxValue) ? " of " + cLimit.ToString() : "") + " processed";
                        }
                        DataSet oDataSet = null;
        ...
        public string Save()
        {
            ...
            if ((Input != null) && (Output != null))  // WJC should also check for valid
            {
                ...
                xmlSave = UIBase.FormatXmlString(xmlUgly); // OK Job::Save()
