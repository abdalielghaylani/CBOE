        ...
        public string Functions
        {
            set
            {
                ...
                foreach (XmlNode oXmlNodeFunction in oXmlNodeFunctions)
                {
                    ...
                    {
                        int cArguments = 0;
                        //Coverity fix - CID 11717
                        XmlNode objoXmlNodeFunction = oXmlNodeFunction.SelectSingleNode("arguments");
                        if (objoXmlNodeFunction != null)
                        {
                            foreach (XmlNode oXmlNodeArgument in objoXmlNodeFunction)
                            {
                    ...
                    //Coverity fix - CID 11717
                    if (oTreeNodeReturns != null)
                    {
                        if (oTreeNodeSignature != null)
                        {
