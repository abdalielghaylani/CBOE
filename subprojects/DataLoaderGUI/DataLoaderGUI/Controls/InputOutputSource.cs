...
namespace CambridgeSoft.DataLoaderGUI.Controls
{
    ...
    public partial class InputOutputSource : UserControl
    {
        ...
        #region data
        private CambridgeSoft.DataLoaderGUI.Forms.CalculationBox _CalculationBox = null;
        ...
        public string OutputType
        {
            ...
            get
            {
                return _eOutputType.TypeValue.ToString();
            }
        ...
        {
            get { return _Text_RichTextBox.Text; }
        }
        ...
        public bool CheckResult
        {
            get
            {
                return _Checked_Checkbox.Checked;
            }
        }
            ...
            set
            {
                if (_WhichShowing != value)
                {
                    ...
                    if (ctlTo != null)
                    {
                        ...
                        if (_ControlShowing == _Calculation_RichTextBox) _Calculation_PictureBox.Visible = true;
        ...
        public void GetMapping(XmlTextWriter voCOEXmlTextWriter, string vstrFields)
        {
            ...
            switch (_WhichShowing)
            {
                ...
                case Showing.Map:
                    {
                        if (_FieldList_ComboBox.SelectedItem != null)
                        {
                ...
                case Showing.Textbox:
                    {
                        ...
                        voCOEXmlTextWriter.WriteAttributeString("value", _Text_RichTextBox.Text);
                        break;
                    }
            }
