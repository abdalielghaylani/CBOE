...
namespace CambridgeSoft.DataLoaderGUI.Controls
{
    public partial class InputFileChooser : UIBase 
    {
        ...
        private int _endAt = 0;
        private bool _noStructure = false;
        ...
        public bool HaveStructure
        {
            get
            {
                return !_noStructure;//!_noStructureCheckBox.Checked;
            }
        }

        /// <summary>
        /// Get property to return the known regNum selection value
        /// </summary>
        public bool KnownRegNum
        {
            get
            {
                return RegisterKnownRegCheckBox.Checked;
            }
        }
        ...
        public int StartAt
        {
            get
            {
                _startAt = string.IsNullOrEmpty(StartAtRecordTextBox.Text) ? 0 : Convert.ToInt32(StartAtRecordTextBox.Text);
                return _startAt;
            }
        }
        ...
        public int EndAt
        {
            get
            {
                _endAt = string.IsNullOrEmpty(EndAtRecordTextBox.Text) ? 0 : Convert.ToInt32(EndAtRecordTextBox.Text);
                return _endAt;
            }
        }
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            try
            {
                this.Filter = "SD files (*.sdf)|*.sdf|Text files (*.txt)|*.txt|Microsoft Excel Files (*.xls;*.xlsx)|*.xls;*.xlsx|CSV files (*.csv)|*.csv";
                ...
                else if (_InputFileTextBox.Text.ToLower().EndsWith(".csv"))
                {
