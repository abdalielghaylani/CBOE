...
namespace CambridgeSoft.COE.DataLoader.Core.DataMapping
{
    ...
    public class MockRegistryRecord : IDestinationRecord
    {
        ...
        #region IDestinationRecord Members
        ...
        /// <summary>
        /// we currently return null because this mock object does not have validation rules
        /// </summary>
