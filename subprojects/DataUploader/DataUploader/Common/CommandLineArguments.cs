            ...
            private bool ParseValue(Type type, string stringData, out object value)
            {
                ...
                if ((stringData != null || type == typeof(bool)) && (stringData == null || stringData.Length > 0))
                {
                    try
                    {
                        ...
                        {
                            if (stringData == null || stringData == "+" || stringData.ToLower()=="true")
                            {
                                value = true;
                                return true;
                            }
                        ...
                        else
                        {
                            ...
                            {
                                //JED: modified to eliminate case-sensitivity
                                if (name.ToLower() == stringData.ToLower())
                                {
                                    stringData = name;
                                    valid = true;
                                    break;
                            ...
                            {
                                //JED: modified to allow numeric matching
                                foreach (int number in Enum.GetValues(type))
                                {
                                    int intData = -1;
