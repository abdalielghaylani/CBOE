...
Insert into coedb.coedataview (ID,	NAME,	DESCRIPTION,	USER_ID,	IS_PUBLIC,	FORMGROUP,	DATE_CREATED,	DATABASE, COEDATAVIEW	)values(2000,'ChemACX','','COEDB',1,0,sysdate,'CHEMACXDB',
