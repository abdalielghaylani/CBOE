...
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_log.trg"
...
@"sql\Patches\Patch &&currentPatch\sql\Packages\pkg_PartitionManagment.sql"
...
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_sites.trg"
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_people.trg"
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_security_roles.trg"
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_privilege_tables.trg"
@"sql\Patches\Patch &&currentPatch\sql\triggers\coedb_coepagecontrol.trg"
...
@"sql\Patches\Patch &&currentPatch\sql\CsSecurity\CREATE_Audit_Tables.sql"
...
@"sql\Patches\Patch &&currentPatch\sql\Procedures.sql"
SHO ERR
@"sql\Patches\Patch &&currentPatch\sql\Functions.sql"
SHO ERR
...
@"sql\Patches\Patch &&currentPatch\sql\packages\PKG_CoeDbLibrary.SQL"
@"sql\Patches\Patch &&currentPatch\sql\packages\pkg_ConfigurationManager.sql"
SHO ERR
PROMPT
