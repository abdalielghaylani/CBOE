...
namespace CambridgeSoft.COE.Framework.UnitTests.Helpers
{
    internal class SearchHelper
    {
        ...
        {
            return Assembly.GetExecutingAssembly().Location.Substring(0, Assembly.GetExecutingAssembly().Location.IndexOf("TestResults")) + @"CambridgeSoft.COE.Framework.UnitTests\" + strExtendedPath;
        }
        /// <summary>
        /// Create dataview 
        /// </summary>
