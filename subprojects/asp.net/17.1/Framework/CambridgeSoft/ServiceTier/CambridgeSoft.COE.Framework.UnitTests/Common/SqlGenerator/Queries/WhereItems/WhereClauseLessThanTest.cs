...
{
    /// <summary>
    ///This is a test class for CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems.WhereClauseLessThan and is intended
    ///to contain all CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems.WhereClauseLessThan Unit Tests
    ///</summary>
    [TestClass()]
    public class WhereClauseLessThanTest
    {
        ...
        public void LessEqualTest()
        {
            ...
            values_expected.Add(new Value("C1CCCC1", target.DataField.FieldType));

            string expected = "(LTRIM(\"Formula\") <= :0)";
            string actual;

            actual = target.Execute(dataBaseType, values);

            Assert.IsTrue(CompareElements(values_expected, values), "values_GetDependantString_expected was not set correctly.");
            Assert.AreEqual(expected, actual, "CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems.WhereClauseLes" +
                    "sThan.GetDependantString did not return the expected value.");
        }
        ...
        [TestMethod()]
        public void GetDependantStringWhereClauseLessThanTest()
        {
            WhereClauseLessThan target = new WhereClauseLessThan();
            target.DataField = new Field();
            target.DataField.FieldName = "Formula";
            ...
            string expected = "(TRIM(\"Formula\") < :0)";
            string actual;
        ...
        /// <summary>
        /// Unit Test For WhereClauseLessThan :String 
        /// </summary>
        [TestMethod()]
        public void GetDependantStringWhereClauseNameLessThanTest()
        {
            try
            {
                WhereClauseLessThan target = new WhereClauseLessThan();
        ...
        [DeploymentItem("CambridgeSoft.COE.Framework.dll")]
        [TestMethod()]
        public void GetDependantStringWhereClauseLessThan_IntegerTest()
        {
            try
            {
                WhereClauseLessThan target = new WhereClauseLessThan();
