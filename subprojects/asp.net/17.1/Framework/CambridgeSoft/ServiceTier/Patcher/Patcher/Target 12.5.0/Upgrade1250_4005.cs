...
{
    /// <summary>
    /// Patch to update missing xml configuration in 4005.xml from upgrade [1210_1250].
    /// </summary>
    class Upgrade1250_4005 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            if (!_errorsInPatch)
                messages.Add("Upgrade1250_4005 Workflow was successfully fixed.");
            else
                messages.Add("Upgrade1250_4005 Workflow  was fixed with partial update.");
            return messages;
        }
            ...
            try
            {
                ...
                if (_newNode == null)
                {
                    ...
                    if (InsertNode(_parentNode, _newNode, _insertBefore, _insertAfter))
                        return "Form[4005]: " + _newElementPath + " was added succesfully.";
                    else
                        return "Form[4005]: " + _newElementPath + " was not added due to errors.";
                }
                else
                {
                    _errorsInPatch = true;
                    return "Form[4005]: " + _newElementPath + " was already available.";
                }
            }
            catch (Exception ex)
