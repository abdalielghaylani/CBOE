...
{
    /// <summary>
    /// Patch to update missing xml configuration in 4011.xml from upgrade [1210_1250].
    /// </summary>
    class Upgrade1250_4011 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            #region TrueString
            coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:viewMode/COE:formElement[@name='NormalizedStructure Detail Lbl']/COE:configInfo/COE:fieldConfig";
            InnerText = "true";
            status = ManipulateNode(coeFormPath, "TrueString", "FalseString", "CSSClass");
            messages.Add(status);
            Reset();
            #endregion
            ...
            coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:viewMode/COE:formElement[@name='NormalizedStructure Detail Lbl']/COE:configInfo/COE:fieldConfig";
            InnerText = "false";
            status = ManipulateNode(coeFormPath, "FalseString", "", "TrueString");
            messages.Add(status);
            Reset();
             #endregion
            ...
            #region TextMode
            coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:viewMode/COE:formElement[@name='STRUCT_COMMENTS']/COE:configInfo/COE:fieldConfig";
            InnerText = "MultiLine";
            status = ManipulateNode(coeFormPath, "TextMode", "", "CSSClass");
            messages.Add(status);
            Reset();
            #endregion
            ...
            if (!_errorsInPatch)
                messages.Add("Upgrade1250_4011 Workflow was successfully fixed.");
            else
                messages.Add("Upgrade1250_4011 Workflow  was fixed with partial update.");
            return messages;
        }
