...
namespace CambridgeSoft.COE.Patcher
{
    ...
    /// </summary>
    public class MigCOEFormGroup4011 : BugFixBaseCommand
    {
        public override List<string> Fix(List<XmlDocument> forms, List<XmlDocument> dataviews, List<XmlDocument> configurations, XmlDocument objectConfig, XmlDocument frameworkConfig)
        {
            ...
            foreach(XmlDocument doc in forms)
            {
                ...
                if (id == "4011")
                {
                    messages.Add("Processing 4011 formGroup xml.");
                    ...
                    try
                    {
                        ...
                        XmlNode CoeFormId0_editMode_IdentifiersLabel = doc.SelectSingleNode("//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='0']/COE:editMode/COE:formElement[@name='Identifiers']/COE:label/text()", manager);
                        ...
                        if (CoeFormId0_editMode_IdentifiersLabel != null &&
                            !CoeFormId0_editMode_IdentifiersLabel.Value.Equals("Registry Identifiers"))
                        {
                            CoeFormId0_editMode_IdentifiersLabel.Value = "Registry Identifiers";
                        ...
                        XmlNode CoeFormId1_cilentScript = doc.SelectSingleNode("//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:cilentScript", manager);
                        ...
                        if (CoeFormId1_cilentScript != null)
                        {
                            XmlNode CoeFormId1 = doc.SelectSingleNode("//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']");
                            CoeFormId1.RemoveChild(CoeFormId1_cilentScript);
                            messages.Add("Client script has been removed.");
                        }
                        ...
                        if (doc.SelectSingleNode("//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:viewMode/COE:formElement[@name='STRUCT_COMMENTS']", manager) == null)
                        {
                            ...
                            CoeFormId1_viewMode_StructComments.InnerXml = XmlDepository.ReadonlyStructureComments;
                        }
                    ...
                    if (errorInPath == true)
                    {
                        messages.Add("Rollback changes to formGroup 4011, fali to migrate 4011 formGroup xml.");
                        doc.Load(originalForm_OuterXml);
                    }
                    else
                    {
                        messages.Add("4011 processing finished. Succeed to migrate 4011 formGroup xml.");
                    }
                }
            }
...
";
            ...
            public const string ReadonlyStructureComments = @"
              <label xmlns=""COE.FormGroup"">Structure Comments</label>
              <showHelp xmlns=""COE.FormGroup"">false</showHelp>
              <isFileUpload xmlns=""COE.FormGroup"">false</isFileUpload>
              <pageComunicationProvider xmlns=""COE.FormGroup""/>
