...
{
    /// <summary>
    /// COE Web Control to work with numeric fields (E.g 10.000).
    /// </summary>
    /// <summary>
    /// <para>
    /// This class implements a Numeric TextBox control that may be used inside a <see cref="COEFormGenerator"/>.
    /// </para>
    /// <para>
    /// The COECurrencyEdit class accepts every WebNumericEdit(Infragistics) property to be set, but as ICOEGenerable control it also provides
    ...
    ///                     &lt;formElement&gt;
    ///                        &lt;Id&gt;AM_Total&lt;/Id&gt;
    ///                        &lt;bindingExpression&gt;MW&lt;/bindingExpression&gt;
    ///                        &lt;configInfo&gt;
    ///                          &lt;fieldConfig&gt;
    ///                            &lt;configSetting bindingExpression="this.ID"&gt;UniqueID01&lt;/configSetting&gt;
    ///                            &lt;configSetting bindingExpression="this.CssClass"&gt;COENumericEdit&lt;/configSetting&gt;
    ///                            &lt;configSetting bindingExpression="this.ReadOnly"&gt;true&lt;/configSetting&gt;
    ///                          &lt;/fieldConfig&gt;
    ///                        &lt;/configInfo&gt;
    ///                        &lt;displayInfo&gt;
    ///                          &lt;type>CambridgeSoft.COE.Framework.Controls.COEFormGenerator.COENumericEdit&lt;/type>
    ///                        &lt;/displayInfo&gt;
    ///                      &lt;/formElement&gt;
    /// </code>
    /// </summary>
    [ToolboxData("<{0}:COENumericEdit runat=server></{0}:COENumericEdit>")]
    public class COENumericEdit : WebNumericEdit, ICOEGenerableControl, ICOELabelable, ICOECultureable
    {
        #region Variables
