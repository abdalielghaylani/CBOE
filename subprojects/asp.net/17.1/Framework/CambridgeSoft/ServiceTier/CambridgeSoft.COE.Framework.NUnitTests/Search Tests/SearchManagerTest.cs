...
namespace CambridgeSoft.COE.Framework.Services.Search.UnitTests
{
    ...
    public class SearchManagerTestBU
    {
        ...
        private string pathToXmls = SearchHelper.GetExecutingTestResultsBasePath(string.Empty);
        int hitlistId = -1;
        ...
        public void FormulaCommandGetHitListTest()
        {
            ...
            try
            {
                ...
                item.ID = 1;
                item.TableId = 3;
                item.Criterium = new SearchCriteria.FormulaCriteria("C5-10Br2-4", "cscartridge");
                searchCriteria.Items.Add(item);
        ...
        public void MolWeightCommandGetHitListTest()
        {
            ...
            try
            {
                ...
                SearchCriteria.MolWeightCriteria molWeightCriteria = new SearchCriteria.MolWeightCriteria();
...
AAAAAA==')");
        ...
        //Failed : CHEMINVDB2.CSDOHITLIST table not present
        ...
        public void DoSearchWithPagingTest()
        {
           ...
           */
            ...
            {
                Assert.Inconclusive("CHEMINVDB2.CSDOHITLIST table not present");
            }
        }
