...
namespace CambridgeSoft.COE.Framework.Common.UnitTests
{
    ...
    public class SerializationTest
    {
        ...
        private string pathToXmls = AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("CambridgeSoft.COE.Framework.NUnitTests")) + @"CambridgeSoft.COE.Framework.NUnitTests" + @"\Serialization XML";
