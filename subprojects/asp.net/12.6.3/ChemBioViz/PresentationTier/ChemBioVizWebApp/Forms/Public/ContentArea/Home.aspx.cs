...
public partial class Forms_ContentArea_Home : GUIShellPage
{
    ...
    {
        ApplicationHome homeData = CambridgeSoft.COE.Framework.COEConfigurationService.ConfigurationUtilities.GetApplicationHomeData("CHEMBIOVIZ");
        ...
        for(int i = 0; i < homeData.Groups.Count; i++)
        {
            ...
            if((myGroup != null) && (myGroup.COEIdentifier == "CHEMBIOVIZ")) //isolate just to chembioviz' panels
            {
    ...
    protected override void SetControlsAttributtes()
    {
        ...
        this.Page.Title = Resources.Resource.ChemBioViz_Page_Title;
        Utilities.WriteToAppLog(GUIShellTypes.LogMessageType.EndMethod, MethodBase.GetCurrentMethod().Name);
    }
    #endregion
}
