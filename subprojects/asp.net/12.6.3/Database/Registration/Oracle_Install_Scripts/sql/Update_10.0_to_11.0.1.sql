...
DROP TABLE FRAGMENTS CASCADE CONSTRAINTS;
...
UPDATE IDENTIFIERS SET Active='T',Name =IDENTIFIER_DESCRIPTOR;
COMMIT;
...
CREATE TABLE DUPLICATES(ID  NUMBER(8),RegNumber VARCHAR2(50),RegNumberDuplicated VARCHAR2(50),PersonID NUMBER(8), Created DATE);
...
CREATE SEQUENCE SEQ_DUPLICATES
  START WITH 1
...
ALTER TABLE PROJECTS ADD ACTIVE NCHAR(1) NULL;
...
INSERT INTO REGDB.VW_FRAGMENT(FRAGMENTID) VALUES(1);
