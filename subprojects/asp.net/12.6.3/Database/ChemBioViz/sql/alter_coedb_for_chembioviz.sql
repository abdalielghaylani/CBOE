...
-- This script creates roles and privileges for ChemBioViz
...
CREATE TABLE  &&privTableName (
	...
	CBV_CAN_SEARCH NUMBER(1,0) null,
	CBV_CAN_EDIT_FORMS NUMBER(1,0) null,
	CBV_CAN_SAVE_PUBLIC_FORM NUMBER(1,0) null,
	CBV_CAN_SAVE_DEFAULT_SETTINGS NUMBER(1,0) null,
...
INSERT INTO &&privTableName(ROLE_INTERNAL_ID,CBV_CAN_SEARCH, CBV_CAN_EDIT_FORMS, CBV_CAN_SAVE_PUBLIC_FORM, CBV_CAN_SAVE_DEFAULT_SETTINGS) VALUES (SECURITY_ROLES_SEQ.CURRVAL, '1','0', '0','0');
...
INSERT INTO &&privTableName(ROLE_INTERNAL_ID,CBV_CAN_SEARCH, CBV_CAN_EDIT_FORMS, CBV_CAN_SAVE_PUBLIC_FORM, CBV_CAN_SAVE_DEFAULT_SETTINGS) VALUES (SECURITY_ROLES_SEQ.CURRVAL, '1','1', '1','1');
Commit;
