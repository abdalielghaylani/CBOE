...
{
    /// <summary>
    ///This is a test class for CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems.WhereClauseStructure and is intended
    ///to contain all CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems.WhereClauseStructure Unit Tests
    ///</summary>
    [TestFixture]
    public class WhereClauseStructureTest
    {
       ...
       // [DeploymentItem("CambridgeSoft.COE.Framework.dll")]
        ...
        {
            WhereClauseStructure target = new WhereClauseStructure();
            ...
            //ApplicationData appConfigData = ConfigUtils.GetApplicationData("SAMPLE");
            ...
            values_expected.Add(new Value("15", System.Data.DbType.String));
            values_expected.Add(new Value("absoluteHitsRel=NO, relativeTetStereo=NO, tetrahedralStereo=Yes, simThreshold=90, reactionCenter=YES, full=NO, tautomer=NO, fragmentsOverlap=NO, permitExtraneousFragmentsIfRXN=NO, permitExtraneousFragments=NO, doubleBondStereo=YES, hitAnyChargeHetero=YES, identity=NO, hitAnyChargeCarbon=YES, similar=NO", System.Data.DbType.String));

            string expected = chemistryEngineSchema + ".MoleculeContains(\"Base64_cdx\", :0, '', :1)=1";
            ...
            Assert.AreEqual(expected, actual, "WhereClauseStructure.GetDependantString did not return the expected value.");
