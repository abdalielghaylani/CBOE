// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SelectClauseDirectFormula.cs" company="PerkinElmer Inc.">
...
namespace CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.SelectItems
{
    ...
    /// <summary>
    /// This class to generate a "molfmla(field)" SQL Statement for Direct Cartridge.
    /// </summary>
    internal class SelectClauseDirectFormula : SelectClauseItem, ISelectClauseParser
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectClauseDirectFormula"/> class to its default values. 
        /// </summary>
        public SelectClauseDirectFormula()
        {
            Sortable = false;
        }
        #endregion
        ...
        public SelectClauseItem CreateInstance(System.Xml.XmlNode resultsXmlNode, MetaData.INamesLookup dvnLookup)
        {
            ...
            var item = new SelectClauseDirectFormula();
        ...
        /// </param>
        /// <returns>
        /// A string containing the select part corresponding to this clause (i.e. the CsCartridge.ConvertCDX.CDXToFormula(fieldName,''))
        /// </returns>
        protected override string GetDependantString(DBMSType dataBaseType, List<Value> values)
        {
            ...
            {
                builder.Append("mdlaux.molfmla(NULL, 'SMILES:'||");
            }
            else
            {
                builder.Append("mdlaux.molfmla(NULL, ");
            }
