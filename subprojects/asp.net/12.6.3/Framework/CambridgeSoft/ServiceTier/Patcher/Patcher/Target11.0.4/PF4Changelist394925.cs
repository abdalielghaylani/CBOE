...
namespace CambridgeSoft.COE.Patcher
{
    ...
    /// </summary>
    class PF4Changelist394925 : BugFixBaseCommand
    {
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            if (frameworkConfig != null)
            {
                ...
                try
                {
                    string BATCHNUMBERLENGTH_XPath = "/configuration/coeConfiguration/applications/add[@name='REGISTRATION']/tableEditor/add[@name='VW_SEQUENCE']/tableEditorData/add[@name='BATCHNUMBERLENGTH']";
                    if (frameworkConfig.SelectSingleNode(BATCHNUMBERLENGTH_XPath) == null)
                    {
                        XmlNode REGISTRATIONTableEditorData = frameworkConfig.SelectSingleNode("/configuration/coeConfiguration/applications/add[@name='REGISTRATION']/tableEditor/add[@name='VW_SEQUENCE']/tableEditorData");
                        XmlNode BATCHNUMBERLENGTH = frameworkConfig.CreateElement("add");

                        XmlAttribute name = frameworkConfig.CreateAttribute("name");
                        name.Value = "BATCHNUMBERLENGTH";
