...
{
    /// <summary>
    /// Upgrade the CBVExcel link for 1240
    /// </summary>
    public class UpgradeCBVExcelLinkTo1240 : BugFixBaseCommand
    {
        public override List<string> Fix(List<XmlDocument> forms, List<XmlDocument> dataviews, List<XmlDocument> configurations, XmlDocument objectConfig, XmlDocument frameworkConfig)
        {
            ...
            {
                if (excelLinkNode.Attributes["url"].Value.ToLower() != "/cfserverasp/clients/chembiovizexcel addin/chembiovizexceladdin1240.exe")
                {
                    messages.Add("CBVExcel url was successfully updated");
                    excelLinkNode.Attributes["url"].Value = "/cfserverasp/Clients/ChemBioVizExcel Addin/ChemBioVizExcelAddin1240.exe";
                }
                else
