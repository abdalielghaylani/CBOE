                  ...
                  <template match="COEConfig">
                    <children>
                      <template match="FrameworkConfig">
                        <children>
                          <template match="MessagingTypes">
                            <children>
                              <template match="MessagingType">
                                <children>
                                  <template match="@schema">
                                    <children>
                                      <condition>
                                        ...
                                        <styles />
                                        <children>
                                          <conditionbranch xpath="../@configEditorName=&quot;COE DataView&quot; and ../@name=&quot;dataView&quot; and ../../@configEditorName=&quot;Messaging Types&quot; and ../../../@name=&quot;Global&quot;">
                                            <editorproperties />
                                            <properties />
                                            <styles />
                                            <children>
