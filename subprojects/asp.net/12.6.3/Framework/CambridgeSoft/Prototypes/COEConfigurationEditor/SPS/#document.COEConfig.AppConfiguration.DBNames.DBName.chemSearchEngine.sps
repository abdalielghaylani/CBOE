                  ...
                  <template match="COEConfig">
                    <children>
                      <template match="AppConfiguration">
                        <children>
                          <template match="DBNames">
                            <children>
                              <template match="DBName">
                                <children>
                                  <template match="chemSearchEngine">
                                    <children>
                                      <template match="@type">
                                        <children>
                                          <condition>
                                            ...
                                            <styles />
                                            <children>
                                              <conditionbranch xpath="../@configEditorName=&quot;Chemical Search Engine&quot; and ../../@configEditorName=&quot;CHEMINVDB2&quot; and ../../@name=&quot;CHEMINVDB2&quot; and ../../../@configEditorName=&quot;Databases&quot; and ../../../../@configEditorName=&quot;Inventory&quot;">
                                                <editorproperties />
                                                <properties />
                                                <styles />
                                                <children>
