...
namespace CambridgeSoft.COE.Framework.Controls.COEFormGenerator
{
    ...
    public class SaltAndBacthSuffixTextBox : TextBox, ICOEGenerableControl, ICOELabelable, ICOERequireable, ICOEDesignable, ICOEHelpContainer, ICOEReadOnly
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (HttpContext.Current.Session[RegistrationWebApp.Constants.MultiCompoundObject_Session] != null)
            {
                try
                {
                    RegistryRecord registryRecord = (RegistryRecord)(HttpContext.Current.Session[RegistrationWebApp.Constants.MultiCompoundObject_Session]);
