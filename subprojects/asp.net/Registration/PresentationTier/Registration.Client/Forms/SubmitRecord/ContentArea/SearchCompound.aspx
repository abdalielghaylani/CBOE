<%@ Page Language="C#" MasterPageFile="~/Forms/Master/Registration.Master" AutoEventWireup="true" CodeBehind="SearchCompound.aspx.cs" Inherits="PerkinElmer.CBOE.Registration.Client.Forms.SubmitRecord.ContentArea.SearchCompound" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <table class="PagesContentTable" style="margin-left:2px;">
       ...
       <tr runat="server" id="ComponentToolBar">
        ...
        <tr>
            <td colspan="2">
                <iframe id="SearchComponentFrame" runat="server" style="width:100%;" scrolling="no"></iframe>
            </td>
        </tr>
    </table>
</asp:Content>
