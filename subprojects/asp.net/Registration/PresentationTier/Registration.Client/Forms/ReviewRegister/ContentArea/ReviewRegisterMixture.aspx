<%@ Page Language="C#" MasterPageFile="~/Forms/Master/Registration.Master" AutoEventWireup="true"
    Codebehind="ReviewRegisterMixture.aspx.cs" Inherits="PerkinElmer.CBOE.Registration.Client.Forms.ReviewRegister.ContentArea.ReviewRegisterMixture"
    ...
    <table class="PagesContentTable" cellspacing="1" cellpadding="2">
        <tr class="PagesToolBar">
            ...
            <td align="left" style="white-space: nowrap">
                <asp:Button SkinID="ButtonBig" ID="CancelButton" runat="server" Visible="False" CausesValidation="False"
                    OnClick="CancelButton_Click" />
                <asp:Button SkinID="ButtonBig" ID="GoHomeButton" runat="server" Visible="False" CausesValidation="False"
                    OnClick="GoHomeButton_Click" />
                <input id="BackButton" runat="server" class="ButtonBig" type="button" onclick="history.back(-1);" visible="false" />
                <asp:Button SkinID="ButtonBig" ID="EditButton" runat="server" CausesValidation="False"
                    OnClick="EditButton_Click" />
                <asp:Button SkinID="ButtonBig" ID="RegisterButton" runat="server" OnClick="RegisterButton_Click" />
                <asp:Button SkinID="ButtonBig" ID="SubmitButton" runat="server" Visible="False" OnClick="SubmitButton_Click" />
                <asp:Button SkinID="ButtonBig" ID="DoneButton" runat="server" OnClick="DoneButton_Click"
                    Visible="false" />
                <asp:Button SkinID="ButtonBig" ID="SearchTempButton" runat="server" OnClick="SearchTemp_Click"
                ...
                <div style="float: right;">
                    ...
                    <uc4:MenuButton ID="DefineMixtureImageMenuButton" runat="server" CausesValidation="false"
                        ...
                        <MenuItemList>
                            ...
                            <uc4:MenuItem CommandName="DeleteComponent" enabled="false" />
                        </MenuItemList>
                    </uc4:MenuButton>
        ...
        <tr>
            <td colspan="3">
                ...
                <uc1:MessageBox ID="CompoundDuplicatesMessageBox" runat="server" OnBtn1Clicked="CompoundDuplicatesMessageBox_AcceptButtonClicked">
                </uc1:MessageBox>
                ...
                <cc1:CslaDataSource ID="BatchComponentFragmentsCslaDataSource" runat="server" OnSelectObject="BatchComponentFragmentsCslaDataSource_SelectObject"
                    TypeAssemblyName="CambridgeSoft.COE.Registration.Services" TypeName="CambridgeSoft.COE.Registration.Services.Types.BatchComponent"
                    OnUpdateObject="BatchComponentFragmentsCslaDataSource_UpdateObject">
                </cc1:CslaDataSource>
