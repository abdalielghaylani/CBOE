<%@ Page Language="C#" MasterPageFile="~/Forms/Master/Registration.Master" AutoEventWireup="true"
    Codebehind="ComponentDuplicates.aspx.cs" Inherits="PerkinElmer.COE.Registration.Server.Forms.ComponentDuplicates.ContentArea.ComponentDuplicates"
        ...
        <tr>
            <td colspan="3">
                <cc1:CslaDataSource ID="DuplicatesCslaDataSource" runat="server"
                    ...
                    TypeName="CambridgeSoft.COE.PerkinElmer.COE.Registration.Server.Forms.ComponentDuplicates.ContentArea.DuplicatesResolver">
                </cc1:CslaDataSource>
