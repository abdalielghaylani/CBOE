<%@ Control Language="C#" AutoEventWireup="true" Codebehind="AddInList.ascx.cs" Inherits="PerkinElmer.COE.Registration.Server.Forms.RegistrationAdmin.UserControls.AddInList" %>
