<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegistryRecordNavigation.ascx.cs" Inherits="PerkinElmer.COE.Registration.Server.Forms.Public.UserControls.RegistryRecordNavigation" %>
