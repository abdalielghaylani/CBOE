<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RegistryRecordNavigation.ascx.cs" Inherits="PerkinElmer.CBOE.Registration.Client.Forms.Public.UserControls.RegistryRecordNavigation" %>
