<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MessagesBox.ascx.cs" Inherits="PerkinElmer.COE.Registration.Server.Forms.Public.UserControls.MessagesBox" %>
...
<script src="/COERegistration/Forms/Public/JScripts/MessagesBox.js" type="text/javascript">
</script>
...
">
	...
	font-size: 1.1em;"><asp:Label ID="lblTitle" runat="server"></asp:Label></div>
			<div runat="server" id="popupControls" style="float: right;cursor: pointer;">
			...
			<table   runat="server" id="Maintable" name="Maintable" style="" width="100%" height="100%" border="0">
				...
				<tr align="center">
					...
					<td valign="bottom" align="right" style="height: 26px"><asp:button id="btn1" runat="server" Text="Button"  CssClass="button" 
							...
							OnClick="btn2_Click" Width="90px" OnClientClick="hidePopWin();" CausesValidation="false"></asp:button><asp:button id="btn3" runat="server" Text="Button" 
