...
<%@ Register Assembly="CambridgeSoft.COE.Framework, Version=17.1.1.0, Culture=neutral, PublicKeyToken=1e3754866626dfbf"
...
<asp:Content ID="PagesContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="FormBrowserDiv" style="text-align: right">
        ...
        <asp:DropDownList ID="FormsDropDownList" runat="server" OnSelectedIndexChanged="FormsDropDownList_SelectedIndexChanged"
    ...
    <div class="ButtonsToolBar">
        <div style="float: right; margin-right: 70px;">
            <ChemBioViz:MenuButton ID="SearchQueryMenuButton" runat="server" CausesValidation="false"
                Text="Restore Query" EnableMenu="true" LeftImageURL="~/App_Themes/Common/Images/RestoreQuery.png">
                <MenuItemList>
        ...
        <div class="MainButtonContainer">
           <%-- <asp:Panel ID="panExportpopup" runat="server" BorderColor="white" BorderWidth="1">
            ...
            <ChemBioViz:ImageButton ID="SearchImageButton" runat="server" TypeOfButton="Search"
                ButtonMode="Txt" CausesValidation="true" />
            <ChemBioViz:ImageButton ID="ClearImageButton" runat="server" TypeOfButton="Clear"
                ButtonMode="Txt" CausesValidation="false" OnClientClick="return coe_clearForm();"
                UseSubmitBehavior="false" />
            <ChemBioViz:ImageButton ID="RetrieveAllImageButton" runat="server" TypeOfButton="RetrieveAll"
                ButtonMode="Txt" CausesValidation="false" />
            <ChemBioViz:MenuButton ID="NewQueryMenuButton" runat="server" CausesValidation="false"
                Text="New Query" EnableMenu="false" LeftImageURL="~/App_Themes/Common/Images/NewQuery.png" />
            <ChemBioViz:MenuButton ID="RefineImageMenuButton" runat="server" CausesValidation="false"
                Text="Refine" EnableMenu="true" LeftImageURL="~/App_Themes/Common/Images/Refine.png">
                <MenuItemList>
            ...
            <ChemBioViz:MenuButton ID="QueryMenuButton" runat="server" CausesValidation="false"
                Text="Query" EnableMenu="true" LeftImageURL="~/App_Themes/Common/Images/Query.png">
                <MenuItemList>
            ...
            <ChemBioViz:MenuButton ID="MarkedMenuButton" runat="server" CausesValidation="false"
                Text="Marked" EnableMenu="true" LeftImageURL="~/App_Themes/Common/Images/Marked.png">
                <MenuItemList>
            ...
            <ChemBioViz:MenuButton ID="HitsMenuButton" runat="server" CausesValidation="false"
                Text="Return To Hits" EnableMenu="false" LeftImageURL="~/App_Themes/Common/Images/ReturnToHits.png" />
            <ChemBioViz:MenuButton ID="PrintMenuButton" runat="server" CausesValidation="false"
                Text="Print" EnableMenu="false" LeftImageURL="~/App_Themes/Common/Images/Print.png"
                OnClientClick="return PrintFormGenerator();" />
                ...
                <asp:ImageButton ID="imgExport" runat="server" ImageUrl="../../../App_Themes/Common/Images/Export.png"
                    OnClientClick="javascript:return flipVisibility(this,'imgExport');" />
            ...
            <asp:DropDownList ID="GridSizeDropDownList" runat="server" OnSelectedIndexChanged="GridSizeDropDownList_SelectedIndexChanged"
                AutoPostBack="true" Visible="false" CssClass="HitsPerPage">
                <asp:ListItem Value="5" Text="5"></asp:ListItem>
                <asp:ListItem Value="10" Text="10"></asp:ListItem>
                <asp:ListItem Value="25" Text="25"></asp:ListItem>
                <asp:ListItem Value="50" Text="50"></asp:ListItem>
                <asp:ListItem Value="100" Text="100"></asp:ListItem>
            </asp:DropDownList><label id="LabelForGridSize" runat="server" class="HitsPerPage"
                style="padding-left: 1px; margin-left: 0px;"></label>
        </div>
        <div>
    ...
    <div class="FormGenContainer" style="position: absolute; width: 660px;"> 
        <asp:UpdatePanel runat="server" ID="MainUpdatePanel">
            <ContentTemplate>
                <div id="PagerDiv">
                    <cc2:PagerControl ID="CoePagerControl" runat="server" OnCurrentPageChanged="CoePagerControl_CurrentPageChanged"
                        SkinID="COEPagerControl" />
        ...
        <div style="overflow: auto;" id="NoRecordsFoundDiv" runat="server" visible="false">
            <asp:Label ID="NoRecordsFoundLabel" ForeColor="DarkRed" Visible="false" runat="server"
        ...
        <asp:UpdatePanel runat="server" ID="BottomPagerUpdatePanel">
            <ContentTemplate>
                <div id="BottomNavDiv" style="clear:both;">
                    ...
                    <cc2:PagerControl ID="CoePagerControlBottom" runat="server" OnCurrentPageChanged="CoePagerControl_CurrentPageChanged"
                        SkinID="COEPagerControl" />
                </div>
            </ContentTemplate>
            <Triggers>
    ...
    <cc1:CslaDataSource ID="ChemBioVizSearchCSLADataSource" runat="server" OnSelectObject="CslaDataSource_SelectObject"
        OnUpdateObject="CslaDataSource_UpdateObject">
    </cc1:CslaDataSource>
