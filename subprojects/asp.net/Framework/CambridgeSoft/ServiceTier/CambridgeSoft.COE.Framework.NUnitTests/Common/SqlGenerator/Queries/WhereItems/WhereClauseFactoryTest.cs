       ...
       // [DeploymentItem("CambridgeSoft.COE.Framework.dll")]
        ...
        public void ParseTextCriteriaOperationTest()
        {
            ...
            try
            {
                ...
                actual = CambridgeSoft.COE.Framework.NUnitTests.CambridgeSoft_COE_Framework_Common_SqlGenerator_Queries_WhereItems_WhereClauseFactoryAccessor.ParseTextCriteriaOperation(field, operationNode, false, trimPosition, caseSensitive);
