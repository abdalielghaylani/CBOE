...
namespace CambridgeSoft.COE.Framework.COEDataViewService.UnitTests
{
    ...
    public class COEDataViewManagerBOTest : LoginBase
    {
        ...
        public void MergeTable_Test()
        {
            ...
            Microsoft.VisualStudio.TestTools.UnitTesting.PrivateObject thePrivateObject =new Microsoft.VisualStudio.TestTools.UnitTesting.PrivateObject(currentTable);
        ...
        private COEDatabaseBOList GetPublishedSchemas()
        {
            ...
            COEDatabaseBOList publishedDataBases = COEDatabaseBOList.GetList(true, mainInstance.Name);
