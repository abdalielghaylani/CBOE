...
namespace CambridgeSoft.COE.Framework.NUnitTests
{
    ...
    public class CachingTest
    {
        ...
        public COEDataView BuildCOEDataViewFromXML()
        {
            ...
            doc.Load(AppDomain.CurrentDomain.BaseDirectory.Substring(0, AppDomain.CurrentDomain.BaseDirectory.IndexOf("CambridgeSoft.COE.Framework.NUnitTests")) + @"CambridgeSoft.COE.Framework.NUnitTests" + @"\TestXML\COEDataViewForTests.xml");
