...
{
    /// <summary>
    /// Patch to update missing xml configuration in 4013.xml from upgrade [1210_1250].
    /// </summary>
    class Upgrade1250_4013 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            coeFormPath = "//COE:listForms/COE:listForm[@id='0']/COE:coeForms/COE:coeForm[@id='0']/COE:viewMode/COE:formElement[@name='']/COE:configInfo/COE:fieldConfig/COE:coeForm[@id='1']/COE:viewMode/COE:formElement/COE:configInfo";
            InnerXml = "<param databindingexpression=\"OrderIndex\" formattedText=\"OrderIndex={0}|\" />";
            status = ManipulateNode(coeFormPath, "CommandArguments", "", "fieldConfig");
            messages.Add(status);
            Reset();
            #endregion
            ...
            #region Text
            coeFormPath = "//COE:listForms/COE:listForm[@id='0']/COE:coeForms/COE:coeForm[@id='0']/COE:viewMode/COE:formElement[@name='']/COE:configInfo/COE:fieldConfig/COE:coeForm[@id='1']/COE:viewMode/COE:formElement/COE:configInfo";
            InnerText = "Resolve This Component";
            status = ManipulateNode(coeFormPath, "Text", "", "CommandArguments");
            messages.Add(status);
            Reset();
            #endregion
            ...
            if (!_errorsInPatch)
                messages.Add("Upgrade1250_4013 Workflow was successfully fixed.");
            else
                messages.Add("Upgrade1250_4013 Workflow  was fixed with partial update.");
            return messages;
        }
            ...
            try
            {
                ...
                if (_newNode == null)
                {
                    ...
                    if (InsertNode(_parentNode, _newNode, _insertBefore, _insertAfter))
                        return "Form[4013]: " + _newElementPath + " was added succesfully.";
                    else
                        return "Form[4013]: " + _newElementPath + " was not added due to errors.";
                }
                else
                {
                    _errorsInPatch = true;
                    return "Form[4013]: " + _newElementPath + " was already available.";
                }
            }
            catch (Exception ex)
