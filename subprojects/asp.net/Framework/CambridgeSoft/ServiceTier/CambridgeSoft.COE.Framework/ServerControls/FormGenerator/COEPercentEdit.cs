...
{
    /// <summary>
    /// COE Web Control to work with percentage fields (E.g 20%).
    /// </summary>
    /// <summary>
    /// <para>
    /// This class implements a Percent TextBox control that may be used inside a <see cref="COEFormGenerator"/>.
    /// </para>
    /// <para>
    /// The COECurrencyEdit class accepts every WebPercentEdit(Infragistics) property to be set, but as ICOEGenerable control it also provides
    ...
    ///                     &lt;formElement&gt;
    ///                        &lt;Id&gt;AM_Total&lt;/Id&gt;
    ///                        &lt;bindingExpression&gt;JapanSales&lt;/bindingExpression&gt;
    ///                        &lt;configInfo&gt;
    ///                          &lt;fieldConfig&gt;
    ///                            &lt;configSetting bindingExpression="this.ID"&gt;UniqueID01&lt;/configSetting&gt;
    ///                            &lt;configSetting bindingExpression="this.CssClass"&gt;COEPercentEdit&lt;/configSetting&gt;
    ///                            &lt;configSetting bindingExpression="this.ReadOnly"&gt;true&lt;/configSetting&gt;
    ///                          &lt;/fieldConfig&gt;
    ///                        &lt;/configInfo&gt;
    ///                        &lt;displayInfo&gt;
    ///                          &lt;type>CambridgeSoft.COE.Framework.Controls.COEFormGenerator.COEPercentEdit&lt;/type>
    ///                        &lt;/displayInfo&gt;
    ///                      &lt;/formElement&gt;
    /// </code>
    /// </summary>
    [ToolboxData("<{0}:COEPercentEdit runat=server></{0}:COEPercentEdit>")]
    public class COEPercentEdit : WebPercentEdit, ICOEGenerableControl, ICOELabelable, ICOECultureable
    {
        #region Variables
