...
<div style="text-align:center;float:left;" id="DivForMasterDV" runat="server">
    ...
    <COEManager:ImageButton id="RefreshSchemaImageButton" runat="server" ButtonMode="ImgAndTxt" TypeOfButton="Publish" OnClientClick="SetProgressLayerVisibility(true); return true;" />
</div>
