...
xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xs:complexType name="COEDataView.Table">
		...
		<xs:attribute name="hitListDataType" type="tns:HitListDataTypes" />
	...
	<xs:simpleType name="IndexTypes">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="DIRECT_CARTRIDGE" />
			<xs:enumeration value="CS_CARTRIDGE" />
			<xs:enumeration value="JCHEM_CARTRIDGE" />
	...
	<xs:simpleType name="MimeTypes">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="CHEMICAL_X_MDL_CHIME" />
			<xs:enumeration value="CHEMICAL_X_DATADIRECT_CTAB" />
			<xs:enumeration value="CHEMICAL_X_CML" />
	...
	<xs:simpleType name="HitListDataTypes">
		<xs:restriction base="xs:string">			
			<xs:enumeration value="NUMBER" />
			<xs:enumeration value="STRING" />
			<xs:enumeration value="ROWID" />
			<xs:enumeration value="COEPK" />
		</xs:restriction>
	</xs:simpleType>
</xs:schema>';
