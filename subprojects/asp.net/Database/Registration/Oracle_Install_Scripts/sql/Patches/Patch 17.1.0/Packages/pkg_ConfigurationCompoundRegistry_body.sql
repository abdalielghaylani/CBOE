...
PROCEDURE VerifyNullField(AField IN VARCHAR2, ATable IN VARCHAR2)  IS
         LCount      Number;
         LStatement  Varchar2(4000);
...
PROCEDURE VerifyFields(AField VARCHAR2,ATableName VARCHAR2) IS
LIsException  Varchar2(200);
  BEGIN
      LIsException := 'false';
      VerifyNullField(AField,ATableName);
       EXCEPTION
         WHEN OTHERS THEN
          BEGIN
            LIsException := 'true';
  ...
  PROCEDURE ValidateTables(AErrorsLog OUT CLOB,APropertyListType VARCHAR2,AField VARCHAR2) IS
     ...
     AErrorsLog:='';
            ...
            WHEN 'MIXTURE' THEN
                 BEGIN
                    ...
                    VerifyFields(AField,LTableName);
                    VerifyFields(AField,LTempTableName);
                 END;
             WHEN 'BATCH' THEN
                 BEGIN
                    LTableName:='BATCHES';
