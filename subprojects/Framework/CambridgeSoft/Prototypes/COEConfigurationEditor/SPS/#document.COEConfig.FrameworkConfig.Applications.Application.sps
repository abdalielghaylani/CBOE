                  ...
                  <template match="COEConfig">
                    <children>
                      <template match="FrameworkConfig">
                        <children>
                          <template match="Applications">
                            <children>
                              <template match="Application">
                                <children>
                                  <template match="@dbConnecton">
                                    <children>
                                      <condition>
                                        <editorproperties />
                                        <properties />
                                        <styles />
                                        <children>
                                          <conditionbranch xpath="../@configEditorName=&quot;Registration Mananger&quot; and ../@name=&quot;Registration&quot; and ../../../@name=&quot;Global&quot;">
                                            <editorproperties />
                                            <properties />
                                            <styles />
                                            <children>
