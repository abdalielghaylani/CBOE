...
{
    /// <summary>
    /// Patch to update missing xml configuration in 4010.xml from upgrade [1210_1250].
    /// </summary>
    class Upgrade1250_4010 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            #region CSSLabelClass
            coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1003']/COE:addMode/COE:formElement[@name='']/COE:configInfo/COE:fieldConfig";
            InnerText = "FELabel";
            status = ManipulateNode(coeFormPath, "CSSLabelClass", "tables", "validationRuleList");
            messages.Add(status);
            Reset();
            #endregion
            ...
            if (!_errorsInPatch)
                messages.Add("Upgrade1250_4010 Workflow was successfully fixed.");
            else
                messages.Add("Upgrade1250_4010 Workflow  was fixed with partial update.");
            return messages;
        }
            ...
            try
            {
                ...
                if (_newNode == null)
                {
                    ...
                    if (InsertNode(_parentNode, _newNode, _insertBefore, _insertAfter))
                        return "Form[4010]: " + _newElementPath + " was added succesfully.";
                    else
                        return "Form[4010]: " + _newElementPath + " was not added due to errors.";
                }
                else
                {
                    _errorsInPatch = true;
                    return "Form[4010]: " + _newElementPath + " was already available.";
                }
            }
            catch (Exception ex)
