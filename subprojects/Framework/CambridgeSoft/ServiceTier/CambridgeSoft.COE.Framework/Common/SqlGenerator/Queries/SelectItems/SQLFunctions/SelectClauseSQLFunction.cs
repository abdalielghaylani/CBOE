...
namespace CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.SelectItems
{
    ...
    /// </para>
    /// <para>
    /// The SelectClauseSqlFunction is a base class called by all functions that inherit from it. The sql function can be single parameter in the simplest case or multiple
    ...
    /// SelectClauseSQLFunction itemFunction = new SelectClauseFunction();
    /// itemFunction.FunctionName = "LCase";
    /// itemFunction.Parameters.Add(item);
    /// itemFunction.Alias = "First Name";
    /// query.AddSelectItem(itemFunction);
    /// </code>
    /// 
    /// <b>With XML:</b>
    /// <code lang="XML">
    /// &lt;sqlFunction functionaName="LCASE" &gt;
    ///     &lt;Parameters&gt;
    ///		    &lt;field fieldid="1"/&gt;
    ///     &lt;/Parameters&gt;
    /// &lt;/sqlFunction>
    ...
    /// </para>
    /// </summary>
    public class SelectClauseSQLFunction : SelectClauseItem, ISelectClauseParser
    {
        #region Properties
        /// <summary>
        ...
        /// Default Constructor
        /// </summary>
        public SelectClauseSQLFunction()
        {
        ...
        {
            SelectClauseSQLFunction item = new SelectClauseSQLFunction();
