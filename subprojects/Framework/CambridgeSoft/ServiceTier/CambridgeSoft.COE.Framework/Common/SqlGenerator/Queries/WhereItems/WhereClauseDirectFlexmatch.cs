// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WhereClauseDirectFlexmatch.cs" company="PerkinElmer Inc.">
...
namespace CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems
{
    ...
    /// <summary>
    /// This class to generate a "flexmatch(field)" SQL Statement for Direct Cartridge.
    /// </summary>
    internal class WhereClauseDirectFlexmatch : WhereClauseBinaryOperation
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="WhereClauseDirectFlexmatch"/> class to its default values. 
        /// </summary>
        public WhereClauseDirectFlexmatch()
        {
        ...
        /// <summary>
        /// Gets or sets for a 2D flexmatch search, it is a string containing the flexmatch switches.
        /// </summary>
        public string FlexmatchParameters { get; set; }

        /// <summary>
        /// Gets or sets a number that is equal to the flexmatch-number parameter used with the flexmatchtimeout 
        ...
        protected override string GetDependantString(DBMSType databaseType, List<Value> values)
        {
            ...
            builder.Append(string.Format("flexmatch({0}", ParameterHelper.GetDirectStructureFieldString(dataField, GetFullName(dataField))));
            builder.Append(",");

            ParameterHelper.AppendStructure(this, ref builder, ref values, val);

            builder.Append(", ");
            ParameterHelper.AppendParameter(this, ref builder, ref values, new Value(FlexmatchParameters, DbType.String));

            if (!string.IsNullOrEmpty(FlexmatchNumber))
            {
                builder.Append(", ");
                ParameterHelper.AppendParameter(this, ref builder, ref values, new Value(FlexmatchNumber, DbType.String));
            }
