<%@ Page language="c#" CodeFile="ModifyRecurrenceDialog.aspx.cs" AutoEventWireup="false" Inherits="Forms.ModifyRecurrenceDialog" %>
		...
		function cancelClicked()
		{
			...
			<table style="width:100%;" cellspacing="0" class="Fonts">
				<tr>
					...
					<td colspan="3"><br />
						This is a recurring appointment. Do you want to open this occurrence or the 
						series?</td>
				</tr>
				<tr>
					<td colspan="4">&nbsp;</td>
				...
				<tr>
					<td>&nbsp;</td>
					<td colspan="3"><input type="radio" id="radOccurence" name="modifyseries" checked><label for="radOccurence">Open 
				...
				<tr>
					<td>&nbsp;</td>
					<td colspan="3"><input type="radio" id="radSeries" name="modifyseries"><label for="radSeries">Open 
							the series.</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td><button class="Fonts" style="width:90px" onclick="okClicked()">OK</button></td>
					<td>&nbsp;</td>
					<td><button class="Fonts" style="width:90px" onclick="cancelClicked()">Cancel</button></td>
					<td>&nbsp;</td>
				</tr>
			</table>
		</form>
