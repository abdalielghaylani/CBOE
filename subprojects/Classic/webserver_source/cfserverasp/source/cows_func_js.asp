...
function pageLoadTiming(){ 
	
	
	
	if (document.all["pageLoadTime"]){
			//alert('Page Load Time: '+((new Date()).getTime()-before)/1000.+' s');
			var loadTime = ((new Date()).getTime()-before)/1000.+' s';
			document.all["pageLoadTime"].innerHTML = loadTime;
	}
}		
