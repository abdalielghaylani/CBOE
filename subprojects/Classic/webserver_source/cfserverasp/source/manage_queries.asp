...
Function getUserInfoFromDBQuery(dbkey, formgroup, username)
	...
	if CBool(Application("ALLOW_PUBLIC_QUERIES")) = true then
		sql = "SELECT dbqt.* " &_
			" FROM " & DB_QUERY_TABLE  & " dbqt " &_
			" WHERE (dbqt.USER_ID='" & username & "'" & " OR dbqt.IS_PUBLIC='1')" &_
			" AND NOT dbqt.QUERY_NAME = 'HISTORY' AND dbqt.FORMGROUP='"& UCase(formgroup) & "'" &_
			" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
			" AND dbqt.DBNAME='"& dbkey & "'" &_
			" ORDER BY QUERY_ID DESC"
	else
		sql = "SELECT dbqt.* " &_
			" FROM " & DB_QUERY_TABLE  & " dbqt " &_
			" WHERE (dbqt.USER_ID='" & username & "')"  &_
			" AND NOT dbqt.QUERY_NAME = 'HISTORY' AND dbqt.FORMGROUP='"& UCase(formgroup) & "'" &_
			" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
			" AND dbqt.DBNAME='"& dbkey & "'" &_
			" ORDER BY QUERY_ID DESC"
...
Function getUserInfoFromDBQueryALL(dbkey, formgroup, username)
	...
	sql = "SELECT dbqt.* " &_
		" FROM " & DB_QUERY_TABLE & " dbqt " &_
		" WHERE dbqt.USER_ID='" & username & "'"  &_
		"  AND dbqt.FORMGROUP='"& UCase(formgroup) & "'" &_
		" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
		" AND dbqt.DBNAME='"& dbkey & "'" &_
		" ORDER BY QUERY_ID DESC"
...
Function getHistoryInfoFromDBQuery(dbkey, formgroup, username)
	...
	If DB_QUERY_SCHEMA <> "" then
		...
		DescSQL = "to_char(to_date(dbqt.DESCRIPTION, 'MM/DD/YYYY:HH:MI:SS PM'), '" & Application("date_format_string") & " :HH:MI:SS PM') DESCRIPTION"    
	else
		DB_QUERY_TABLE = "DB_QUERY"
		FORMGROUPS = "DB_FORMGROUP"
		DescSQL = "dbqt.DESCRIPTION"
	end if
	if CheckFormgroupTableExists(dbkey, formgroup) then
		...
		'		" AND " & DB_QUERY_TABLE & ".FORMGROUP=" &  FORMGROUPS & ".FORMGROUP_ID ORDER BY " & FORMGROUPS & ".FORMGROUP_NAME"
			sql = "SELECT dbqt.QUERY_ID, dbqt.SESSION_ID, dbqt.QUERY_NAME, dbqt.IS_PUBLIC, dbqt.USER_ID, dbqt.FORMGROUP, dbqt.DBNAME, dbqt.APPNAME, dbqt.NUMBER_HITS, dbqt.REC_DATE, " & DescSQL & ", fgs.FORMGROUP_NAME AS FORM_NAME" &_
				" FROM " & DB_QUERY_TABLE & " dbqt," & FORMGROUPS & " fgs " &_
				" WHERE dbqt.USER_ID='" & username & "'"  &_
				" AND dbqt.QUERY_NAME ='HISTORY'" &_
				" AND dbqt.DBNAME='"& dbkey & "'" & " AND dbqt.SESSION_ID is NULL" &_
				" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
				" AND dbqt.FORMGROUP='"& Ucase(formgroup) & "'" &_
				" AND dbqt.FORMGROUP=fgs.FORMGROUP_ID ORDER BY fgs.FORMGROUP_NAME"
			...
			sql = "SELECT dbqt.QUERY_ID, dbqt.SESSION_ID, dbqt.QUERY_NAME, dbqt.IS_PUBLIC, dbqt.USER_ID, dbqt.FORMGROUP, dbqt.DBNAME, dbqt.APPNAME, dbqt.NUMBER_HITS, dbqt.REC_DATE, " & DescSQL & ",fgs.FORMGROUP_NAME AS FORM_NAME" &_
				...
				" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
				" AND dbqt.FORMGROUP='"& Ucase(formgroup) & "'" &_
				" AND dbqt.FORMGROUP=fgs.FORMGROUP_NAME ORDER BY fgs.FORMGROUP_NAME"
		...
		'	" AND " & DB_QUERY_TABLE & ".APPNAME='"& Application("APPKEY") & "'" &_
		'	" ORDER BY QUERY_ID DESC"
		sql = "SELECT dbqt.QUERY_ID, dbqt.SESSION_ID, dbqt.QUERY_NAME, dbqt.IS_PUBLIC, dbqt.USER_ID, dbqt.FORMGROUP, dbqt.DBNAME, dbqt.APPNAME, dbqt.NUMBER_HITS, dbqt.REC_DATE, " & DescSQL &_
			" FROM " & DB_QUERY_TABLE  & " dbqt " &_
			" WHERE dbqt.USER_ID='" & username & "'"  &_
			" AND dbqt.QUERY_NAME ='HISTORY'" &_
			" AND dbqt.DBNAME='"& dbkey & "'" & " AND dbqt.SESSION_ID is NULL" &_
...
Function getSessionInfoFromDBQueryALL(dbkey, formgroup, sessionid)
	...
	if CheckFormgroupTableExists(dbkey, formgroup) then
		if Session("bypass_ini" & dbkey & formgroup) = true then
			...
			'	" ORDER BY " & FORMGROUPS & ".FORMGROUP_NAME ASC, REC_DATE DESC"
			sql = "SELECT dbqt.*" & ", fgs.FORMGROUP_NAME as FORM_NAME" &_
				" FROM " & DB_QUERY_TABLE & " dbqt," & FORMGROUPS & " fgs " &_
				" WHERE dbqt.DBNAME='"& dbkey & "'" &_
				" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
				" AND dbqt.FORMGROUP=fgs.FORMGROUP_ID" &_
				" ORDER BY dbqt.FORMGROUP_NAME ASC, dbqt.REC_DATE DESC"
			...
			sql = "SELECT dbqt.*" & ", fgs.FORMGROUP_NAME as FORM_NAME" &_
				...
				" WHERE dbqt.DBNAME='"& dbkey & "'" &_
				" AND dbqt.APPNAME='"& Application("APPKEY") & "'" &_
				" AND dbqt.FORMGROUP=fgs.FORMGROUP_NAME" &_
				" ORDER BY dbqt.FORMGROUP_NAME ASC, REC_DATE DESC" 				
		end if
	else
		'sql = "SELECT " & DB_QUERY_TABLE & ".*"  &_
		'	" FROM " & DB_QUERY_TABLE & "," & FORMGROUPS &_
