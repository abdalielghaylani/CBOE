...
//jhs 1/4/2008 added to get rid of javascript errors
var oktoloadnav = true
...
if (formmode == null){
	//jhs 1/4/2008 added oktoloadnav to get rid of javascript errors
	oktoloadnav =  false
	formmode = "search"
...
action = Request("UserInfoActionVal")
DoSetNullAction()
...
//jhs 1/4/2008 added oktoloadnav check to get rid of javascript errors
var add_on = MainWindow.navbar_add_on;
if (oktoloadnav){
