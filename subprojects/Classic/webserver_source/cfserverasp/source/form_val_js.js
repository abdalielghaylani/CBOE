...
function clearData(elm){
		var temp = elm + '_ctrl'
		//jhs 2/20/2008 added this if then which comes from cd_getSpecificObject
		// the function in the js file though launches an error instead of just returning it
		// the if then will check for the object first and then only give it to cd_clear if the object exists
		r = null;
...
function clearFields(){
	...
	for (i=0;i<f.length;i++){
		var e = f.elements[i]
		e.value = ""; //CBOE-1033 SJ for clearing all controls including dropdowns       
	}
}
