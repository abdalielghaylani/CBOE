...
<FRAMESET COLS="100%" ROWS="58,*,80,0" BORDER = 0 FRAMEBORDER = 0 FRAMESPACING = 0>
	<FRAME NAME="head" SRC="JSBrwHd.asp" SCROLLING="no" BORDER = 1 FRAMEBORDER = 0 FRAMESPACING = 0 MARGINHEIGHT=2 MARGINWIDTH = 2>
	<FRAMESET COLS="5,*,5">
