...
strHtml = strHtml & "		<tr><td align=""right"">Requested By:</td><td bgcolor=""#d3d3d3"">" & RUserID & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Requested For:</td><td bgcolor=""#d3d3d3"">" & DUserID & "</td></tr>" & vbcrlf
