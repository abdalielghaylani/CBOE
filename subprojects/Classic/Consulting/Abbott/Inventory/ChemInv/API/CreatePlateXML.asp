...
if RegisterCompounds = "true" then
	...
	For Each oNode in nlCompounds
		...
		if oNode.GetAttribute("PRODUCER") <> "" Then QueryString = QueryString & "&Temporary_Structures.PRODUCER=" & oNode.GetAttribute("PRODUCER")
		...
		if oNode.GetAttribute("NOTEBOOK_TEXT") <> "" Then QueryString = QueryString & "&Temporary_Structures.NOTEBOOK_TEXT=" & oNode.GetAttribute("NOTEBOOK_TEXT")
		...
		if oNode.GetAttribute("BATCH_COMMENT") <> "" Then QueryString = QueryString & "&Temporary_Structures.BATCH_COMMENT=" & oNode.GetAttribute("BATCH_COMMENT")
		if oNode.GetAttribute("CHEMICAL_NAME") <> "" Then QueryString = QueryString & "&Temporary_Structures.CHEMICAL_NAME=" & oNode.GetAttribute("CHEMICAL_NAME")
		if oNode.GetAttribute("SYNONYM_R") <> "" Then QueryString = QueryString & "&Temporary_Structures.SYNONYM_R=" & oNode.GetAttribute("SYNONYM_R")
		if oNode.GetAttribute("LIT_REF") <> "" Then QueryString = QueryString & "&Temporary_Structures.LIT_REF=" & oNode.GetAttribute("LIT_REF")
		if oNode.GetAttribute("PREPARATION") <> "" Then QueryString = QueryString & "&Temporary_Structures.PREPARATION=" & oNode.GetAttribute("PREPARATION")
		if oNode.GetAttribute("STORAGE_REQ_AND_WARNINGS") <> "" Then QueryString = QueryString & "&Temporary_Structures.STORAGE_REQ_AND_WARNINGS=" & oNode.GetAttribute("STORAGE_REQ_AND_WARNINGS")
		...
		if oNode.GetAttribute("STRUCTURE_COMMENTS_TXT") <> "" Then QueryString = QueryString & "&Temporary_Structures.STRUCTURE_COMMENTS_TXT=" & oNode.GetAttribute("STRUCTURE_COMMENTS_TXT")
		...
		if oNode.GetAttribute("SALT_NAME") <> "" Then QueryString = QueryString & "&Temporary_Structures.SALT_NAME=" & oNode.GetAttribute("SALT_NAME")
		...
		if oNode.GetAttribute("SOLVATE_NAME") <> "" Then QueryString = QueryString & "&Temporary_Structures.SOLVATE_NAME=" & oNode.GetAttribute("SOLVATE_NAME")
		...
		if oNode.GetAttribute("VENDOR_NAME") <> "" Then QueryString = QueryString & "&Temporary_Structures.VENDOR_NAME=" & oNode.GetAttribute("VENDOR_NAME")
		...
		if oNode.GetAttribute("APPEARANCE") <> "" Then QueryString = QueryString & "&Temporary_Structures.APPEARANCE=" & oNode.GetAttribute("APPEARANCE")
		...
		if oNode.GetAttribute("FIELD_1") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_1=" & oNode.GetAttribute("FIELD_1")
		if oNode.GetAttribute("FIELD_2") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_2=" & oNode.GetAttribute("FIELD_2")
		if oNode.GetAttribute("FIELD_3") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_3=" & oNode.GetAttribute("FIELD_3")
		if oNode.GetAttribute("FIELD_4") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_4=" & oNode.GetAttribute("FIELD_4")
		if oNode.GetAttribute("FIELD_5") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_5=" & oNode.GetAttribute("FIELD_5")
		if oNode.GetAttribute("FIELD_6") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_6=" & oNode.GetAttribute("FIELD_6")
		if oNode.GetAttribute("FIELD_7") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_7=" & oNode.GetAttribute("FIELD_7")
		if oNode.GetAttribute("FIELD_8") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_8=" & oNode.GetAttribute("FIELD_8")
		if oNode.GetAttribute("FIELD_9") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_9=" & oNode.GetAttribute("FIELD_9")
		if oNode.GetAttribute("FIELD_10") <> "" Then QueryString = QueryString & "&Temporary_Structures.FIELD_10=" & oNode.GetAttribute("FIELD_10")
		...
		if oNode.GetAttribute("TXT_CMPD_FIELD_1") <> "" Then QueryString = QueryString & "&Temporary_Structures.TXT_CMPD_FIELD_1=" & oNode.GetAttribute("TXT_CMPD_FIELD_1")
		if oNode.GetAttribute("TXT_CMPD_FIELD_2") <> "" Then QueryString = QueryString & "&Temporary_Structures.TXT_CMPD_FIELD_2=" & oNode.GetAttribute("TXT_CMPD_FIELD_2")
		if oNode.GetAttribute("TXT_CMPD_FIELD_3") <> "" Then QueryString = QueryString & "&Temporary_Structures.TXT_CMPD_FIELD_3=" & oNode.GetAttribute("TXT_CMPD_FIELD_3")
