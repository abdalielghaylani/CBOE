...
bDebugPrint = false
bWriteError = false
strError = "Error:DeleteDataMap<BR>"

dataMapID = Request("dataMapID")

' Redirect to help page if no parameters are passed
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cheminv/help/admin/api/DeleteDataMap.htm"
	Response.end
End if
...
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".DATAMAPS.DeleteDataMap", adCmdStoredProc)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".DATAMAPS.DeleteDataMap")
End if
