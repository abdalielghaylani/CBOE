...
Response.Write "Report with ID " & Cmd.Parameters("RETURN_VALUE") & " updated.<br>"
...
if NumParams <> 0 then
	...
	'Response.end
		...
		ParamName= Request("Parameter" &i-1 & "Name")
		ParamDisplayName= Request("Parameter" &i-1 & "DisplayName")
