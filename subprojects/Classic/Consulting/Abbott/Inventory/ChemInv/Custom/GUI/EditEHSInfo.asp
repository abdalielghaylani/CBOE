...
<script language="JavaScript">
	...
	function ValidateContainer(){	
		...
		if ((document.form1.EHSACGIHCarcinogenCategory.value.length > 0) && ((document.form1.EHSACGIHCarcinogenCategory.value.length > 2) || (document.form1.EHSACGIHCarcinogenCategory.value != "A1") || (document.form1.EHSPackingGroup.value != "A2"))){
