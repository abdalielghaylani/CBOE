...
%>
	<table border="0" width="500" cellpadding="10" cellspacing="0">
		...
		<script language="javascript">
			document.cows_input_form.searchSubLocations.checked = true;
		</script>
<%
	Case "substructure"
%>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<td valign="top">
				<table>
		      		<tr>
			        	<td>
							<span title="Catalog Number">Catalog Number:</span><br>
							<%ShowInputField dbkey, formgroup, "inv_containers_alias.Supplier_CatNum", "0","30"%>        
						</td>
		      		</tr>
		      		<tr>
			        	<td>
