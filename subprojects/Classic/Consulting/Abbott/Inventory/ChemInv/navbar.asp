						...
						<table border="0" bordercolor="#666666" width="550">
							<tr>
								...
								if (top.opener) {
									...
									cancel_action = "parent.location.href='http://<%=Request.ServerVariables("Server_Name")%>/cs_security/home.asp';";
								}
				...
				<td width="650" valign="top" colspan="2">
					<table border="0" cellspacing="3">
						<tr>
							...
							<nobr>
								<script language="JavaScript">
									if (!((formgroup.toLowerCase() == "containers_form_group") || (formgroup.toLowerCase() == "containers_np_form_group") || (formgroup.toLowerCase() == "plates_form_group"))){
