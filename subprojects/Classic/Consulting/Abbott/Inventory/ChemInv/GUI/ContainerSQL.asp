...
SQL = "SELECT /*+ ORDERED */ " & vblf & _ 
    ...
    "DECODE(inv_Containers.Batch_ID_FK, NULL, ' ', " & schemaName & ".GUIUTILS.GETBATCHAMOUNTSTRING(container_ID,'mg')) as totalBatchAmt,  " & _
    ...
    "inv_Compounds.CAS AS CAS, " & vblf & _ 
    ...
    "CHEMINVDB2.RESERVATIONS.GETTOTALQTYRESERVED(inv_Containers.Container_ID) as TotalQtyReserved, " & vblf & _
	...
	"DECODE(inv_Containers.Container_Cost, NULL, ' ', '$'||TO_CHAR(inv_Containers.Container_Cost,'999,999.99')) AS ContainerCost,  " & vblf & _	     
...
"FROM " & vblf & _ 
    "inv_Containers , inv_Locations, inv_Compounds, inv_Suppliers, inv_Units UOM, inv_Units UOP, inv_Units UOC, inv_Units UOD, inv_Units UOW, inv_Container_Types, inv_container_status, inv_solvents, inv_address, inv_states, inv_country " & vblf & _
"WHERE  " & vblf & _ 
  "inv_Containers.Location_ID_FK = inv_Locations.Location_ID  " & vblf & _
"AND " & vblf & _ 
