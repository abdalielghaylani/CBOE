	...
	<SCRIPT LANGUAGE=javascript>
		...
		function LookUpContainer(barcode){
			...
			if (httpResponse.length == 0){
				...
				top.ListFrame.location.href = "Order_list.asp?Clear=0&OrderID=<%=OrderID%>&RequestID=<%=RequestID%>&Action=<%=Action%>&OrderStatusID=" + document.form1.OrderStatusID.value + "&AddContainerID=" + temp[0] + "&DeliveryLocationID=" + document.form1.LocationID.value + "&ShipToName=" + document.form1.ShipToName.value;
			}
			clearTextBox();
		}
	</SCRIPT>
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
	  <td colspan="2" align="right">
	    <a class="MenuLink" href="Close" onclick="parent.opener.focus(); parent.close(); return false">Close</a>
	  </td>
	</tr>
	<tr>
		<td align="right">
