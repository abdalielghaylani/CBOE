		...
		<td>
			...
			If isNumeric(httpResponse) then
				If CLng(httpResponse) > 0 then
					...
					Response.Write "<br /><a href=""javascript:if (opener){opener.location.reload();} location.href='/cheminv/gui/menu.asp'""><img src=""/cheminv/graphics/sq_btn/ok_dialog_btn.gif"" border=""0""></a>"
					else
