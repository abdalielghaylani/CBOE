...
<%
			...
			Select Case theAction
				...
				Case "Exit"
					...
					Response.Write "<SCRIPT LANGUAGE=javascript>SelectLocationNode(0, " & Session("CurrentLocationID") & ", 0, '" & Session("TreeViewOpenNodes1") & "'," & Session("plPlate_ID") & ",1); opener.focus(); window.close();</SCRIPT>" 
				Case "WriteAPIError"
