...
<%
	...
	Else
		While (Not RS.EOF)
			...
			editData = "CompoundID=" & CompoundID & "&SynonymID=" & SynonymID & "&SubstanceName=" & Replace(SubstanceName,"'","\'")
%>
			<tr>
				<td align="center">
					<%=SubstanceName%>
	...
	Set Conn = nothing		
%>
<br><a HREF="#" onclick="window.close(); return false;"><img SRC="../graphics/ok_dialog_btn.gif" border="0"></a>
</center>
</body>
</html>
