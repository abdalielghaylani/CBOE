...
<table border="0">
	<TR>
		<TD colspan="2" ALIGN="center"><span class="GUIFeedback">If you enter a reason for cancelling this order, <BR>it will be appeneded to the order comments.</span><br></TD>
	</TR>
	<tr>
