			...
			<table border="1">
				<tr>
					...
					<td>
						...
						Base64DecodeDirect "invreg", "base_form_group", Session("wBASE64_CDX"), "Structures.BASE64_CDX", Session("wcpdID"), Session("wcpdID"), specifier, 130
						%>
					</td>
				</tr>
			</table>
