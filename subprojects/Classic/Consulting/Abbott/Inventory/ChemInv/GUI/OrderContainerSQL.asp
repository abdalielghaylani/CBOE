...
SQL = "SELECT " & _ 
	...
	"DECODE(inv_Containers.Container_Cost, NULL, ' ', '$'||TO_CHAR(inv_Containers.Container_Cost,'999,999.99')) AS ContainerCost,  " & _	     
...
"FROM " & _ 
    "inv_Containers, inv_Locations, inv_Units UOM, inv_Units UOP, inv_Units UOC, inv_Units UOW, inv_Container_Types, inv_Compounds, inv_Suppliers, inv_container_status  " & _
"WHERE  " & _ 
