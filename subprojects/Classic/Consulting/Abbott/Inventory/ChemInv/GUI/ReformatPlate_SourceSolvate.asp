	...
	<TABLE BORDER="0">
		...
		<tr>
			...
			<td>
				...
				<%=ShowSelectBox3("SolventVolumeAddedUnitID" & i, Application("plDefVolUnitID"),"SELECT unit_id AS Value, unit_name AS DisplayText FROM inv_units WHERE unit_type_id_fk in (1) ORDER BY lower(DisplayText) ASC",null,null,null,"CalculateConcentration(" & i &");")%>
			</td>
		</tr>
		<!--
		<tr>
		...
		<TR>
			...
			<TD>
				...
				<%=ShowSelectBox3("ConcentrationUnitID" & i, Application("plDefConcUnitID"),"SELECT unit_id AS Value, unit_name AS DisplayText FROM inv_units WHERE unit_type_id_fk in (3) ORDER BY lower(DisplayText) ASC",null,null,null,"CalculateVolume(" & i &");")%>
			</TD>
		</TR>
		<!--
		<TR>
