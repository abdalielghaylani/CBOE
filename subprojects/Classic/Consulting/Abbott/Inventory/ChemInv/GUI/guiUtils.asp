...
Function ShowRegStructure(id, height, width)
	Dim str
	str = "<embed src='" & Application("AppTempDirPathHTTP")& "/" & Application("appkey")& "Temp/mt.cdx' width='" & width & "' height='" & height & "' ID='" & id & "' name='cdp" & id & "' type='chemical/x-cdx' viewonly='true' dataurl='/cheminv/cheminv/cheminv_action.asp?dbname=invreg&formgroup=base_form_group&dataaction=get_structure&Table=Reg_Numbers&Field=Structure&DisplayType=cdx&StrucID=" & id & "'>"
...
Function ShowInlineStructure(id, height, width, border,base64cdx)
	...
	ShowInlineStructure = "<SCRIPT language=javascript>cd_insertObject(""chemical/x-cdx"", """ &  width & """, """ & height & """, ""cdpnew"", """ & TempCdxPath & """, ""true"", ""true"", escape(document.all.inline.value),  ""true"");</" & "SCRIPT>"
End function
...
"		<td bgcolor=""#e1e1e1"" width=""100%"" valign=""middle""><table cellpadding=0 cellspacing=0><tr><td>" & imgSrc & "&nbsp;</td><td><font size=""1""><strong>" & title & "</strong>&nbsp;&nbsp;&nbsp;</td><td align=""right""><font size=""1"">" & additional & "</td></tr></table></td>"  & vbcrlf &_
...
function DisplaySimpleMovedRack(RackIDList,SelectedRackGrids,ContainerGridPositionIDList)
	...
	htmlWrapper = htmlWrapper & "<td bgcolor=""#CCCCCC""><img src=""/cheminv/graphics/pixel.gif"" width=""10"" height=""10"" border=""0"">&nbsp;</td><td>* Containers for Fulfillment</td>"
