...
Sub SetContainerSessionVarsFromPostedData()
	...
	if Not IsEmpty(iStorageConditions) then Session("StorageConditions") = iStorageConditions
	if Not IsEmpty(iHandlingProcedures) then Session("HandlingProcedures") = iHandlingProcedures
	...
	if Not IsEmpty(iPOLineNumber) then Session("POLineNumber")= iPOLineNumber
	...
	if Not IsEmpty(iField_1) then Session("Field_1")= iField_1
	if Not IsEmpty(iField_2) then Session("Field_2")= iField_2
	if Not IsEmpty(iField_3) then Session("Field_3")= iField_3
	if Not IsEmpty(iField_4) then Session("Field_4")= iField_4
	if Not IsEmpty(iField_5) then Session("Field_5")= iField_5
	if Not IsEmpty(iField_6) then Session("Field_6")= iField_6
	if Not IsEmpty(iField_7) then Session("Field_7")= iField_7
	if Not IsEmpty(iField_8) then Session("Field_8")= iField_8
	if Not IsEmpty(iField_9) then Session("Field_9")= iField_9
	if Not IsEmpty(iField_10) then Session("Field_10")= iField_10
	if Not IsEmpty(iDate_1) then Session("Date_1")= iDate_1
	if Not IsEmpty(iDate_2) then Session("Date_2")= iDate_2
	if Not IsEmpty(iDate_3) then Session("Date_3")= iDate_3
	if Not IsEmpty(iDate_4) then Session("Date_4")= iDate_4
	if Not IsEmpty(iDate_5) then Session("Date_5")= iDate_5
