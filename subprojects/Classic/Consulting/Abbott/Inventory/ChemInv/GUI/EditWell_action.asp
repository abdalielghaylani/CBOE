...
For i = 0 to ubound(arrFields)
	...
	if len(Session(field)) > 0 then
		if InStr("iContainerIDs,multiscan,multiSelect,fieldList,wCompoundCount,wParentCount", field) = 0 then
			Select case lcase(field)
				'number fields
				case "wwell_format_id_fk","wqty_unit_fk","wqty_initial","wqty_remaining","wweight_unit_fk","wweight","wconc_unit_fk","wconcentration","wcompound_id_fk","wsolvent_id_fk","wreg_id_fk","wbatch_number_fk","wsolvent_volume","wsolvent_volume_unit_id_fk"
	...
	'set empty fields to null
		if InStr("iContainerIDs,multiscan,multiSelect,fieldList", field) = 0 then
			Select case lcase(field)
				'number fields
				case "wwell_format_id_fk","wqty_unit_fk","wqty_initial","wqty_remaining","wweight_unit_fk","wweight","wconc_unit_fk","wconcentration","wsolvent_id_fk","wsolvent_volume","wsolvent_volume_unit_id_fk"'"wcompound_id_fk","wreg_id_fk","wbatch_number_fk",
