	...
	<tr>
		<td align="right" valign="top" nowrap>
			<%If Session("INV_CREATE_PLATE" & dbkey) then%>	
				<a class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/ReformatPlate.asp?multiSelect=true', 'Diag', 1); return false">Reformat Plates</a>
				|
			<%end if%>
			<%If Session("INV_CREATE_PLATE" & dbkey) then%>	
				<a class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/ReformatPlate.asp?multiSelect=true&pageAction=daughter', 'Diag', 1); return false">Daughter Plates</a>
				|
			<%end if%>
			...
			<%If Session("INV_DILUTE_PLATE" & dbkey) then%>	
				<a class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/ReformatPlate_SourceSolvate.asp?multiSelect=true&pageMode=dilute', 'Diag', 4); return false">Dilute Plates</a>
				|
			<%End if%>
