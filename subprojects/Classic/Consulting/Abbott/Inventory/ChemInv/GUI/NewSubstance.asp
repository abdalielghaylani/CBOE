		  ...
		  <tr>
			...
			<td width="300" valign="top">
				<table border="1" cellpadding="0" cellspacing="0">
					<tr>
						<td valign="top">
							<script language="JavaScript">cd_insertObjectStr("<embed src='/CFWTEMP/cheminv/cheminvTemp/mt.cdx' width='280' height='200' id='5' name='mycdx' type='chemical/x-cdx'>");</script>
						</td>
					</tr>
				</table>		
			</td>
