-- Create procedure/function CHECKOUTCONTAINER.
CREATE OR REPLACE  FUNCTION "&&SchemaName"."CHECKOUTCONTAINER"          
...
if is_container_type_allowed(Null, pLocationID) = 0 then
  ...
  my_sql := 'UPDATE Inv_Containers SET Location_ID_FK= ' || pLocationID;
