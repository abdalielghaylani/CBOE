CREATE OR REPLACE FUNCTION "&&SchemaName"."SELECTHAZMATDATA"
...
BEGIN
  SELECT NVL(CatNum1.EHS_Group_1, NVL(CatNum2.EHS_Group_1, HazMat.EHS_Group_1)), 
         ...
         NVL(CatNum1.is_OSHA_Carcinogen, NVL(CatNum2.is_OSHA_Carcinogen, Managed.is_OSHA_Carcinogen)), 
         NVL(CatNum1.ACGIH_Carcinogen_Category, NVL(CatNum2.ACGIH_Carcinogen_Category, Managed.ACGIH_Carcinogen_Category)),
         ...
         DECODE(CatNum1.supplier_catnum_internal, NULL, DECODE(CatNum2.CAS_Internal, NULL, 1, 2), 0)
