...
'Copyright 1999-2003 CambridgeSoft Corporation. All rights reserved
	...
	Set Cmd = GetCommand(Conn, "{CALL CS_SECURITY.MANAGE_USERS.GETALLUSERS()}", adCmdText)	
	...
	<script LANGUAGE="javascript">
		...
		function Doit(id){
			if (id == -1){
				 ...
				 opener.document.user_manager.UserName.value = UName;
				 opener.document.user_manager.iPassword.value = "**********";
				 opener.document.user_manager.iPassword2.value = "**********";
				 opener.document.user_manager.isAlreadyInOracle.value = "1";
				 opener.lockFields();
				 window.close();
			}
		}
...
RS.MoveFirst
	...
	Else	
%>
<form name="form1" METHOD="POST" action="ManageUsers.asp">
<table border="0">
	<tr>
		<th align="center" valign="top">Select a User:</th>
	</tr>
	<tr>
		<td>
...
<%			
		...
		While (Not RS.EOF)
			...
			Response.Write "<OPTION value=""" & UserName & """>" & UserName  &  vblf 
