		...
		if UCase(sqlSyntax) = "ORACLE" then
			...
			Select case Application("DATE_FORMAT")
				...
				Case "9"
					PrepStrWhereItem = finalName & strOperator & "TO_DATE('" & strValue & "'," & "'DD,MM,YYYY')"' this is passed in as a parameter
				Case "10"
					PrepStrWhereItem = finalName & strOperator & "TO_DATE('" & strValue & "'," & "'YYYY,MM,DD')"' this is passed in as a parameter
			end select
...
Function DoQueryStringSearch(ByVal dbkey, ByVal formgroup)
	'?action =query_string&dbname = KKK&formgroup = """& full_field_name = LLL & fieldvalue = *** & field_type = III & field_criteria =KKK"
...
Sub DoLoggedOutMsg()
	...
	Response.Write "<P><font face=""Arial""size=""3"" color=""Red""><br>"
	Response.Write "You have been automatically logged out of the system<br>"
	Response.Write "due to a period of inactivity, please sign in again<br>"
	Response.Write "on the main screen.</font></P>"
	Response.Write "<P>"
	Response.Write "<a href=""javascript:location.replace('/" & Application("AppKey")& "/login.asp')"">Log In</a>"
	Response.Write "</P>"
	Response.Write ""
	response.write "</body>"
	Response.Write "</html>"
