...
bDebugPrint = false
bWriteError = False
strError = "Error:UpdateRolesGrantedToRole<BR>"
...
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cfserverasp/help/admin/api/UpdateRolesGrantedToRole.htm"
	Response.end
End if
...
Set Cmd = GetCommand(Conn, "CS_SECURITY.MANAGE_ROLES.UpdateRolesGrantedToRole", adCmdStoredProc)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd("CS_SECURITY.Manage_Roles.UpdateRolesGrantedToRole")
End if
