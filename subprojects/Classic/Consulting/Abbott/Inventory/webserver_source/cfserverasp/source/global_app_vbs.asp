...
if Application("MARKED_HITS_MAX") = "" then
	...
	if (Application("MARKED_HITS_MAX")="INIEmpty" or Application("MARKED_HITS_MAX") = "NULL" or Application("MARKED_HITS_MAX") = "") then
		Application("MARKED_HITS_MAX")="1000"
	end if
	Application.UnLock
end if
...
if Not Session("UserPrefs" & dbkey & User_ID & "start_check") <> "" then
	...
	currentSearchPrefs = selectCurrentSettings(dbkey, formgroup, User_ID, "SEARCHPREFS" & dbkey)
	...
	currentDisplayPrefs = selectCurrentSettings(dbkey, formgroup, User_ID, "USERRESULTSPREFS" & dbkey)
