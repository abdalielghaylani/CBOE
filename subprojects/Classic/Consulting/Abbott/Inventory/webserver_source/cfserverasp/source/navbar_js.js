...
function doMarkHit(uniqueid){
		...
		if(MainWindow.UserInfoWindow != self){
			MainWindow.UserInfoWindow.document.location.replace(app_Path + "/user_info.asp?dbname=" + dbname + "&formgroup=" + formgroup+ "&HitID=" + uniqueid)
		}else{
			MainWindow.UserInfoWindow.location.replace(app_Path + "/user_info.asp?dbname=" + dbname + "&formgroup=" + formgroup + "&HitID=" + uniqueid)
		}
}	
...
function doMarkAll(uniqueid){
		...
		if(MainWindow.UserInfoWindow != self){
			MainWindow.UserInfoWindow.document.location.replace(app_Path + "/user_info.asp?dbname=" + dbname + "&formgroup=" + formgroup)
		}else{
			MainWindow.UserInfoWindow.location.replace(app_Path + "/user_info.asp?dbname=" + dbname + "&formgroup=" + formgroup)
		}
}
