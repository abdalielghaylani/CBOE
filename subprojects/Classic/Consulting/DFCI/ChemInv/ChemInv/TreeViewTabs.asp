<%
	...
	TabView.QueryString = "ClearNodes=0&TreeID=" & TreeID & "&MaybeLocSearch=" & MaybeLocSearch & "&formelm=" & formelm & "&elm1=" & elm1 & "&elm2=" & elm2 & "&elm3=" & elm3 & "&LocationPickerID=" & LocationPickerID & "&NodeURL=" & NodeURL & "&NodeTarget=" & NodeTarget & "&GotoNode=0"
