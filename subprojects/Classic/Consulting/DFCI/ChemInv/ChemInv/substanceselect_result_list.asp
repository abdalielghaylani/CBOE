...
sql = "SELECT inv_compounds.compound_id,inv_compounds.acx_id, inv_compounds.CAS,inv_compounds.Substance_Name,inv_compounds.BASE64_CDX FROM inv_compounds WHERE inv_compounds.Compound_ID =" & BaseID
				...
				<td align="center" valign="top" width="194" nowrap>
					...
					<div align="left">
						<font size="1" face="Arial">
 									...
 									<% response.write "<BR><strong>Catalog Number:</strong> " & ACX_ID & "" %>							<strong>
							...
							%>
								...
								<%	response.write "<br><strong>Brand/ Description:</strong>" & SubstanceName & "" %>
							<br>
						</font>
					</div>
