...
<html>
<head>
<title><%=Application("appTitle")%> -- Create Par Levels From Excel</title>
...
<body>
<center>
<FORM name="form1" method="post" encType="multipart/form-data" action="CreateFORECASTFromExcel_action.asp">
<span class="GuiFeedback"><% if errmsg <> "" then %><%=errmsg%><% else %>
Par levels will be created from the first Sheet in the excel file (Location barcode, NDC, amount).<% end if %>
</span>
<table border="0">
	<tr>
		<td colspan="2">
