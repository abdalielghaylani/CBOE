...
If bWriteError then
	...
	Response.end
End if
strSQL = "SELECT Location_ID, Location_Barcode, Location_Name, " & Application("CHEMINV_USERNAME") & ".racks.isRackLocation(location_id) + " & Application("CHEMINV_USERNAME") & ".racks.isRack(location_id) FROM inv_Locations WHERE Location_ID=" & LocationID
