...
If IsEmpty(Amount) then
	strError = strError & "Amount is a required parameter<BR>"
	bWriteError = True
End if
...
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".Requests.DFCI_UpdateParLevel", adCmdStoredProc)
...
Cmd.Parameters.Append Cmd.CreateParameter("PAmount",adNumeric, adParamInput, , Amount) 
Cmd.Parameters("PAmount").Precision = 9
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".Requests.DFCI_UpdateParLevel")
End if
