CREATE OR REPLACE PACKAGE BODY "REFORMAT" AS
  ...
  */
	...
	BEGIN
		...
		l_query     := 'SELECT plate_id_fk, well_id as parent_well_id_fk, row_index, col_index,wc.compound_id_fk AS compound_id_fk,wc.reg_id_fk AS reg_id_fk, wc.batch_number_fk as batch_number_fk
