...
--' This is the parameters clause for creation of the CS Cartridge index on the inv_compounds table
DEFINE cscartIndexOptions = 'TABLESPACE=&&cscartTableSpaceName'