...
BEGIN
  ...
  --update location_id
    ...
    l_locationId := xmldom.getAttribute(vElement,'LOCATION_ID_FK');
		xmldom.setAttribute(vElement,'LOCATION_ID_FK',guiutils.GetLocationId(l_locationId, NULL, NULL, NULL));
    --xmldom.setValue(xmldom.getAttributeNode(l_element, 'LOCATION_ID_FK'),	p_locationID);
