...
GRANT SELECT ON cs_security.security_roles TO &&schemaName;
GRANT SELECT ON cs_security.privilege_tables TO &&schemaName;
...
GRANT SELECT ON security_roles to inv_role_locations;

INSERT INTO CS_SECURITY.OBJECT_PRIVILEGES VALUES ('CSS_CREATE_ROLE', 'SELECT', '&&SchemaName', 'SECURITY_ROLES');
