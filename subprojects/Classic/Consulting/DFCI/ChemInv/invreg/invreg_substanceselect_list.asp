...
if  plugin_value  then
	displayType = "cdx"
	zoomFunction = "ACX_getStrucZoomBtn('INV_VW_REG_STRUCTURES.BASE64_CDX'," & cpdDBCounter & ")"
else
	displayType = "SizedGif"
	zoomFunction = "ACX_getStrucZoomBtn('INV_VW_REG_STRUCTURES.BASE64_CDX'," & cpdDBCounter & ",500,450)"
end if
