...
if Session("returnaction") <> "" then
	...
	cancel_url = "http://" & Request.ServerVariables("Server_Name") & "/ChemInv/default.asp?formgroup=" & Session("returnaction") & "&dataaction=db&dbname=cheminv&Showbanner=True&formmode=&ClearCurrentLocation=1"
else
	cancel_url = "http://" & Request.ServerVariables("Server_Name") & "/cs_security/home.asp"
end if
