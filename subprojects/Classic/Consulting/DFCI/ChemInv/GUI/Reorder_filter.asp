...
<title><%=Application("appTitle")%> -- Reorder Drugs For Par Levels</title>
...
<br clear="all">
<form name="form1" target="DisplayFrame" action="reorder_display.asp" method="POST">
<table border="1" bordercolor="666666" cellpadding="1" cellspacing="0">
	<tr>
		<td colspan="4" align="Center">
			<b>Reorder Drugs for Central Sites</b>		
		</td>
	</tr>	
	<tr>
		<td rowspan="3" valign="top">
			<table>
				...
				<tr>
					...
					<td valign="top">
					<%= ShowPickList("Location", "iLocationId", "","select location_barcode || ' ' || location_name  as displaytext, location_id as value from inv_locations where location_type_id_fk in (1000, 1001) order by location_name")%>
				...
				<tr>
					...
					<td valign="top">
						<input type="text" name="BumpUp" value="" size="12">
					</td>
					<td align="right" valign="top" nowrap>
					</td>
					<td valign="top">
