...
%>
	...
	<tr>
		...
		<%'LocationID = Session("LocationID")%>
			<%ShowLocationPicker3 "document.form1", "LocationID", "lpLocationBarCode", "lpLocationName", 10, 30, false, "UpdateAddress(document.form1.LocationID.value);"%> 
		</td>
	</tr>
	<%else%>
	<tr>
		...
		<input TYPE="Text" SIZE="10" Value name="lpLocationBarCode" onchange="UpdateLocationPickerFromBarCode(this.value, document.form1,'LocationID','lpLocationBarCode', 'lpLocationName')" <%=IIF((OrderStatusID="1" or OrderStatusID=""),"","class=""readOnly"" READONLY")%>>
