...
showPK = "inv_owners, inv_project_job_info, inv_country, inv_custom_field_groups"
%>
<html>
<head>
...
if TableName <> "" then
	...
	SQL = "SELECT * FROM all_cons_columns WHERE owner = '" & dbOwner & "' AND table_name = '" & dbTrueTableName & "'"
	...
	if pkColumnName="Invalid table specified" then 
	pkColumnName="ID"
	END IF
	...
	SQL = "SELECT * FROM all_tab_columns WHERE owner = '" & dbOwner & "' AND table_name = '" & dbTableName & "'"
