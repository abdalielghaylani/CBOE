...
<br clear="all">
<form name="form1" target="DisplayFrame" action="replenishment_display.asp" method="POST">
		...
		<td rowspan="3" valign="top">
			<table>
				...
				<tr>
					...
					<%= ShowPickList("Location", "iLocationId", "","select location_barcode || ' ' || location_name  as displaytext, location_id as value from inv_locations where location_type_id_fk not in (1000,1003,1004) and location_type_id_fk>1000 order by location_name")%>
