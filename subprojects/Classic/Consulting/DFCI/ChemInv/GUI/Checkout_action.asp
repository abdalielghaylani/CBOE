...
FormData = FormData & "&iField_9=" & Request("LocationId") 
FormData = FormData & Credentials
'Response.Write(FormData)
'Response.end
httpResponse = CShttpRequest2("POST", ServerName, "/cheminv/api/CheckOutContainer.asp", "ChemInv", FormData & "&iField_4=MOVE_FROM")
'response.write httpResponse
'response.end 
httpResponse = CShttpRequest2("POST", ServerName, "/cheminv/api/CheckOutContainer.asp", "ChemInv", FormData & "&iField_4=MOVE_TO")
'Response.Write httpResponse 
'Response.End
%>
<html>
