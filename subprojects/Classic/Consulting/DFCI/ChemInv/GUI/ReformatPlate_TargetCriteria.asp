...
<table border="0" cellspacing="0" cellpadding="1">
	<tr>
		...
		<tr height="25">
			...
			<td>
				...
				<input type="radio" name="AutoGen_r" onclick="AutoGen_OnClick(this);" value="1">Auto-generate barcode from barcode description<BR>
	...
	<tr>
		...
		<td>
			&nbsp;<%=GetBarcodeIcon()%>&nbsp;<%ShowLocationPicker2 "document.form1", "LocationID", "lpLocationBarCode" & num, "lpLocationName" & num, 10, 28, false, Session("CurrentLocationID")%> 
		</td>
	</tr>	
	<tr>
