...
<script language="JavaScript">
	function Validate(){
		...
		if (document.form1.NDC.value=="" && document.form1.DrugName.value=="")
		{
			bWriteError = true
			errmsg += "- You must fill in either a drug name or NDC code.\n"	
		}
		if(errmsg!="")
		{
...
<br clear="all">
<form name="form1" target="DisplayFrame" action="bulkmove_display.asp" method="POST">
<table border="1" bordercolor="666666" cellpadding="1" cellspacing="0">
	<tr>
		<td colspan="4" align="Center">
			<b>Bulk Move Supplies</b>		
		</td>
	</tr>	
	<tr>
			...
			<table>
				...
				<tr>
					...
					<%
						...
						locationsql=" location_type_id_fk>=1000 "
					

 					%>
					<input type="hidden" name="targetlocationid" value="<%=request("targetlocationid")%>">	
					<%= ShowPickList2("Location", "iLocationId", "","select location_barcode || ' ' || location_name  as displaytext, location_id as value from inv_locations where  " & locationSQL & " order by location_name",25," ","","")%>
				...
				<tr>
					...
					<td valign="top">
						<input type="text" name="DrugName" value="" size="30" maxsize="50">
					</td>
					<td valign="top">
					</td>
					<td></td>
