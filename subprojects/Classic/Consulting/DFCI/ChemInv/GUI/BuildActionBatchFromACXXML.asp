...
'response.write Ubound(PackageID_arr) 
'response.end
For i = 0 to Ubound(PackageID_arr)
	...
	PackageNode.SelectSingleNode("@ContainerSize").text= InitialAmount_arr(i)*ContainerCount_arr(i)*Qty_arr(i)
	Call AddAttributeToElement(oACXxml, PackageNode, "initialQty", InitialAmount_arr(i)*ContainerCount_arr(i)*Qty_arr(i))
	Call AddAttributeToElement(oACXxml, PackageNode, "QtyRemaining", InitialAmount_arr(i)*ContainerCount_arr(i)*Qty_arr(i))
	...
	Call AddAttributeToElement(oACXxml, PackageNode, "NumCopies", 1)
	'MCD: extra ordering fields
	...
	End if
	'PJD add PO and reqnumber
	Call AddAttributeToElement(oACXxml, PackageNode, "PONumber", PO)
	Call AddAttributeToElement(oACXxml, PackageNode, "ReqNumber", i+1)
