...
<%
	...
	Else
		While (Not RS.EOF)
			...
			editData = "URLID=" & URLID & "&URLhref=" & Server.URLEncode(URLhref) & "&Link_text=" & replace(Link_Text,"'","\'") & "&URLType=" & URLType & "&Image_source=" & strImageSource & "&FK_value=" & FK_value & "&FK_name=" & FK_name & "&Table_Name=" & Table_Name & "&LinkType=" & LinkType
%>
			<tr>
				<td align="center">
					<%=Table_Name%>
