...
<table border="1" bordercolor="666666" cellpadding="1" cellspacing="0">
	...
	<tr>
		...
		<td rowspan="3" valign="bottom" align="center">
			...
			<a class="MenuLink" HREF="#" onclick="document.form1.submit(); return false;"><img src="/cheminv/graphics/sq_btn/filter.gif" alt="Click to filter the display" border=0 /></a><br />
			<%=GetCloseButton()%>
		</td>
	</tr>
</table>
