	...
	if right(fieldName,2) = "fk" then
		Select case fieldName
			...
			Case "Compound:compound_id_fk"
				...
				theRow = theRow & "<input TYPE=""hidden"" NAME=""tempCsUserID"" Value=""" & Server.URLEncode(CryptVBS(lcase(Session("UserID" & "cheminv")),Session("UserName" & "cheminv"))) & """></TD></TR>"
...
if fieldColumns = "container_status_id_fk" then
%>
    <tr>
		...
		<td>		
			<textarea rows="6" cols="40" NAME="icontainer_comments"></textarea>
		</td>
	</tr>
<%
end if
