		...
		<TD HEIGHT=50 VALIGN=MIDDLE NOWRAP>
			...
			If IsNumeric(httpresponse) then 
				If Clng(httpResponse) > 0 then
					...
					Response.Write "<P><center><a HREF=""Ok"" onclick=""if(opener.cows_input_form){opener.location.reload();}else{SelectLocationNode(0, " & Request("cLocationID") & ", 0, '" & Session("TreeViewOpenNodes1") & "'," & containerId & "); }opener.focus(); window.close(); return false;""><img SRC=""/cheminv/graphics/sq_btn/ok_dialog_btn.gif"" border=""0"" title=""Close dialog window""></a></center>"		
