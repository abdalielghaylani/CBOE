...
BEGIN
	populateCartridgeIndex('MX', 'substance', 'base64_cdx');
END;
/

prompt 'analyzing cartridge schema'

connect &&installUer/&&sysPass@&&serverName
begin
	dbms_stats.gather_schema_stats(ownname=> 'CSCARTRIDGE' , cascade=> TRUE);
end;
/
