...
df.document.write('<input type=hidden name=strucid value=' + strucid +'>'); 
 ...
 if (ShowMSDSLinks){
	df.document.write(' | ');
	if ((ProdWRS.hasmsds[Row])||(msdxLinkText != "MSDX")){
		var QS="";
	   ...
	   df.document.write('<a href="#" disabled title="No materials safety data available" class="MenuLink" onclick="return false;">' +  msdxLinkText + '</a>')	
	}
 }
...
if (numpacks) {
 df.document.write('						<small>PackID</small>');
 df.document.write('					</td>');
 df.document.write('					<td align=center>');
...
df.document.write('						</small>');	
 df.document.write('					</td>');
	...
	// df.document.write(' onfocus=blur() align=top>');
 	df.document.write(' onchange="top.bannerFrame.AddtoShopcartWRS(\'' + scpayload +  '\',\'2\'); return false" align=top>');
	 df.document.write('								</td>');
	 df.document.write('							</tr>');
	 df.document.write('						</table>');
	 df.document.write('				</td>');
