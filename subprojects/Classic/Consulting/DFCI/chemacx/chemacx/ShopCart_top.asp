...
var prefix = 'javascript:parent.TopFrame.';
	          ...
	          write( '<tr>' +
			   ...
			   '<td><input size=3 name=qty_'+ Row +  ' value=' + top.opener.ShopcartWRS.qty[Row]  + ' onchange=" parent.TopFrame.Recalculate('+ Row +');return false;" ></td>' +
				...
				//write('<td align=right><small>$' +   subtot  + '</small></td>');  
                 write('<td width=50 align=center><small>'   + '<a href=' + prefix + 'DeleteRow('+ Row +')><img border=0 src=<%=Application("NavButtonGifPath")%>remove_btn.gif alt=\"Remove from cart\" align=middle></a>'     + '</small></td></tr>');
