...
sList = GetListFromSQLRow("SELECT owner_id_fk, " & Application("ORASCHEMANAME") & ".GUIUTILS.GetLocationPath(inv_locations.location_id) AS Path from inv_locations WHERE location_id=" & LocationID)
aList = split(sList,",")
