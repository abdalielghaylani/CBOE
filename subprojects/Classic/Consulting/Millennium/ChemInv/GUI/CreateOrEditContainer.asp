...
<input TYPE="hidden" NAME="tempCsUserID" Value=<%=Server.URLEncode(CryptVBS(lcase(Session("UserID" & "cheminv")),Session("UserName" & "cheminv")))%>>
...
%>
	<tr height="25">
		...
		<td colspan="3">
            ...
            &nbsp;<%=GetBarcodeIcon()%>&nbsp;<%ShowLocationPicker7 "document.form1", "iLocationID", "lpLocationBarCode", "lpLocationName", 10, 49, false, "", LocationID %>
		</td>
	</tr>
	<tr height="25">
		<td align="right" valign="top" nowrap width="150">
	...
	<tr height="25">
		...
		<%else%>
			<td width="200" align="right">Compound ID:</td><td><input type="text" Size="15" name="iCompoundID" value="<%=CompoundID%>" onchange="if(IsValidCompoundID(this.value, true)==1){NewCompoundID.value= this.value;}else{this.value = '';}"></td>
		<%End if%>
