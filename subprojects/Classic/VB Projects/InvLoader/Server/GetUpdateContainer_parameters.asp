<% 
Sub GetUpdateContainer_parameters()
    Cmd.Parameters.Append Cmd.CreateParameter("RETURN_VALUE",adNumeric, adParamReturnValue, 0, NULL)
        Cmd.Parameters("RETURN_VALUE").Precision = 9
    Cmd.Parameters.Append Cmd.CreateParameter("PCONTAINERID",131, 1, 0, NULL)
...
'    Cmd.Parameters.Append Cmd.CreateParameter("PINITIALQTY",5, 1, 0, NULL)
    ...
    Cmd.Parameters.Append Cmd.CreateParameter("PDATECERTIFIED",135, 1, 0, NULL) 
    Cmd.Parameters.Append Cmd.CreateParameter("PDATEAPPROVED",135, 1, 0, NULL) 
