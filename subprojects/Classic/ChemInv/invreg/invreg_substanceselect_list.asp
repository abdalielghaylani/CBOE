				...
				<td valign="top" nowrap>
					<table border="0" cellpadding="0" cellspacing="0" width="80">
						<tr>
							...
							<td width="54"><a href="Synonyms" onClick="openSynWindow(100,200, <%=BaseID%>,<%=BaseRunningIndex%>);return false"><img src="<%=Application("NavButtonGifPath")%>names_blue.gif" alt border="0"><nobr></a></td>
							<td width="54">
								<script language="JavaScript">getFormViewBtn("details_blue.gif","invreg_substanceselect_form.asp","<%=BaseActualIndex%>", "edit")</script></td>
							</td>
							...
							%>
								<td nowrap>Reg#: <a target="_new" title="View this subtance in the Chemical Registration System" href="<%=Application("SERVER_TYPE") & Application("RegServerName")%>/chem_reg/default.asp?formgroup=base_form_group&amp;dbname=reg&amp;dataaction=query_string&amp;full_field_name=Reg_Numbers.Reg_ID&amp;field_value=<%=Reg_ID%>"><%=baseRegNumber%></a></td>
							<% 
							else
							%>
					...
					<div align="center">
						<font size="1" face="Arial">
							<strong>
								...
								if Application("INVREG_USERNAME") = "REGDB" then
								%>
									<a target="_new" title="View this subtance in the Chemical Registration System" href="<%=Application("SERVER_TYPE") & Application("RegServerName")%>/chem_reg/default.asp?formgroup=base_form_group&amp;dbname=reg&amp;dataaction=query_string&amp;full_field_name=Reg_Numbers.Reg_ID&amp;field_value=<%=Reg_ID%>"><%=baseRegNumber%></a>
								<% 
								else
								%>
									<%=baseRegNumber%><br>
