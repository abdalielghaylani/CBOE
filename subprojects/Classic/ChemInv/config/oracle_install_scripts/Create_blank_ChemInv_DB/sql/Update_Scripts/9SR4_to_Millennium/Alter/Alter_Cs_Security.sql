...
-- new view
GRANT SELECT,INSERT,UPDATE,DELETE ON "&&SchemaName".VIEW_INV_CUSTOM_FIELDS TO &&securitySchemaName WITH GRANT OPTION;
...
INSERT INTO &&securitySchemaName..OBJECT_PRIVILEGES VALUES ('INV_BROWSE_ALL', 'SELECT', '&&SchemaName', 'VIEW_INV_CUSTOM_FIELDS');
-- INV_MANAGE_CUSTOM_FIELDS PRIVS
INSERT INTO &&securitySchemaName..OBJECT_PRIVILEGES VALUES ('INV_MANAGE_CUSTOM_FIELDS', 'INSERT', '&&SchemaName', 'VIEW_INV_CUSTOM_FIELDS');
INSERT INTO &&securitySchemaName..OBJECT_PRIVILEGES VALUES ('INV_MANAGE_CUSTOM_FIELDS', 'UPDATE', '&&SchemaName', 'VIEW_INV_CUSTOM_FIELDS');
INSERT INTO &&securitySchemaName..OBJECT_PRIVILEGES VALUES ('INV_MANAGE_CUSTOM_FIELDS', 'DELETE', '&&SchemaName', 'VIEW_INV_CUSTOM_FIELDS');
commit;
