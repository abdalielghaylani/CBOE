...
alter table INV_REQUESTS
  ...
  references &&securitySchemaName..PEOPLE (USER_ID);
-- Create/Recreate indexes 
...
--' Alter &&securitySchemaName to integrate the Inventory application
prompt '#########################################################'
prompt 'Altering the &&securitySchemaName schema...'
prompt '#########################################################'

--' Grant all cheminvdb2 object permissions to &&securitySchemaName   
Connect &&schemaName/&&schemaPass@&&serverName
...
--' Create &&securitySchemaName objects and data for Inventory 
connect &&securitySchemaName/&&securitySchemaPass@&&serverName;
