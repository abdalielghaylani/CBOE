...
--run this script to update to IM9 SR1.
set echo off
...
@@triggers\trg_inv_wells_molar_calcs.sql
...
--plsql
@@FUNCTIONS\f_CheckInDefaultLocation.SQL
...
--cs_security grants
GRANT SELECT ON INV_DATA_MAPS TO &&securitySchemaName WITH GRANT OPTION;
GRANT SELECT ON INV_DATA_MAPPINGS TO &&securitySchemaName WITH GRANT OPTION;
GRANT SELECT ON INV_MAP_FIELDS TO &&securitySchemaName WITH GRANT OPTION;
GRANT EXECUTE ON DATAMAPS TO &&securitySchemaName WITH GRANT OPTION;
