...
ELSE
      ...
      SELECT	request_id,
        ...
        GETLOCATIONPATH(l.location_id) AS LocationPath,
        ivrb.*
      FROM inv_requests r, inv_locations l, &&securitySchemaName..people p1,&&securitySchemaName..people p2, inv_container_types ct, inv_request_status rs, inv_container_batches icb, inv_vw_reg_batches ivrb,inv_containers c
      WHERE	r.user_id_fk = p1.user_id(+)
      AND   r.batch_id_fk = icb.batch_id(+)
