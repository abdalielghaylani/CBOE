...
spool ..\LOG_Update_Inventory_9SR4_to_10.txt
...
prompt recreating cs_security foreign keys...
ALTER TABLE INV_CONTAINERS DROP CONSTRAINT  INV_CONT_CURRUSERID_FK;
ALTER TABLE INV_CONTAINERS ADD
CONSTRAINT "INV_CONT_CURRUSERID_FK"
  	FOREIGN KEY("CURRENT_USER_ID_FK")
    REFERENCES "PEOPLE"("USER_ID");

ALTER TABLE INV_REQUESTS DROP CONSTRAINT  INV_REQ_ASSIGNED_USER_ID_FK;
ALTER TABLE INV_REQUESTS ADD
CONSTRAINT "INV_REQ_ASSIGNED_USER_ID_FK"
		FOREIGN KEY ("ASSIGNED_USER_ID_FK")
		REFERENCES "PEOPLE" ("USER_ID");

ALTER TABLE INV_RESERVATIONS DROP CONSTRAINT  INV_RESV_USERID_FK;
ALTER TABLE INV_RESERVATIONS ADD
CONSTRAINT "INV_RESV_USERID_FK"
  	FOREIGN KEY("USER_ID_FK")
	REFERENCES "PEOPLE"("USER_ID");

ALTER TABLE INV_ORG_USERS DROP CONSTRAINT  INV_ORG_USER_ID_FK;
ALTER TABLE INV_ORG_USERS ADD
CONSTRAINT "INV_ORG_USER_ID_FK"
		FOREIGN KEY ("USER_ID_FK")
		REFERENCES "PEOPLE" ("USER_ID");

ALTER TABLE INV_ORG_ROLES DROP CONSTRAINT  INV_ORG_ROLE_ID_FK;
ALTER TABLE INV_ORG_ROLES ADD
CONSTRAINT "INV_ORG_ROLE_ID_FK"
		FOREIGN KEY ("ROLE_ID_FK")
		REFERENCES SECURITY_ROLES ("ROLE_ID");

ALTER TABLE INV_CONTAINER_CHECKIN_DETAILS DROP CONSTRAINT  INV_CON_CHECKIN_USERID_FK;
ALTER TABLE INV_CONTAINER_CHECKIN_DETAILS ADD
CONSTRAINT "INV_CON_CHECKIN_USERID_FK"
  	FOREIGN KEY("USER_ID_FK")
    REFERENCES "PEOPLE"("USER_ID");

ALTER TABLE EXT_CONTAINERS DROP CONSTRAINT  INV_CONT_CURRUSERID_FK_1;
ALTER TABLE EXT_CONTAINERS ADD
CONSTRAINT "INV_CONT_CURRUSERID_FK_1"
  	FOREIGN KEY("CURRENT_USER_ID_FK")
    REFERENCES "PEOPLE"("USER_ID");
