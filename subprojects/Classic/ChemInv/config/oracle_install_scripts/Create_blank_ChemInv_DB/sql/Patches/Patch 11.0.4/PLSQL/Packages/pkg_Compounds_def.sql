...
-- Updates inv_compounds with the new reg id and batch number values for registered compounds in scenarios where the registered batch is moved to other compound etc.                        
