...
v_TempLocation_ID_FK Inv_Containers.Location_ID_FK%Type;
...
BEGIN
	...
	select guiutils.GetLocationId(v_Location_ID_FK, pContainerID, NULL, NULL) into v_TempLocation_ID_FK from dual ;
	...
	VALUES (
		NULL,
		DECODE(v_TempLocation_ID_FK,NULL,4,v_TempLocation_ID_FK),
		v_Compound_ID_FK,
		NULL,
		v_Reg_ID_FK,
		v_Batch_Number_FK,
