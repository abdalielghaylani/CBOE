Create or replace FUNCTION  &&schemaName..GETSALTNAME(p_mixtureid in number, p_batch_internal_id in Number)
  Return varchar2 DETERMINISTIC is
  Result varchar2(2000):=' ';
--  cpdID Integer;
Begin
select rtrim(replace(substr(wm_concat(description||'&'),1, 2000),'&,',';'),'&') into Result from (
