CREATE OR REPLACE
FUNCTION CHEMINVDB2."UPDATEALLCONTAINERFIELDS"
...
--CSBR ID   : 137548 SJ
--Comments :  Adding condition to check if quantity entered is greater than Container size                     
if pQtyRemaining > pMaxQty then
...
SET
  ...
  Container_Name = NVL(pContainerName,Container_Name), --CSBR 161683 
...
WHEN excess_contents then
	--RETURN 'Amount cannot exceed container size';
RETURN -103;
