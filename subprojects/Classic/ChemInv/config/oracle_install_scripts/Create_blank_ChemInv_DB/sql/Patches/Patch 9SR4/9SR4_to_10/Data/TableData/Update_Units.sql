...
BEGIN
	...
	--select nvl(unit_id, 0) into ea_unit_id from inv_units where unit_name = 'each' and unit_abreviation = 'ea';
	--select nvl(unit_id, 0) into um_unit_id from inv_units where unit_name = 'micromolar' and unit_abreviation = 'uM';
