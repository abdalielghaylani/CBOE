...
INSERT INTO COEDB.OBJECT_PRIVILEGES VALUES('INV_BROWSE_ALL','EXECUTE','CHEMINVDB2','UPDATENONNULLCONTAINERFIELDS');
COMMIT;

--'Grant roles based on privileges
begin
 ...
 LOOP
  EXECUTE IMMEDIATE 'GRANT EXECUTE ON &&SchemaName..UpdateNonnullContainerFields' || ' TO ' || role_rec.role_name;
 END LOOP;
end;
/
show errors;
