CREATE OR REPLACE PACKAGE BODY ORGANIZATION
	...
	BEGIN
        ...
        IF p_Users is not NULL THEN
          ...
          LOOP
            EXECUTE IMMEDIATE 
            'INSERT INTO INV_ORG_USERS (USER_ID_FK,ORG_UNIT_ID_FK) VALUES (:UserIDs, :NewOrgUnitID)' USING l_UserIDs(i), l_NewOrgUnitID;
          END LOOP ;
        END IF;
        ...
        IF p_Roles is not NULL THEN
          ...
          LOOP
            EXECUTE IMMEDIATE 
            'INSERT INTO INV_ORG_ROLES (ROLE_ID_FK,ORG_UNIT_ID_FK) VALUES ( :RoleIDs, :NewOrgUnitID)' USING l_RoleIDs(i), l_NewOrgUnitID;
          END LOOP ;
        END IF;
	...
	BEGIN
        ...
        IF p_Users is not NULL THEN
          ...
          LOOP
            EXECUTE IMMEDIATE 
            'INSERT INTO INV_ORG_USERS (USER_ID_FK,ORG_UNIT_ID_FK) VALUES (:UserIDs, :OrgUnitID)' USING l_UserIDs(i), p_OrgUnitID;
          END LOOP ;
        END IF;
        ...
        IF p_Roles is not NULL THEN
          ...
          LOOP
            EXECUTE IMMEDIATE 
            'INSERT INTO INV_ORG_ROLES (ROLE_ID_FK,ORG_UNIT_ID_FK) VALUES ( :RoleIDs(i) ,:OrgUnitID)' USING l_RoleIDs(i), p_OrgUnitID;
          END LOOP ;
        END IF;
