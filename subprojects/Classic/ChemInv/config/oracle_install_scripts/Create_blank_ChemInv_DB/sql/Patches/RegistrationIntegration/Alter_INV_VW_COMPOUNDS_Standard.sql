PROMPT Starting Alter_INV_VW_COMPOUNDS_Standard.sql
...
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_CPD_IDX ON &&schemaName..INV_VW_COMPOUNDS(COMPOUND_ID ASC) TABLESPACE &&indexTableSpaceName;
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_CAS_IDX ON &&schemaName..INV_VW_COMPOUNDS(CAS ASC) TABLESPACE &&indexTableSpaceName;
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_ACXID_IDX ON &&schemaName..INV_VW_COMPOUNDS(ACX_ID ASC) TABLESPACE &&indexTableSpaceName;
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_ic_rowid_IDX ON &&schemaName..INV_VW_COMPOUNDS(ic_rowid ASC) TABLESPACE &&indexTableSpaceName; 
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_rn_rowid_IDX ON &&schemaName..INV_VW_COMPOUNDS(rn_rowid ASC) TABLESPACE &&indexTableSpaceName; 
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_s_rowid_IDX ON &&schemaName..INV_VW_COMPOUNDS(s_rowid ASC) TABLESPACE &&indexTableSpaceName; 
CREATE INDEX &&schemaName..INV_VW_COMPOUNDS_b_rowid_IDX ON &&schemaName..INV_VW_COMPOUNDS(b_rowid ASC) TABLESPACE &&indexTableSpaceName;
