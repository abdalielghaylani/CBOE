PROMPT Starting Alter_INV_VW_REG_BATCHES.sql
...
CREATE INDEX &&schemaName..VWREGBAT_REGNUMBER_IDX ON &&schemaName..INV_VW_REG_BATCHES(REGNUMBER ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGID_IDX ON &&schemaName..INV_VW_REG_BATCHES(REGID ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGBATCHID_IDX ON &&schemaName..INV_VW_REG_BATCHES(REGBATCHID ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGNOTEBOOK_IDX ON &&schemaName..INV_VW_REG_BATCHES(REGNOTEBOOK ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGSEQUENCE_IDX ON &&schemaName..INV_VW_REG_BATCHES(REGSEQUENCE ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGNUMBER_FIDX ON &&schemaName..INV_VW_REG_BATCHES(lower(REGNUMBER) ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGBATCHID_FIDX ON &&schemaName..INV_VW_REG_BATCHES(lower(REGBATCHID) ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_REGNOTEBOOK_FIDX ON &&schemaName..INV_VW_REG_BATCHES(lower(REGNOTEBOOK) ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_RNRID ON &&schemaName..INV_VW_REG_BATCHES(rnRowid ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_BRID ON &&schemaName..INV_VW_REG_BATCHES(bRowid ASC) TABLESPACE &&indexTableSpaceName ONLINE;
CREATE INDEX &&schemaName..VWREGBAT_MRID ON &&schemaName..INV_VW_REG_BATCHES(mRowid ASC) TABLESPACE &&indexTableSpaceName ONLINE;
