...
@@PLSQL\Triggers\inv_plates_biu0.sql
@@PLSQL\Triggers\inv_plates_au0.sql
@@PLSQL\Triggers\inv_plates_ad0.sql
@@PLSQL\Triggers\inv_wells_biu0.sql
@@PLSQL\Triggers\inv_wells_au0.sql
@@PLSQL\Triggers\inv_wells_ad0.sql