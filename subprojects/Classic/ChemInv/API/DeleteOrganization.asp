...
bDebugPrint = false
bWriteError = False
strError = "Error:DeleteOrganization<BR>"
...
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cheminv/help/admin/api/DeleteOrganization.htm"
	Response.end
End if
...
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".ORGANIZATION.DELETEORGANIZATION", adCmdStoredProc)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".ORGANIZATION.DELETEORGANIZATION")
End if
