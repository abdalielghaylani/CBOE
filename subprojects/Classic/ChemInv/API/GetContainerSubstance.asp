...
bDebugPrint = false
bWriteError = False
strError = "Error:GetContainerSubstance<BR>"
...
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cheminv/help/admin/api/GetContainerSubstance.htm"
	Response.end
End if
...
GetInvConnection()
Set Cmd = GetCommand(Conn, InvSchema & ".GUIUTILS.GETCONTAINERSUBSTANCE", 4)		 
