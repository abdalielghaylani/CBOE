...
bDebugPrint = false
bWriteError = false
strError = "Error:CreateBatchRequest<BR>"
...
'Response.Write(BatchID)
'Response.End


'-- Set up and ADO command
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".REQUESTS.CreateBatchRequest", adCmdStoredProc)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".REQUESTS.CreateBatchRequest")
End if
