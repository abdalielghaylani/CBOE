...
'ScriptUtilities has two types of the include. This (1) is full version 
'using ScriptUtilities library. Include (2) is in the free version.
...
'.Value = Binary value of the source field. You can convert it to a string 
'by String method : GetUpload.FieldName.Value.String
...
Function GetUpload()
	...
	If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
		...
		If LCase(Left(CT, 19)) = "multipart/form-data" Then 
			...
			If PosB > 0 Then 
				Boundary = Mid(CT, PosB + 9) 'Separetes boundary
			End if
			...
			End If
		Else 'Content-Type header is not "multipart/form-data"
