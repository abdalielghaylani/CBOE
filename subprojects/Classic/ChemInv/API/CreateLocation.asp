...
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cheminv/help/admin/api/CreateLocation.htm"
	Response.end
End if
...
If isEmpty(CollapseChildNodes) or CollapseChildNodes = "" then CollapseChildNodes = NULL
If bWriteError then
	' Respond with Error
...
Cmd.Parameters.Append Cmd.CreateParameter("P_COLLAPSECHILDNODES",131, 1, 0, CollapseChildNodes)
Cmd.Parameters("P_COLLAPSECHILDNODES").Precision = 9
if  Application("ENABLE_OWNERSHIP")="TRUE" then
...
Cmd.Parameters("pIspublic").NumericScale = 0
Cmd.Parameters("pIspublic").Precision = 8
end if
if bDebugPrint then
