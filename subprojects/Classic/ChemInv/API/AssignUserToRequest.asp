...
bDebugPrint = false
bWriteError = False
strError = "Error:AssignUserToRequest<br>"
...
If Len(Request.QueryString) = 0 AND Len(Request.Form)= 0 then
	Response.Redirect "/cheminv/help/admin/api/AssignUserToRequest.htm"
	Response.end
End if
...
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".REQUESTS.UPDATEASSIGNEDTOUSER", adCmdStoredProc)
...
Cmd.Parameters.Append Cmd.CreateParameter("pAssignedToUser",200, adParamInput, 30, UserID)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".REQUESTS.UPDATEASSIGNEDTOUSER")
End if
