...
For each Key in custom_createrequest_fields_dict
	...
	reqHtml = reqHtml & "<td class=""grayBackground"">" & TempValue & "</td></tr>" & vbcrlf
Next
...
'			regHtml = regHtml & "<tr><td align=""right"">" & reg_fields_dict.item(key) & ":</td><td class=""grayBackground"">" & RS(key) & "</td></tr>"
'		end if
'	next
'end if
'RS.Close()
...
strHtml = strHtml & "<tr><td colspan=""2"" align=""center"" bgcolor=""#e1e1e1"" style=""border-bottom:1px solid #000000;""><b>" & caption & "</b></td></tr>" & vbcrlf
strHtml = strHtml & "<tr><td valign=""top"">" & vbcrlf
strHtml = strHtml & "	<table border=""0"" class=""receipt"">" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Request ID:</td><td class=""grayBackground"">" & RequestID & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Date Required:</td><td class=""grayBackground"">" & DateRequired & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Date Delivered:</td><td class=""grayBackground"">" & DateDelivered & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Requested By:</td><td class=""grayBackground"">" & RequestedBy & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Requested For:</td><td class=""grayBackground"">" & RequestedFor & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Amount Requested:</td><td class=""grayBackground"">" & FormatNumber(QtyRequired,2) & "&nbsp;" & UOMAbbrv & "</td></tr>" & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"">Amount Delivered:</td><td class=""grayBackground"">" & FormatNumber(QtySelected,2) & "&nbsp;" & UOMAbbrv & "</td></tr>" & vbcrlf
strHtml = strHtml & reqHtml & vbcrlf
strHtml = strHtml & "		<tr><td align=""right"" valign=""top"">Comments:</td><td class=""grayBackground"">" & comments & "</td></tr>" & vbcrlf
