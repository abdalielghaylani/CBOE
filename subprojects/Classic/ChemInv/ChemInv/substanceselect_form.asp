...
<tr>
	<td colspan="2" align="right">
		...
		<a HREF="#" onclick="DoSelectSubstance(<%=BaseID%>, document.cows_input_form.SubstanceName.value); return false;"><img SRC="/cheminv/graphics/sq_btn/ok_dialog_btn.gif" border="0"></a>
	</td>
</tr>
</table>
</center>
