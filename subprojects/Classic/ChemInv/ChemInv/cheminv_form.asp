...
<html>
	<head>
		<title><%=Application("appTitle")%> -- Results-Form View</title>
		...
		<script language="JavaScript" src="<%=Application("acxprod_display")%>"></script>
	...
	<table border="1" cellpadding="0" cellspacing="0" width="210">
				...
				<td colspan="2">			
					<table border="0" cellpadding="0" cellspacing="0" width="205">
						<tr>
							...
							<td><a href="Table%20View" onclick="getAction('list_view');return false;"><img border="0" SRC="<%=Application("NavButtonGifPath")%>list_view_btn.gif"></a></td>
			...
			<tr>
				<td colspan="2" align="center" bgcolor="white" valign="middle">
					<%ShowCFWChemResult dbkey, formgroup, "Structure", "inv_compounds.Structure", BaseID, displayType, 185, 130%>	
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					...
					<%
					if BaseRS("CAS") <> "" then
					 	response.write "CAS#: " & BaseRS("CAS")
					else
						response.write "CAS#: n/a"
					end if
					%>
					</strong><br></font>
				</td>
			...
			<tr>
				...
				<small>&nbsp;<%ShowCFWChemResult dbkey, formgroup, "Formula", "inv_compounds.Formula", BaseID, "raw", 20, 20%></small>
				</td>
			</tr>
			<tr>
				...
				<td bgcolor="#FFFFFF">
				<small>&nbsp;<%ShowCFWChemResult dbkey, formgroup, "MolWeight", "inv_compounds.MolWeight", BaseID, "raw", 20, 20%></small>
				</td>
			</tr>
			<tr>
				<td align="left" bgcolor="#FFFFD6">
				...
				<td bgcolor="#FFFFD6" colspan="3">
				<small>&nbsp;<% ShowResult dbkey, formgroup, BaseRS, "inv_compounds.ACX_ID", "raw", 0, 0%></small>
				</td>
			</tr>
			<tr>
		...
		<script language="JavaScript">
			...
			<script language="JavaScript">
				...
				var CheckACXCDROM = "Check ChemInv CD-ROM";
