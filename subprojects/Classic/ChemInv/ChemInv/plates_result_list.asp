	...
	<head>
		...
		<script language="JavaScript">
			...
			function updateDict(bClear) {
				...
				var strURL = serverType + serverName + "/cheminv/cheminv/MultiSelect.asp?selectChckBox=" + allChckBoxValues + "&removeList=" + removeList + "&dictType=plate";	
			...
			<tr>
				...
				<td align="center" valign="top" nowrap>
					<%If Session("INV_CREATE_PLATE" & dbkey) then%>	
						<a class="MenuLink" HREF="#" onclick="OpenDialog2('/Cheminv/GUI/ReformatPlate_SelectMap.asp?multiSelect=true&reformatAction=reformat', 'Diag', 1); return false">Reformat Plates</a>
						|
					<%end if%>
					<%If Session("INV_CREATE_PLATE" & dbkey) then%>	
						<a class="MenuLink" HREF="#" onclick="OpenDialog2('/Cheminv/GUI/ReformatPlate_SelectOrder.asp?multiSelect=true&reformatAction=daughter', 'Diag', 1); return false">Daughter Plates</a>
						|
					<%end if%>
