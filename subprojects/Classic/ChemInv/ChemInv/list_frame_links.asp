...
%>
    ...
    <ul id="nav">
        ...
        <li><a href="/cheminv/gui/<%=Session("TabFrameURL")%>?containerCount=0&clear=1" target="TabFrame" title="Cancel MultiSelect" class="contextMenu" onmouseover="this.className = 'menuOn'" onmouseout="this.className = 'contextMenu';">Cancel MultiSelect</a></li>
    </ul>
    </div>
<%
