...
'-- Purpose: Commented out the QueryString and using FormData; updated CShttpRequest2 method with FormData
'-- Date: 26/02/2010
...
ReceiptID = CShttpRequest2("POST", ServerName, APIURL, "ChemInv", FormData)
