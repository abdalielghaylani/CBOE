...
if Request("printworksheet") = "true" then
	Response.Write("<div align=""center""><table class=""grayBackground"" width=""75%""><tr><td align=""center""><span class=""GuiFeedback"">" & caption & "</span></td></tr></table><br />")
...
<tr><td colspan="2" align="center" bgcolor="#e1e1e1"  style="border-bottom:1px solid #000000;"><b><%=caption%></b></td></tr>
<tr><td valign="top">
	<table border="0" class="receipt">
		<tr><td align="right">Request ID:</td><td class="grayBackground"><%=RequestID%></td></tr>
		<tr><td align="right">Date Required:</td><td class="grayBackground"><%=DateRequired%></td></tr>
		<tr><td align="right">Date Delivered:</td><td class="grayBackground"><%=DateDelivered%></td></tr>
		<tr><td align="right">Requested By:</td><td class="grayBackground"><%=RUserID%></td></tr>
		<tr><td align="right">Requested For:</td><td class="grayBackground"><%=DUserID%></td></tr>
		<tr><td align="right">Amount Requested:</td><td class="grayBackground"><%=FormatNumber(QtyRequired,2)%>&nbsp;<%=UOMAbbrv%></td></tr>
		<tr><td align="right">Amount Delivered:</td><td class="grayBackground"><%=FormatNumber(QtySelected,2)%>&nbsp;<%=UOMAbbrv%></td></tr>
		<%=reqHtml%>
		<tr><td align="right" valign="top">Comments:</td><td class="grayBackground"><%=comments%></td></tr>
