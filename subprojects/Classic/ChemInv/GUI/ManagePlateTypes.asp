...
If action <> "create" then
	...
	SQL = "SELECT plate_type_name, max_freeze_thaw FROM inv_plate_types WHERE plate_type_ID=?"
	'Response.Write SQL
	'Response.end
	set Cmd = server.createobject("ADODB.Command")
	Cmd.CommandText = SQL
	Cmd.ActiveConnection = Conn
	Cmd.Parameters.Append Cmd.CreateParameter("PlateTypeID",131, 1, 0, PlateTypeID)
	Set RS= Cmd.Execute
