...
Select Case Request("action")
	Case "create"	
		url = "/cheminv/api/CreatePhysPlateType.asp" 
		msg = "New Physical Plate Type has been created."
	Case "update"
		url = "/cheminv/api/UpdatePhysPlateType.asp"
		msg = "Physical Plate Type has been updated."
	Case "delete"
		url = "/cheminv/api/DeletePhysPlateType.asp"
		msg = "Physical Plate Type has been deleted."
End Select
		...
		<TD>
			...
			If isNumeric(httpResponse) then
				If CLng(httpResponse) > 0 then
					...
					Response.Write "<SPAN class=""GuiFeedback"">Physical Plate Type operation failed</SPAN>"
