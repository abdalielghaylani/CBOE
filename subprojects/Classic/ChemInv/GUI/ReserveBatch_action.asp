		...
		<td height="50" valign="middle" nowrap>
			...
			If IsNumeric(httpresponse) then 
				If Clng(httpResponse) > 0 then
					...
					Response.Write "<P><center><a HREF=""Ok"" onclick=""if (opener){opener.DialogWindow = null;opener.location.reload();} window.close(); return false;""><img SRC=""/cheminv/graphics/sq_btn/ok_dialog_btn.gif"" border=""0"" title=""Close dialog window""></a></center>"		
				else				
