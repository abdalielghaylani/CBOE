...
if clear then
	...
	if(showInList="") then
	    Response.Write "<SCRIPT LANGUAGE=javascript>(top.ListFrame)? theListFrame = top.ListFrame : theListFrame = top.main.ListFrame; theListFrame.location.href= theListFrame.location.href.replace('multiSelect=1', 'multiSelect=0'); theListFrame.location.href= theListFrame.location.href.replace('showInList=', '');</SCRIPT>"
	else
...
<%if myDict.Count > 0 then
        ...
        arrCategories = array("Update","Obtain","Other")
        ...
        arrLinks(1,2) = "Check In"
        arrLinks(1,3) = "1"
        arrLinks(1,5) = arrCategories(1)
        arrLinks(1,6) = "Check In"
        ...
        arrLinks(6,1) = "/Cheminv/GUI/PrintLabelOption.asp?multiSelect=true&ShowInList=containers"
        arrLinks(6,2) = "Print Labels"
        arrLinks(6,3) = "2"
        arrLinks(6,5) = arrCategories(2)
