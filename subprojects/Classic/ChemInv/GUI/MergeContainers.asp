...
if Action <> "SelectIDs" then
	...
	sourcestring = MergeContainerIDs & ", " & ContainerID
	regEx.Pattern = "[a-zA-Z]+(,[a-zA-Z]+)*"
	Set Matches = regEx.Execute(sourcestring)
	If Matches.Count > 0 then
	instructionTextA = "Error: The query string contains unwanted text and that will prevent the sql execution.<br><br>Select the containers you want to merge with the current container."
	Action = "SelectIDs"
	else
