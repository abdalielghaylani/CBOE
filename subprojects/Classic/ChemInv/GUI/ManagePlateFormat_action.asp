...
Select Case Request("action")
	Case "create"	
		url = "/cheminv/api/CreatePlateFormat.asp" 
		msg = "New Plate Format has been created"
	Case "update"
		url = "/cheminv/api/UpdatePlateFormat.asp"
		msg = "Plate Format has been updated"
	Case "delete"
		url = "/cheminv/api/DeletePlateFormat.asp"
		msg = "Plate Format has been deleted"
End Select
		...
		<TD>
			...
			If isNumeric(httpResponse) then
				If CLng(httpResponse) > 0 then
					...
					Response.Write "<SPAN class=""GuiFeedback"">Plate Format operation failed</SPAN>"
