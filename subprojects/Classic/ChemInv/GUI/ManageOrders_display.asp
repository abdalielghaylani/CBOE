...
Else
    ...
    select case CInt(OrderStatusID)
        case 1
	...
	<table border="0" cellspacing="0" width="100%" cellpadding="2" align="left">
		<tr>
			<td align="right" valign="top" nowrap>
					...
					<a class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/Order_frset.asp?action=create&clear=1&CreateType=ManageOrders', 'Diag', 1); return false;">Create Order</a>
...
<%
	...
	Else
		While (Not RS.EOF)
			OrderID = RS("order_id")
			NumContainers = CInt(RS("NumContainers"))
...
%>
			<tr>
				...
				%>
				<td align="center"> 
					<a Class="MenuLink" Href="#" onclick="OpenDialog('/Cheminv/GUI/Order_frset.asp?clear=1&action=edit&CreateType=ManageOrders&amp;<%=editdata%>', 'Diag', 1); return false">Edit</a>
				...
				%>
				<td align="center"> 
					<a Class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/Order_list.asp?Clear=1&Action=edit&CreateType=ManageOrders&OrderID=<%=OrderID%>', 'Diag', 2); return false">View</a>
					| <a Class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/ReceiveOrder_frset.asp?OrderID=<%=OrderID%>&clear=1', 'Diag', 2); return false">Receive</a>
				</td>
				<%
				    case 3, 4      ' 3 = Closed, 4 = Cancelled
				%>
				<td align="center"> 
					<a Class="MenuLink" HREF="#" onclick="OpenDialog('/Cheminv/GUI/Order_list.asp?Clear=1&Action=edit&CreateType=ManageOrders&OrderID=<%=OrderID%>', 'Diag', 2); return false">View</a>
				</td>
			...
			<%if (OrderStatusID = "1" and NumContainers > 0) then%>
				<td align="center">
...
<%	
	...
	Set Cmd = nothing
	Set Conn = nothing
End if      ' if bDebugPrint then
%>
	</table>
	</TD></TR>
	<% if OrderStatusID = "1" then 'Fix Bug  CSBR-75633 %>
