...
if Request("Action") = "new" then
	...
	for i = 0 to ubound(arrNewContainer)
		...
		FormData = FormData & "PrincipalID=" & Request("PrincipalID") & "&"
		FormData = FormData & "LocationTypeID=" & Request("LocationTypeID") & "&"
		end if
			...
			Select Case theAction
				Case "SelectContainer"
					...
					if Request("AutoPrint") = "on" then
						...
						Response.write "<Script language=javascript>barcodeWindow = OpenDialog('/Cheminv/GUI/PrintLabelOption.asp?ShowInList=containers&ContainerID=" & ContainerList & "', 'Diag2', 1); barcodeWindow.focus();</script>"
					end if
