...
Select Case Request("action")
	Case "create"	
		url = "/cheminv/api/CreatePlateType.asp" 
		msg = "New Plate Type has been created"
	Case "update"
		url = "/cheminv/api/UpdatePlateType.asp"
		msg = "Plate Type has been updated"
	Case "delete"
		url = "/cheminv/api/DeletePlateType.asp"
		msg = "Plate Type has been deleted"
End Select
		...
		<TD>
			...
			If isNumeric(httpResponse) then
				If CLng(httpResponse) > 0 then
					...
					Response.Write "<SPAN class=""GuiFeedback"">Plate Type operation failed</SPAN>"
