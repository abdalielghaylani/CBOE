...
If mapAction <> "create" then
	Call GetInvConnection()
	SQL = "SELECT DATA_MAP_NAME,DATA_MAP_TYPE_ID_FK,DATA_MAP_COMMENTS,NUM_HEADER_ROWS,NUM_COLUMNS,COLUMN_DELIMITER, USE_WELL_COORDINATES From INV_DATA_MAPS Where DATA_MAP_ID=?"
	set Cmd = server.createobject("ADODB.Command")
	Cmd.CommandText = SQL
	Cmd.ActiveConnection = Conn
	Cmd.Parameters.Append Cmd.CreateParameter("dataMapID",131, 1, 0, dataMapID)
	Set RS = Cmd.Execute
