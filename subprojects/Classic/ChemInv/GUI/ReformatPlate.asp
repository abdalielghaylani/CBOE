...
if multiSelect = "true" then 
	...
	Barcode = NumPlates& " plates selected."
Else
...
elseif pageAction = "daughter" and cint(NumPlates)<=300 then
...
if (pageAction = "selectOrder" or pageAction = "daughter") and cint(NumPlates)<=300 then
...
<table border="0">
	<tr>
		<td colspan="2">
			<span class="GuiFeedback"><br><br><center>Please select 300 or less plates.</center></span><br><br>
		</td>
	</tr>
	<tr>
...
<%
	if pageAction = "selectMap" then
		...
		aValidMaps = split(validMaps,",")
		if cInt(aValidMaps(0)) < 0 then
%>
		<TR>
