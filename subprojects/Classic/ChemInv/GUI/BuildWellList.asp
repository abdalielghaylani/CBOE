...
RegBatchDetailsURL = "<A CLASS='MenuLink' target='_blank' TITLE='Registration Details' HREF='" & Application("SERVER_TYPE") & Application("InvServerName") & "/cheminv/gui/ViewRegDetails.asp?reg_number="
