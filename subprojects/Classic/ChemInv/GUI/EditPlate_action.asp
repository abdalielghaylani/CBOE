	...
	if len(Session(field)) > 0 then
		if InStr("iContainerIDs,multiscan,multiSelect,fieldList,AutoGen", field) = 0 then
			Select case lcase(field)
				'number fields
				case "pllocation_id_fk","plplate_pype_id_fk","plqty_unit_fk","plqty_initial","plqty_remaining","plstatus_id_fk","plsupplier_shipment_number","pllibrary_id_fk","plft_cycles","plweight_unit_fk","plweight","plconc_unit_fk","plconcentration","plsolvent_id_fk","plsolvent_volume","plsolvent_volume_unit_id_fk","plplate_type_id_fk","plpurity_unit_fk","plpurity","plprincipal_id_fk" '"plnumcopies",
					ValuePairs = ValuePairs & mid(field,3) & "%3D" & Session(field) & "::"
				'text fields
				case "plplate_name","plsupplier","plsupplier_barcode","plsupplier_shipment_code","plfield_1","plfield_2","plfield_3","plfield_4","plfield_5","plgroup_name","plplate_barcode"
		...
		if InStr("iContainerIDs,multiscan,multiSelect,fieldList,AutoGen", field) = 0 then
			Select case lcase(field)
				...
				'text fields
				case "plplate_name","plsupplier","plsupplier_shipment_code","plfield_1","plfield_2","plfield_3","plfield_4","plfield_5","plgroup_name","plplate_barcode"
					ValuePairs = ValuePairs & mid(field,3) & "%3DNULL::"
				'date fields
				case "plsupplier_shipment_date","pldate_1","pldate_2"
					ValuePairs = ValuePairs & mid(field,3) & "%3DNULL::"
