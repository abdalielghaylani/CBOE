	...
	<table border="0" cellspacing="0" cellpadding="2" width="700" align="left">
		<tr>
			...
			<td valign="top" align=right>
				<a class="MenuLink" href="Close" onclick="window.location='/cheminv/gui/ManageReports.asp?ReportTypeID=<%=ReportTypeID%>';  return false;">Close</a> | <a class=menulink href="DeleteReport.asp?ReportTypeID=<%=ReportTypeID%>&Report_ID=<%=Report_ID%>">Delete Report</a>
			</td>
		</tr>
		<tr>
...
<%elseif Rtrim(ParamNames(1,i)) = "end_date" then%><select NAME="Parameter<%=i+1%>Type"><option value="num">Number</option><option value="text">Text</option><option value="start_date" >Date Range Start</option><option value="end_date" selected>Date Range End</option><option value="user_name">Username</option><option value="location">Location</option>	</select>
