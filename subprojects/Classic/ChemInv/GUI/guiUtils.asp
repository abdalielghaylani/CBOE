	...
	If Not IsEmpty(Request.QueryString("special")) then
	    ...
	    If UBound(arr1) > 0 Then 'CSBR 146419 SJ : Checking the array is empty.
            If UBound(arr1) = 1 then
                ...
                arr1 = Split(loc,",")
	            Response.Write "<input TYPE=""Text"" SIZE=""" & size2 &""" value=""" & Trim(arr1(1)) & """ name=""" & elm2 & """ onchange=""UpdateLocationPickerFromBarCode(this.value," & formelm & ",'" & elm1 & "','" & elm2 & "', '" & elm3 & "')"" onblur=""UpdateLocationPickerFromBarCode(this.value," & formelm & ",'" & elm1 & "','" & elm2 & "', '" & elm3 & "')"">"
