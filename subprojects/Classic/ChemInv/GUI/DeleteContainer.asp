...
<%elseif ContainerCount > cint(Application("MAX_UPDATEABLE_CONTAINERS")) then %>
<table border="0">
	<tr>
		<td colspan="2">
			<span class="GuiFeedback"><br><br><center>You cannot delete more than <%=cint(Application("MAX_UPDATEABLE_CONTAINERS"))%> containers at a time.</center></span><br><br>
		</td>
	</tr>
	<tr>
		<td colspan="2" align="right"> 
