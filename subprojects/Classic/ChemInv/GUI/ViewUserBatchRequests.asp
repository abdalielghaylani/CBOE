...
if Session("rTab") = "" or Request("rTab") = "" then
	...
	'CSBR ID : 126848 
	'Modified by: sjacob 
	'Comments : Changed the 'My Requests' caption to 'My Batch Requests'
	pageTitle = "My Batch Requests"
else
...
<a class="MenuLink" href="ViewUserBatchRequests.asp?rtab=MyRequests" <%if rtab="MyRequests" then Response.Write("style=""color: #666;""") %>>My Batch Requests</a> | 
...
%>
<!--CSBR ID : 126848 : sjacob Comments : Changed the 'My Requests' caption to 'My Batch Requests'-->
<span class="GuiFeedback">My Batch Requests</span><br /><br />
...
'-- Date: 13/04/2010
	Request_Comments = RS("request_comments")	
'-- End of Change #123488#
	...
	'-- CSBR ID:121935
	'-- Change Done by : Manoj Unnikrishnan
	'-- Purpose: To show the Custom Create Request fields and Custom Fulfill Request fields
	'-- Date: 25/02/2010
	...
	for each key in custom_fulfillrequest_fields_dict
		execute("Request" & key & " = RS(""" & key & """)")
	next
	'-- End of Change #121935#
	
    BatchAmount = RS("Batch_Amount")
%>
	<tr>
