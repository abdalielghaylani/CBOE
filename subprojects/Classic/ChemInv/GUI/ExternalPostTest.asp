	...
	<table border="0" width="500" cellpadding="0" cellspacing="0">
				...
				<table border="1" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							...
							<script language="javascript">cd_insertObjectStr("<embed src='/CFWTEMP/ChemInv/ChemInvTemp/mt.cdx' border='0' width='280' height='200' id='5' name='CDX' type='chemical/x-cdx'>");</script> 
		  ...
		  <tr>
			<td align="right" colspan="3">
				<a HREF="../Post%20Data%20to%20ChemInv" onclick="getStrucData(); return false;"><img SRC="../graphics/ok_dialog_btn.gif" border="0" alt="Post query to ChemInv server"></a>
			</td>
		  </tr>
		</table>
