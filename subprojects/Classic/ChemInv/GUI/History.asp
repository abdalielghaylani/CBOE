...
<body>
	...
	<select name="numRows" onchange="document.form1.submit();">
		<%
...
%>
			<tr>
				...
				<td>
					<%=GetFormatedDate(RS("TimeStamp").value)%>
				</td>
			</tr>
			<%rs.MoveNext
		Wend
...
%>
<br>
<a href="#" onclick="window.close(); return false;"><img SRC="/cheminv/graphics/sq_btn/close_dialog_btn.gif" border="0"></a>
</form>
