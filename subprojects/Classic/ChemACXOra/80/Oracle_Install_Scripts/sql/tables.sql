...
create table SUPPLIERPHONEID (
	...
	SUPPLIERID NUMBER(9,0) null)   PCTFREE 5 PCTUSED 40
; 
...
create table SUPPLIER (
	...
	SUPPLIERTYPE NUMBER(3,0) null,
	NAME VARCHAR2(255) null,
	SHORTNAME VARCHAR2(50) null,
	SUPPLIERCODE VARCHAR2(50) null,
	SORTORDER NUMBER(9,0) null,
	LOGOPATH VARCHAR2(50) null,
	LOGO BLOB null,
	ORDERFROM NUMBER(9,0) null) 
	LOB (logo) STORE AS(
...
create table SUBSTANCE (
	...
	DATECREATED DATE null,
	SUPPLIERNAME VARCHAR2(255) null,
	ACX_ID VARCHAR2(50) null,
	SUPPLIERID NUMBER(9,0) null,
	hasproducts VARCHAR2(2), 
	hasmsds VARCHAR2(2), 
...
create table PROPERTYCLASSALPHA (
	PROPERTYCLASSALPHAID NUMBER(10,0) null,
	CLASSNAME VARCHAR2(50) null)  PCTFREE 5 PCTUSED 40
; 

-- Create new table PROPERTYALPHA.
create table PROPERTYALPHA (
	PROPERTY VARCHAR2(50) null,
	"VALUE" VARCHAR2(250) null,
	PRODUCTID NUMBER(9,0) null)  PCTFREE 5 PCTUSED 40
; 
...
create table PRODUCT (
	...
	SUPPLIERID NUMBER(9,0) null,
	PRODNAME VARCHAR2(250) null,
	PRODDESCRIP VARCHAR2(255) null,
	...
	CHEMCLASSID NUMBER(9,0) null,
	NUMTOSKIP NUMBER(9,0) null,
	ISWWW VARCHAR2(2) null,
	PICTURE VARCHAR2(50) null,
	ISPICTURE VARCHAR2(2) null,
...
CREATE TABLE PACKAGESIZECONVERSION(
	ID NUMBER(9,0),
	SIZE_FK VARCHAR2(255),
	CONTAINER_QTY_MAX NUMBER,
	UNIT_OF_MEASURE VARCHAR2(255),
	CONTAINER_UOM VARCHAR2(255),
	CONTAINER_COUNT NUMBER,
	CONTAINER_UOM_ID_FK NUMBER(9)
	)  PCTFREE 5 PCTUSED 40
;

CREATE TABLE SHOPPINGCART(
	CSUserName VARCHAR2(50), 
	WddxPacket CLOB, 
	LastUpdate DATE);
