					...
					<table >
						<tr>
							<td align="left" >
							    <table border="2" >
									<tr>
										<td valign="top" align="left"><table border="1"><tr><td><%ShowResult dbkey, formgroup,BaseRS, "Temporary_Structures.BASE64_CDX_ORIGINAL", struc_output, 325,220%>&nbsp;</td></tr></table></td>
								...
								<%'SYAN modified on 1/3/1008 to fix CSBR-85175%>
                <%if application("MOLECULE_PROCESS") = "1" then%>
								  <!--#INCLUDE FILE = "StructureNormalization.asp"-->
								<%end if%>
                <%'End of SYAN modification%>
							</table>
						</td>
									...
									<tr><td valign="top" align="left" width="650">&nbsp;
										<table border="0" >
											<tr> 
												...
												<td <%=td_caption_bgcolor%> width = "150">  <font <%=font_default_caption%>><b><%=getLabelName("Batch_Formula")%></b></font>
												</td>
											</tr>
											...
											<tr>
												...
												<td width = "150" <%=td_bgcolor%>><font <%=font_default_caption%>>
												<%ShowResult dbkey, formgroup, BaseRS, "TEMPORARY_STRUCTURES.BATCH_FORMULA", batch_output, setDisplayType("BATCH_FORMULA"),"15"%></font></td>
