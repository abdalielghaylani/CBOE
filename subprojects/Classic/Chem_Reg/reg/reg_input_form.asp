													...
													<td nowrap align="left" valign="top">  
														<table width = "635">
															...
															<tr>
																...
																<%end if%>
																<%if not checkHideField("Last_Mod_Person_ID") then%>
																<td <%=td_bgcolor%> valign="top" align="left" width="200"><font <%=font_default%>><%ShowLookUpList dbkey, formgroup,BaseRS,"Compound_Molecule.Last_Mod_Person_ID", People_List, "",People_Val,0,true,"value","0" %></font>
																</td>
																<%end if%>
															</tr>
														</table>
								...
								<tr>
									<td>
										<table width="650" >
											...
											<%if not checkHideField("Batch_Reg_Person_ID") then%>	
											<td width = "150" <%=td_bgcolor%> ><font <%=font_default%>><%ShowLookUpList dbkey, formgroup,BaseRS,"Batches.Batch_Reg_Person_ID", People_List, "",People_Text,0,true,"value","0" %></font></font><font  <%=font_default%>></font>
												</td>
											<%end if%>
											<%if not checkHideField("Batch_Reg_Date") then%>	
											...
											<tr>
												...
												<%else%>
													...
													<%'if CBOOL(Application("NOTEBOOK_LOOKUP")) = False then%>
														<td width = "150" <%=td_bgcolor%> ><%ShowLookUpList dbkey, formgroup,BaseRS,"Batches.Scientist_ID", People_List, "",People_Text,0,true,"value","0" %>
														</td>
													<%'end if%>
													<%end if%>
												<%end if%>
