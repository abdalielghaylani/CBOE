...
TOP_NAV = "<a href=""#"" onclick=""getHelpTopic('/" & Application("appkey") & "/help/default.htm','base_form_group','reg')""><b>Help</b></a>&nbsp;|&nbsp;<a href=""/cs_security/home.asp""><b>Home</b></a>"
%>
		...
		<td valign="top" width="50%">
			<%=renderBoxBegin ("Query and Reporting","")%>
					<table border="0" bordercolor="#FFFFFF">
						...
						<%end if %>
            <!--SYAN commented out on 12/17/2007 to fix CSBR-81630
