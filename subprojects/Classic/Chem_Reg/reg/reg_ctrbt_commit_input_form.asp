...
<!--SYAN added 1/28/2008 to fix CSBR-90009-->
	...
	<%'End of SYAN modification%>
				...
				<tr><td>
                    ...
                    <%if application("MOLECULE_PROCESS") = "1" then%>
                        <tr>
									        <td><%=getLabelName("TEMPORARY_STRUCTURES.STRIPPING_SUCCEEDED")%><%ShowInputField dbkey, formgroup, "TEMPORARY_STRUCTURES.STRIPPING_SUCCEEDED",setDisplayType("STRIPPING_SUCCEEDED"),"15:200"%>
									        <%=getLabelName("TEMPORARY_STRUCTURES.STRIPPING_FAILED")%><%ShowInputField dbkey, formgroup, "TEMPORARY_STRUCTURES.STRIPPING_FAILED",setDisplayType("STRIPPING_FAILED"),"15:200"%>
									        </td>
									      </tr>
                    <%end if%>
                    <%'End of SYAN modification%>
