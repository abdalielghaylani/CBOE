...
%>
<P>
<FONT face="Arial" size="2" color="Navy"><STRONG>Step 1 of 2</STRONG> - Confirm deletion of Parameter: <%=pType%> for ExperimentTypeID: <%=eType%></FONT></P>
<FORM METHOD="Post" ACTION="\chem_reg\analytics\manage_analytics_tables\MA_delete_parameter.asp" ID="FormStep1" NAME="FormStep1">
...
if Request.Form("ConfirmDelete") = "Yes" Then
	...
	' Delete the parameter from the table
	...
	sql = "DELETE FROM experimenttypeparameters WHERE experiment_type_id=" & eType & " AND parameter_type_id=" & pType
