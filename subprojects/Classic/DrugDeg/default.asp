...
<%
	...
	'Response.write "xx" & Session( "CurrentLocation" & dbkey & formgroup ) & "<br>"
...
formgroup = Request( "formgroup" )
	...
	'Response.write "xy" & Session( "CurrentLocation" & dbkey & formgroup ) & "<br>"
...
'Response.Write Session( "UserValidated" & dbkey )
'Response.Write "<br>"
'Response.Write Application( "LoginRequired" & dbkey )
'Response.End
...
<head>
	<title>Drug Degradation Enterprise</title>
