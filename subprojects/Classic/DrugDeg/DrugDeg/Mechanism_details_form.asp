...
set connChem = GetConnection( dbkey, formgroup, "DRUGDEG_MECHS" )

' Make and fill a record set for the mechanism.
set rsMechanism = Server.CreateObject( "ADODB.Recordset" )
rsMechanism.Open "Select * from DRUGDEG_MECHS where DEG_CMPD_FK = " & keyDeg, connChem
...
<%
			...
			rsBase64.Open "Select * from DRUGDEG_BASE64 where MOL_ID = " & rsMechanism.Fields( "MOL_ID" ), connChem
			ShowResult dbkey, formgroup, rsBase64, "DRUGDEG_BASE64.BASE64_CDX", "Base64CDX", widthMechDrawing, heightMechDrawing
			rsBase64.Close
%>
		</td>
	</tr>
