...
<title>Change status name</title>
</head>
...
<input type = "hidden" name = "StatusKey" value ="<%=Request.QueryString( "keyprimary" )%>">
...
sSQL = "select * from DRUGDEG_STATUSES where STATUS_KEY = " & Request.QueryString( "keyprimary" )
