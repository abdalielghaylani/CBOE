...
Session( "ReturnToDrugDegSearch" & dbkey ) = Session( "CurrentLocation" & dbkey & formgroup )
		...
		<td>
			...
			<% if CBool(Session( "dd_Edit_Records" & dbkey )) = True then %>
				<tr>
					<td  valign = "top"  align = "right">
						<strong>Parent Editor</strong>
					</td>
					<td  valign = "top">
						<%
						all_editors_list = ListAllEditors(dbkey, formgroup, connBase, "submitted_by", "submitted_by", "lower(submitted_by)", 1)
						ShowLookUpList dbkey, formgroup, BaseRS, "DRUGDEG_PARENTS.SUBMITTED_BY", all_editors_list, "", "", 0, true, "value", "0"
				...
				<tr>
					<td  valign = "top"  align = "right">
						<strong>Experiment Editor</strong>
					</td>
					<td  valign = "top">
						<%
						all_editors_list = ListAllEditors(dbkey, formgroup, connBase, "submitted_by", "submitted_by", "lower(submitted_by)", 2)
						ShowLookUpList dbkey, formgroup, BaseRS, "DRUGDEG_EXPTS.SUBMITTED_BY", all_editors_list, "", "", 0, true, "value", "0"
			...
			<%end if%>
				<tr>
					...
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_PARENTS.GENERIC_NAME", 0, "24"%>
					</td>	
				</tr>
				<tr>
					<td  valign = "top"  align = "right">
					...
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_PARENTS.TRADE_NAME", 0, "24"%>
					</td>	
				</tr>
				<tr>
					<td  valign = "top"  align = "right">
				...
				<!-- Purpose: To search Common Name/Alias name from the view created for Parents & Degradants -->
				<!-- Date: 11/12/2010 -->
						<%ShowInputField dbkey, formgroup, "VW_DRUGDEG_NAME.NAME", 0, "24"%>
				...
				<!-- CSBR ID:133592 -->
				<!-- Change Done by : Manoj Unnikrishnan -->
				<!-- Purpose: Modified the Compound number label name -->
				<!-- Date: 11/12/2010 -->
						<strong>Compound number / CAS number</strong>
				<!-- End of Change #133592# -->
					</td>
					<td  valign = "top">
				<!-- CSBR ID:133592 -->
				<!-- Change Done by : Manoj Unnikrishnan -->
				<!-- Purpose: To search Compound Number from the view created for Parents & Degradants -->
				<!-- Date: 11/12/2010 -->
						<%ShowInputField dbkey, formgroup, "VW_DRUGDEG_COMPOUNDS.COMPOUND_NUMBER", 0, "24"%>
				<!-- End of Change #133592# -->
					</td>	
				</tr>
				<tr>
					...
					<td valign= "top">
						...
						ShowLookUpList dbkey, formgroup, BaseRS, "DRUGDEG_DEGSFGROUP.DEG_FGROUP_ID", all_fgroups_list, "", "", 0, true, "value", "0"
						%>
					</td>
				</tr>
			</table>
		...
		<td  valign = "top">
			...
			<table  border = "0"  bordercolor = "purple">
				<tr>
					...
					<td  valign = "top">
						<%'ShowInputField dbkey, formgroup, "DRUGDEG_PARENTS.Formula", 4, "24"%>
						<%ShowInputField dbkey, formgroup, "DRUGDEG_BASE64.Formula", 4, "24"%>
					</td>
				</tr>
				<!-- CSBR ID:133589 -->
				<!-- Change Done by : Manoj Unnikrishnan -->
				<!-- Purpose: Added new field for searching degradant formula-->
				<!-- Date: 11/12/2010 -->
				<tr>
					<td  valign = "top"  align = "right">
						<strong>Degradant / Impurity Formula</strong>
					</td>
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_DEG_BASE64.Formula", 4, "24"%>
					</td>
				</tr>
				...
				<tr>
					...
					<td  valign = "top">
						<%'ShowInputField dbkey, formgroup, "DRUGDEG_PARENTS.MolWeight", 0, "24"%>
						<%ShowInputField dbkey, formgroup, "DRUGDEG_BASE64.MolWeight", 0, "24"%>
					</td>
				</tr>
				<tr>
					<td  valign = "top"  align = "right">
					...
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_DEGS.MW_AMT_CHG", 0, "24"%>
					</td>
				</tr>
				<!-- CSBR ID:133589 -->
				<!-- Change Done by : Manoj Unnikrishnan -->
				<!-- Purpose: Added new field for searching degradant MW -->
				<!-- Date: 11/12/2010 -->
				<tr>
					<td  valign = "top"  align = "right">
						<strong>Degradant / Impurity Molecular weight</strong>
					</td>
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_DEG_BASE64.MolWeight", 4, "24"%>
					</td>
				</tr>
				<!-- End of Change #133589# -->
				<tr>
...
'						Response.Write( "sSaltsList = [ " & sSaltsList & " ]" )
						ShowLookUpList dbkey, formgroup, BaseRS, "DRUGDEG_PARENTS.SALT", sSaltsList, "", "", 0, true, "value", "0"
...
<!-- -
					<td  valign = "top">
						<%ShowInputField dbkey, formgroup, "DRUGDEG_PARENTS.SALT", 0, "24"%>
					</td>
-- -->
				</tr>
...
'						Response.Write( "sCondsList = [ " & sCondsList & " ]" )
						ShowLookUpList dbkey, formgroup, BaseRS, "DRUGDEG_PARENTS.STATUS", sStatusList, "", "", 0, true, "value", "0"
...
%>
				...
				<%else %>
				<tr>
					<td colspan=2><input type=hidden name=status value="<%=Application("STATUS_NEW")%>"></td>
				</tr>
				<%end if%>
	...
	<tr>
		...
		<td  valign = "top">
			<table  border = "1">
				...
				<tr>
					<td>
						<% ShowStrucInputField  dbkey, formgroup, "DRUGDEG_BASE64.Structure", "5", "340", widthStructArea, "AllOptions", "SelectList" %>
						<% 'ShowStrucInputField  dbkey, formgroup, "DRUGDEG_PARENTS.Structure", "5", "340", widthStructArea, "AllOptions", "SelectList" %>

						<% 'ShowStrucInputField  dbkey, formgroup, "DRUGDEG_BASE64.BASE64_CDX", "5", "340", widthStructArea, "AllOptions", "SelectList" %>
					</td>
				</tr>
			</table>
		</td>
		...
		<td  valign = "top">
			<table  border = "1">
				...
				<tr>
					<td>
						<% 'ShowStrucInputField  dbkey, formgroup, "DRUGDEG_DEGS.Structure", "6", widthStructArea, heightStructArea, "AllOptions", "SelectList" %>
						<% ShowStrucInputField  dbkey, formgroup, "DRUGDEG_DEG_BASE64.Structure", "6", widthStructArea, heightStructArea, "AllOptions", "SelectList" %>
					</td>
				</tr>
			</table>
		</td>
