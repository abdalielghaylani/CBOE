...
<form name="UserLogin" action="/<%=Application("AppKey")%>/login.asp?dbname=drugdeg&amp;formgroup=base_form_group&amp;perform_validate=1&amp;forceManualLogin=1" method="post" )>
<div align="center">
			...
			<table border="0" width="47%">
				<tr>
					<td colspan="2" align="right">
						<input Type="Image" src="graphics/login_btn.gif" border="0" id="Image1" name="Image1" WIDTH="61" HEIGHT="21">
						<%
						...
						%>
						<a href="<%=href%>">
						<img SRC="graphics/exit_btn.gif" border="0" WIDTH="61" HEIGHT="21"></a>
					</td>
				</tr>
			</table>
			</div>
