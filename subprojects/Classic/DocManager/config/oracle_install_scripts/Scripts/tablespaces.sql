...
prompt starting tablespaces.sql
...
BEGIN
	...
	createTableSpace('&&ctxTableSpaceName','&&ctxTableSpaceFile','&&ctxTableSpaceSize','&&ctxBlockSize','&&ctxTablespaceExtent');
	createTableSpace('&&docTableSpaceName','&&docTableSpaceFile','&&docTableSpaceSize','&&docBlockSize','&&docTablespaceExtent');
