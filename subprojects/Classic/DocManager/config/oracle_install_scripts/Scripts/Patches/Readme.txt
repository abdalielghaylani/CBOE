How to create the scripts for a new patch?
	...
	1) Create a new folder into Scripts\Patches\ using the name "Patch x.x.x". (x.x.x is the new version)
	2) Copy file/s from Scripts\Patches\Patch Template\ to the new folder
	3) Edit and update:
		...
		c) the Scripts\Patches\parameters.sql file: 
