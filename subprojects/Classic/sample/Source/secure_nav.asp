...
function getCustomButtons(){
	...
	//addition of add compound button to take you to the add screen.
		if (<%=Application("allowAddMode")%>){ 
			outputval = outputval + getButton("new_record", "", button_gif_path + "add_mode.gif")
		}			
	}
	if(formmode.toLowerCase() == "edit"){
		
		if (<%=Application("allowAddMode")%>){
			outputval = outputval + getButton("edit_record", "", button_gif_path + "edit_mode.gif")
		}
	}
...
var outputval = ""
	outputval = outputval + getButton("add_record")
	outputval = outputval + getButton("clear_form")
	outputval = outputval + getButton("new_search", "base_form_group", button_gif_path + "search_mode.gif")
return outputval
