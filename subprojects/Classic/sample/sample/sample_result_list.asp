...
getFormViewBtn("show_details_btn.gif","sample_form.asp","<%=BaseActualIndex%>")
    ...
    <td><font face="MS Sans Serif" size="1" color="#000000"><%ShowCFWChemResult dbkey, formgroup, "Structure","MolTable.Structure", BaseRS("MOL_ID"), "cdx_with_zoom","212","156"%></font></td>
    <td><font face="MS Sans Serif" size="1" color="#000000"><%ShowResult dbkey, formgroup, BaseRS,"MolTable.Molname","raw", 0, 0%></font></td>
    <td><font face="MS Sans Serif" size="1" color="#000000"><%ShowCFWChemResult dbkey, formgroup, "MolWeight","MolTable.MolWeight", BaseRS("MOL_ID"), "raw", 1,"17"%></font></td>
    <td><font face="MS Sans Serif" size="1" color="#000000"><%ShowCFWChemResult dbkey, formgroup, "Formula","MolTable.Formula", BaseRS("MOL_ID"), "raw", 1,"45"%></font></td>
  </tr>
    <%CloseRS(BaseRS)
CloseConn(DataConn)
