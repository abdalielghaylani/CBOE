...
function getAddCompoundsButtons(){
	...
	//outputval = outputval + getButton("add_record")
	outputval = '<a href="javascript:MainWindow.add_D3()"><img SRC="/<%=Application("appkey")%>/graphics/Button_AddRecord.gif"  border = 0></a>'
...
function getAddParentButtons(){
	...
	outputval = '<a href="javascript:MainWindow.add_D3()"  onMouseOver="status=&quot;Add the data to the database&quot;; return true;"><img SRC="/<%=Application("appkey")%>/graphics/Button_AddRecord.gif"  border = 0></a>'
	outputval = outputval + getButton( "clear_form" )
...
function getModifyConditionTextButtons() {
	...
	var outputval = ""
	//outputval = outputval + getButton( "add_record" )
	outputval = '<a href="javascript:MainWindow.add_D3()"><img SRC="/<%=Application("appkey")%>/graphics/Button_Update.gif"  border = 0></a>'
...
function getModifyExperimentButtons(){
	...
	outputval = '<a href="javascript:MainWindow.D3UpdateRecord()"><img SRC="/<%=Application("appkey")%>/graphics/Button_Update.gif"  border = 0></a>'	
