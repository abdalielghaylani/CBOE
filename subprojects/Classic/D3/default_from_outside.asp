...
if Application( "DBLoaded" & dbkey ) = True then
	...
	Select Case UCase(dataaction)
		...
		Case "VIEW_LINKED_PARENT"
			...
			'sPath = "/D3/D3/Parent_details-Display_only.asp?dbname=D3&formgroup=base_form_group&keyparent=" & rsParentLinks.Fields( "Parent_Cmpd_Key" ) & "&calledby=docmanager"

			sParentKey = Request( "keyparent" )
			'JHS commented out 3/25/2003
			'sCalledBy = Request( "calledby" )
			'sPath = "/D3/D3/Parent_details-Display_only.asp?dbname=D3&formgroup=base_form_group&dataaction=mainpage&keyparent=" & rsParentLinks.Fields( "Parent_Cmpd_Key" ) & "&calledby=docmanager"
			'sPath = sPath & "&keyparent=" & sParentKey & "&calledby=" & sCalledBy
			'JHS commented out 3/25/2003 end
			
			'JHS added 3/25/2003
			sPath = "/D3/D3/Parent_details-Display_only.asp?dbname=D3&formgroup=base_form_group&dataaction=mainpage&keyparent=" & rsParentLinks.Fields( "Parent_Cmpd_Key" )
