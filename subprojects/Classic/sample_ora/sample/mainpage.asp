...
<img height="49" src="/<%=Application("appkey")%>/graphics/cnco.gif" width="71"><img src="/<%=Application("appkey")%>/graphics/mainpage_bnr.gif"> <br>
		...
		<td valign="top" width="621">
			<table border="0" cellspacing="0" cellpadding="0" bgcolor="#e0e0ff" bordercolor="#42426f" width="100%">
				...
				<tr><% if Application("LoginRequired" & dbkey)=1 then%>
					<td width="196"><font face="Arial" color="#42426f" size="2">You are currently<br>logged in as: <%=UCase(Session("UserName" & dbkey))%></font></td>
					<td width="5"><a href="/<%=Application("appkey")%>/logoff.asp"><img src="/<%=Application("appkey")%>/graphics/log_off_big_btn.gif" border="0"></a></td>
					<td width="422">&nbsp;</td>
					<%end if%>
				</tr>
			</table>
