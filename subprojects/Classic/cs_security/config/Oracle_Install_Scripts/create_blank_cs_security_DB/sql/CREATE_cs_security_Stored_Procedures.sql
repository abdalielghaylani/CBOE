...
BEGIN
	...
	if pIsAlreadyInOracle = 0 then
		dbms_sql.parse(source_cursor,'CREATE USER ' || pUserName || ' IDENTIFIED BY ' || pPassword || ' DEFAULT TABLESPACE T_CS_SECURITY TEMPORARY TABLESPACE T_CS_SECURITY_TEMP'  , dbms_sql.NATIVE);
