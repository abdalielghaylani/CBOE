...
Call GetInvCommand(Application("CHEMINV_USERNAME") & ".Requests.EditOrder", adCmdStoredProc)
...
if bDebugPrint then
	...
	Next	
Else
	Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".Requests.EditOrder")
End if
