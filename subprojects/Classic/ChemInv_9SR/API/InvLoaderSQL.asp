...
SELECT CASE cint(StatementID)
	...
	case 13
		strSQL = "SELECT *, location_name || ' (' || location_barcode || ')' as location_name_barcode FROM inv_locations WHERE parent_id IS NOT NULL ORDER BY location_name"
	case 14
