...
'-- use different functions depending on whether QuerySQL is populated
if QuerySQL = "" or isNull(QuerySQL) then
	Call GetInvCommand(Application("CHEMINV_USERNAME") & ".Reports.CreateReport_NoSQL", adCmdStoredProc)
	...
	Else
		Call ExecuteCmd(Application("CHEMINV_USERNAME") & ".Reports.CreateReport_NOSQL")
	End if
else
