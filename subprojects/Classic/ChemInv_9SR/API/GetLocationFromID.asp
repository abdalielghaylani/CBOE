...
If bWriteError then
	...
	Response.end
End if
strSQL = "SELECT Location_ID, Location_Barcode, Location_Name FROM inv_Locations WHERE Location_ID=" & LocationID
...
'Response.Write "<?xml version=""1.0"" encoding=""UTF-8""?><LocationInfo>" & out & "</LocationInfo>"
'Response.Write "<XML><LocationInfo><test>test</test></LocationInfo></XML>"
Response.Write out
</SCRIPT>
