...
<%if action = "delete" then%>
	...
	<tr>
		...
		<td>
			<input TYPE="tetx" SIZE="25" Maxlength="50" NAME="pPlateFormatName" value="<%=htmlValue(PlateFormatName)%>" disabled>
		</td>
	</tr>
...
<%else%>
	...
	<tr>
		...
		<td>
			<input TYPE="tetx" SIZE="25" Maxlength="50" NAME="pPlateFormatName" value="<%=htmlValue(PlateFormatName)%>">
		</td>
	</tr>
	<tr>
