	...
	If refresh = "1" or IsEmpty(Session("LineageNodes")) Then	
		...
		Do While Not RS.EOF
			...
			Else
				...
				Nodex.DHTML = " id=""e" & Nodex.Key & """ onclick=""opener.SelectLocationNode(0," & RS("Location_id_fk") & ", 0, '" & TreeViewOpenNodes1 & "'," & RS("pk") & ",1);"" onmouseover=""javascript:this.style.cursor='hand';"" onmouseout=""javascript:this.style.cursor='default';"""
