...
<table border="0">
	...
	<tr>
		...
		<td>
			<%=ShowMultiSelectBox2("ReportTypeID", "-1", "SELECT ReportTypeDesc AS DisplayText, ReportType_ID AS value FROM " &  Application("CHEMINV_USERNAME") & ".inv_Reporttypes", 45,"All Types", "-1", 5, false, "FilterReports(this.value);return false;")%>
		</td>
		<td align="right" valign="middle" nowrap>
