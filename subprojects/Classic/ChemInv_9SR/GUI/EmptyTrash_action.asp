...
receiveTimeout = 10 * 60 * 1000 '-- 10 minute timeout 
httpResponse = CShttpRequest3("POST", ServerName, "/cheminv/api/EmptyTrash.asp", "ChemInv", FormData, 6000, receiveTimeout)
%>
