		...
		<td>
			...
			If isNumeric(httpResponse) then
				If CLng(httpResponse) > 0 then
					msg = "The Report Layout has been successfully deleted."
					...
					Response.Write "<span class=""GuiFeedback"" title=""" & httpresponse & """>Delete of a Report Layout operation failed.</span>"
