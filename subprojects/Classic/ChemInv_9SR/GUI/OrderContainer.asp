...
<!--Hide JavaScript
	...
	function ValidateContainer(strMode){	
		...
		document.form1.iQtyInitial = document.form1.iQtyMax.value;
...
%>
	...
	<tr height="25">
		...
		<td width="200" align="right">Registry Batch ID:</td><td><input type="text" Size="15" name="RegBatchID" value="<%=RegBatchID%>" disabled onchange="GetRegIDFromRegNum(this.value); iCompoundID.value=''; CompoundID.value='';"><input type="hidden" name="iRegID" value="<%=RegID%>"><input type="hidden" name="iBatchNumber" value="<%=BatchNumber%>"></td>
	...
	<tr>
		...
		<td width="200" align="right">Compound ID:</td><td><input type="text" Size="15" name="iCompoundID" value="<%=CompoundID%>" disabled onchange="NewCompoundID.value= this.value; RegBatchID.value=''; iRegID.value=''; iBatchNumber.value='';"></td>
	...
	<tr height="25">
		...
		<td>
		<%=ShowSelectBox3("iOrderReason", OrderReason, "SELECT DISTINCT container_order_reason_id AS Value, name AS DisplayText, sort_order FROM Container_Order_Reason ORDER BY sort_order ASC", 27, RepeatString(43, "&nbsp;"), "", "postDataFunction(""Required"", ""iOrderReasonOther"");")%>
		</td>
	</tr>
	<%
