...
Else
	...
	'-- don't show the refresh link in showconflicts mode
	if lcase(action) <> "showconflicts" then Response.Write "<center><table border=0 bordercolor=666666 cellpadding=1 cellspacing=0 width=""80%""><tr><td align=right><a class=MenuLink href=""#"" onclick=""document.repostForm.ResolveConflictsLater.value=0;document.repostForm.submit();"">Refresh</a></td></tr><tr><td align=center><span class=""GuiFeedback"">Your substance conflicts with " & art & "existing " & Application("appTitle") & " substance" & plural & ".</td></tr></span></center>"
