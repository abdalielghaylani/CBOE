...
<!--<body style="background-color: #CFD8E6" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">-->
...
Select Case sTab
	Case "Summary"
		...
		'if true then Response.Write "<INPUT TYPE=""button"" value=""View Source!"" onClick=""getsource()"">"
%>
		</td>
		<td valign ="bottom">
			<Table border="0">
				...
				<tr>
						<td><a CLASS="MenuLink"  HREF="#" TITLE="Container Lineage" ONCLICK="OpenDialog('/cheminv/gui/LineageTree.asp?refresh=1&assetType=container&selectedID=<%=ContainerID%>', 'LineageDiag', 5);">Container Lineage</a></td>
				</tr>
			</Table>
		</td>
	</tr>
		...
		<td valign="top">
			...
			<tr><!-- Header Row -->
				...
				<tr>
					...
					<!-- Row 1 Col 2-->
					<%
					strAnchor = "<a CLASS=""MenuLink"" href=""/cheminv/gui/ViewRegDetails.asp?reg_number=" & RegNumber & """ target=""_blank"">"
					Response.write(ShowField2("RegBatchID:", "RegBatchID", 15, "", strAnchor))
					%>
					
				</tr>
				<tr>
					<!-- Row 2 Col 1-->
					<%=ShowField("CAS:", "RegCAS", 15, "RegCAS")%>
					<!-- Row 2 Col 2-->
				...
				<tr>
					<!-- Row 5 Col 1-->
					<%=ShowField("Purity:", "RegPurity", 15, "")%>
					<!-- Row 5 Col 2-->
					<%=ShowField("Synonyms:", "RegSynonym", 15, "")%>
				</tr>
			</table>
		</td>
	</tr>
...
<%
	...
	if Application("ShowRequestSample") then
		...
		Cmd.Properties ("PLSQLRSet") = FALSE
		If (RS.EOF AND RS.BOF) then
			Response.Write ("<TR><TD align=center colspan=6><span class=""GUIFeedback"">No sample requests found for this container.</Span></TD></tr>")
		Else
%>
		<center><table border=1>
		<Tr>
