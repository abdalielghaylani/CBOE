...
<table border="0" cellspacing="0" cellpadding="2" width="600" align="left">
	<tr>
		...
		<td align="right" valign="top">
			<a class="MenuLink" target="_top" href="ManageRequests_frset.asp?RequestType=PENDING&amp;filter=true" <%=disable1%>>Pending Requests</a> |
			<a class="MenuLink" target="_top" href="ManageRequests_frset.asp?RequestType=CLOSED&amp;filter=true" <%=disable2%>>Closed Requests</a>
		</td>
	</tr>
</table>
<br clear="all">
