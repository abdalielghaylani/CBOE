...
<%
	...
	if cint(RS("CompoundCount")) = 1 then
		...
		Session("wReg_Batch_ID") = RS("reg_batch_id")
		fieldList = fieldList & "wCOMPOUND_ID_FK,wREG_ID_FK,wBATCH_NUMBER_FK,wREG_BATCH_ID,"
	end if
...
Sub setWellRegAttributes()
	...
	Session("wRegBase64") = Session("RegBase64")
