...
<table border="0">
	...
	<%else%>
		...
		<tr>
			...
			<td><input TYPE="text" SIZE="20" Maxlength="50" NAME="AllContainerIDs" STYLE="background-color:#d3d3d3;" VALUE="<%=(ContainerID & "," & MergeContainerIDs)%>" READONLY></td>
		</tr>
		<tr>
			<td align="right" valign="top" nowrap>New Quantity Remaining:</td>
			<td><input TYPE="text" SIZE="20" Maxlength="50" NAME="NewQtyRemaining" STYLE="background-color:#d3d3d3;" VALUE="<%=TotalQty%>" READONLY></td>
		</tr>
