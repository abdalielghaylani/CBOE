	...
	if len(Session(field)) > 0 then
		if InStr("iContainerIDs,multiscan,multiSelect,fieldList,AutoGen", field) = 0 then
			Select case lcase(field)
				'number fields
				case "pllocation_id_fk","plplate_pype_id_fk","plqty_unit_fk","plqty_initial","plqty_remaining","plstatus_id_fk","plsupplier_shipment_number","pllibrary_id_fk","plft_cycles","plweight_unit_fk","plweight","plconc_unit_fk","plconcentration","plsolvent_id_fk","plsolvent_volume","plsolvent_volume_unit_id_fk","plplate_type_id_fk","plsolution_volume"'"plnumcopies",
					ValuePairs = ValuePairs & mid(field,3) & "%3D" & Session(field) & "::"
				'text fields
				case "plplate_name","plsupplier_barcode","plsupplier_shipment_code","plfield_1","plfield_2","plfield_3","plfield_4","plfield_5","plgroup_name","plplate_barcode","plsupplier"
				...
				'well number field
				case "plwqty_remaining","plwqty_unit_fk","plwweight","plwweight_unit_fk","plwconcentration","plwconc_unit_fk","plwmolar_amount","plwmolar_unit_fk","plwsolvent_id_fk","plwsolvent_volume","plwsolvent_volume_unit_id_fk","plwsolution_volume"
...
if len(Request("iwQty_Remaining") & Request("iwWeight") & Request("iwConcentration") & Request("iwMolar_amount") & Request("iwSolvent_ID_FK") & Request("iwSolvent_Volume") & Request("iwSolution_Volume")) > 0 then
