...
GetDataFromOpener = Request("GetDataFromOpener")
...
If not bNewAddress then
	...
	if isEmpty(ContactName) then ContactName = ""
	if isEmpty(Address1) then Address1 = ""
	if isEmpty(Address2) then Address2 = ""
	if isEmpty(Address3) then Address3 = ""
	if isEmpty(Address4) then Address4 = ""
	if isEmpty(City) then City = ""
	if isEmpty(StateIDFK) then StateIDFK = ""
	if isEmpty(CountryIDFK) then CountryIDFK = ""
	if isEmpty(ZIP) then ZIP = ""
	if isEmpty(FAX) then FAX = ""
	if isEmpty(Phone) then Phone = ""
	if isEmpty(Email) then Email = ""
end if
...
<%if GetDataFromOpener = "true" then%>
<script language="JavaScript">
	document.form1.Address1.value = opener.document.form1.Address1.value;
	document.form1.Address2.value = opener.document.form1.Address2.value;
	document.form1.Address3.value = opener.document.form1.Address3.value;
	document.form1.Address4.value = opener.document.form1.Address4.value;
	document.form1.City.value = opener.document.form1.City.value;
	document.form1.StateIDFK.value = opener.document.form1.StateIDFK.value;
	document.form1.ZIP.value = opener.document.form1.ZIP.value;
	document.form1.FAX.value = opener.document.form1.Fax.value;
	document.form1.Phone.value = opener.document.form1.Phone.value;
	document.form1.Email.value = opener.document.form1.Email.value;
</script>
<%end if%>
</body>
</html>