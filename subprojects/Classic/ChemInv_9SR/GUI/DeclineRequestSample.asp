...
<table border="0">
	...
	<TR>
		...
		<TD ALIGN="left" width="400"><INPUT TYPE="checkbox" checked NAME="EnterDeclineReason<%=i%>" VALUE="" ONCLICK="ShowHide(<%=i%>);">Enter Reason for Decline</TD>
	</TR>
	<%end if%>
	<tr>
	...
	<TABLE BORDER="0">
		<tr>
			...
			<td valign="top">
				<textarea rows="5" cols="32" name="DeclineReasonList" wrap="hard">&nbsp;<%=RS("decline_reason")%></textarea>
			</td>
		</tr>
	...
	<%else%>
		<tr>
			<td colspan="2" align="right"><a HREF="#" onclick="history.back();"><img SRC="../graphics/btn_back_61.gif" border="0" WIDTH="61" HEIGHT="21"></a><a HREF="#" onclick="document.form1.submit(); return false;"><input type="image" SRC="../graphics/btn_next_61.gif" border="0" WIDTH="61" HEIGHT="21"></a></td>
		</tr>	
	<%end if%>
</table>	
</form>
