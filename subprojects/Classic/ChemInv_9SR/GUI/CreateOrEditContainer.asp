...
%>
	<tr height="25">
		...
		<td colspan="3">
			&nbsp;<%=GetBarcodeIcon()%>&nbsp;<%ShowLocationPicker "document.form1", "iLocationID", "lpLocationBarCode", "lpLocationName", 10, 49, false%> 
		</td>
	</tr>
	<tr height="25">
		<td align="right" valign="top" nowrap width="150">
	...
	<tr height="25">
		...
		<%if Application("RegServerName") <> "NULL" then%>
			<td width="200" align="right">Compound ID:</td><td><input type="text" Size="15" name="iCompoundID" value="<%=CompoundID%>" onchange="validateCompoundID(this);//if(IsValidCompoundID(this.value, true)==1){NewCompoundID.value= this.value; RegBatchID.value=''; iRegID.value=''; iBatchNumber.value='';}else{this.value = '';}"></td>
		<%else%>
...
-->
	...
	<%Else%>
	<tr height="25">
		<td align="right" valign="top" nowrap width="150"><span class="required">Container ID:</span></td><td>&nbsp;<%=GetBarcodeIcon()%>&nbsp;<input type="text" name="iBarcode" size="15" value="<%=Barcode%>"></td>
	<%End if%>
	<td></td><td align="right"> 
				...
				<%if NOT isEdit then%>
					<a HREF="#" onclick="ValidateContainer('Create'); return false;"><img SRC="../graphics/ok_dialog_btn.gif" border="0" WIDTH="61" HEIGHT="21"></a>
				<%Else%>
					<a HREF="#" onclick="ValidateContainer('Edit'); return false;"><img SRC="../graphics/ok_dialog_btn.gif" border="0" WIDTH="61" HEIGHT="21"></a>
				<%End if%>		
		</td>
	</tr>
<%	
			...
			<table border="1">
				<tr>
					...
					<td>
						...
						Base64DecodeDirect "invreg", "base_form_group", RegBase64, "Structures.BASE64_CDX", cpdID, cpdID, specifier, 130%>
					</td>
				</tr>
			</table>
		</td>
