	...
	<table bgcolor="#C0C0C0" border="0">
		...
		<tr>
			<td colspan="3" align="right">
				<input type="button" value="Cancel" onClick="document.location.href='columnpicker2.asp?ArrayID=<%=ArrayID%>&amp;showPlates=<%=showPlates%>&amp;showWells=<%=showWells%>'">
				<input type="button" value="Save" onClick="document.forms[0].SaveColDef.value='true'; if(FillColWidths()){ submit(); } else { return false; }" id="button3" name="button3">
			</td>
		</tr>
	</table>
<%Else%>
	<table bgcolor="#C0C0C0">
		...
		<tr>
			<td align="left" colspan="4"><%=entity%>s per page:&nbsp;<input type="text" size="4" name="PageSize" value="<%=Session("ScreenReportPageSize" & ArrayID)%>"></td>
		</tr>
		<tr>
