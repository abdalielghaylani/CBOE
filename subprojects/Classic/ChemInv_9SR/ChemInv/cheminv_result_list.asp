...
%>
				<td align="center" valign="top" width="194" nowrap>
					...
					<%ShowResult dbkey, formgroup, BaseRS,"inv_compounds.BASE64_CDX", "Base64CDX", 185, 130'ShowResult dbkey, formgroup, BaseRS,"inv_compounds.BASE64_CDX", "Base64CDX", 185, 130%>
					<div align="center">
						<font size="1" face="Arial">
							<strong>
								<br>Compound ID: 
