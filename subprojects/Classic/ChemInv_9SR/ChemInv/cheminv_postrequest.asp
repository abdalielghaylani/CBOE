...
<p></font><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx&amp;dataaction=search_no_gui</font></p>
...
<form id="form2" name="form2" METHOD="Post" ACTION="<%=Application("ActionForm" & "chemacx")%>?dbname=chemacx&amp;dataaction=search_no_gui">
  <table border="
      ...
      <td><table>
        <tr>
          <td>&nbsp; EXAMPLE from a postrequest form.&nbsp; <table border="1">
            <tr>
              <td><embed src="<%=Application("TempFileDirectoryHTTP" & dbkey) & "mt.cdx"%>" border="3" width="253" height="151" type="chemical/x-cdx" name="CDP" id="1"></td>
              <td><table border="1">
                <tr>
...
<p>
<applet align="baseline" code="camsoft.cdp.CDPHelperAppSimple.class" height="0" id="Applet1" name="CDPHelper" width="10">
...
<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=search_no_gui&amp;struc_search_type=exact&amp;return_field=Substance.CsNum&amp;Synonym.Name=ben</font></p>
...
<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=structure_fields</font></p>

<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=formula_fields</font></p>

<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=molweight_fields</font></p>

<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=base_table</font></p>

<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=molecule_table</font></p>

<p><font COLOR="#ff0000" size="3">ACTION=&quot;</font><font COLOR="#0000ff" size="3"><%=Application("ActionForm" & "chemacx")%>?dbname=chemacx</font><font size="3" color="#0000FF">&amp;dataaction=get_info&amp;info_type=rel_fields</font></p>
