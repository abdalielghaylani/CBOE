	...
	if nlTransform = "" then
		...
		for each oNode in nlTransforms
			...
			if not bError then
				...
				QueryString = QueryString & "&PlateTypeIDList=" & "5"
				QueryString = QueryString & "&AmtList=" & "0"
				QueryString = QueryString & "&AmtUnitIDList=" & "4"
				QueryString = QueryString & "&AmtType=" & "SourceVolumeTaken"
				QueryString = QueryString & "&SolventIDList=" & ""
				QueryString = QueryString & "&SolventVolumeList=" & ""
				QueryString = QueryString & "&SolventVolumeUnitIDList=" & ""
				QueryString = QueryString & "&LocationIDList=" & locationID
				QueryString = QueryString & "&NumTargetPlates=" & numCopies
				QueryString = QueryString & "&TargetVolumeList=" & ""
				QueryString = QueryString & "&TargetVolumeUnitIDList=" & ""
