...
if  plugin_value  then
	...
	zoomFunction = "ACX_getStrucZoomBtn('Substance.Structure'," & BaseID & ",600,450)"
end if
%>
				<td align="center" valign="top" width="194" nowrap>
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td>
								<script language="JavaScript">getFormViewBtn("details.gif","invacx_substanceselect_form.asp","<%=BaseActualIndex%>", "edit")</script></td>
