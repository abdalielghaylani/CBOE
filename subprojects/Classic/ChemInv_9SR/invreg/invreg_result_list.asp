	...
	<head>
		...
		<script language="JavaScript">
			...
			function openSynWindow(leftPos,topPos,CompoundID,recordNum){
				...
				SynWindow = window.open("Synlookup.asp?RegID=" + CompoundID + "&recordNum=" + recordNum,"Synonyms_Window",attribs);
			}
...
if  plugin_value  then
	displayType = "cdx"
	zoomFunction = "ACX_getStrucZoomBtn('Structures.BASE64_CDX'," & cpdDBCounter & ", 0, 0, 'zoom_blue_btn.gif')"
else
	displayType = "SizedGif"
	zoomFunction = "ACX_getStrucZoomBtn('Structures.BASE64_CDX'," & cpdDBCounter & ",500,450,'zoom_blue_btn.gif')"
end if
					...
					<div align="center">
						<font size="1" face="Arial">
							<strong>
								...
								<a target="_new" href="http://<%=Application("RegServerName")%>/chem_reg/default.asp?formgroup=base_form_group&amp;dbname=reg&amp;dataaction=query_string&amp;full_field_name=Reg_Numbers.Reg_ID&amp;field_value=<%=Reg_ID%>&amp;PostRelay=1"><%=baseRegNumber%></a>
							</strong>
							<br>
						</font>
					</div>
