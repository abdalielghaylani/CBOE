				...
				<td align="right" valign="top">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td align="left"><a href="/CBOEHelp/CBOEContextHelp/ChemACX Webhelp/Default.htm" onclick="ACXInstructions();return false"><img src="<%=Application("NavButtonGifPath")%>help.gif" width="46" height="16" alt border="0"></a></td>
						</tr>
						<%end if%>
						<tr>
