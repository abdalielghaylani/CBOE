...
In addition to the simple textual search above, ChemACX is <strong>structure searchable</strong>: you may draw your desired structure or seach by name, synonym, formula, or several other fields using the <a href="<%=serverName%>/chemacx/inputtoggle.asp?formgroup=base_form_group&dbname=chemacx">advanced substructure query form</a>.
</p>
<p>
