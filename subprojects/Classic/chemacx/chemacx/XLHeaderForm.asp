...
<a href="Next" onclick="SubmitForm();return false"><img src="<%=Application("NavButtonGifPath")%>export_excel_btn.gif" alt="Export to Excel Template" border="0"></a>
</form> 
</div>
</body>
</html>
