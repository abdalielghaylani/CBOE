			...
			While Not SubstanceRS.EOF
				...
				if sStructType = "cdx" OR sStructType = "gif" OR sStructType = "base64cdx" OR sStructType = "mol" then
					...
					if sStructType = "cdx" OR sStructType = "gif" then	
						sStructURL = Application("SERVER_TYPE") & Request.ServerVariables("HTTP_HOST") & "/ChemACX/chemacx/chemacx_action.asp?dbname=chemacx&dataaction=get_structure&formgroup=base_form_group&Table=substance&Field=structure&DisplayType=" & sStructType & "&StrucID=" & SubstanceRS("CsNum") 
