...
StartupLocation = "/biosar_browser/biosar_browser/mainpage.asp?bypass_ini=true&dbname=biosar_browser&formgroup=base_form_group&refreshPath=/biosar_browser/biosar_browser/mainpage.asp"&_
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top" align="left">
			<img border="0" src="/cfserverasp/source/graphics/cnco.gif"><img border="0" src="/<%=Application("appkey")%>/graphics/<%=Application("appkey")%>_frontpage_bnr.gif">
		</td>
...
<form name="UserLogin" action="/<%=Application("AppKey")%>/login.asp?dbname=cheminv&amp;formgroup=base_form_group&amp;perform_validate=1&amp;forceManualLogin=<%=forceManualLogin%>" method="post" )>
<div align="center">
			...
			<table border="0" width="47%">
				<tr>
					<td colspan="2" align="right">
						<input Type="Image" src="graphics/login_btn.gif" border="0" id=Image1 name=Image1>
						<%
