...
namespace PerkinElmer.COE.Inventory.API.Tests.Controllers
{
    ...
    public class ContainerControllerTest : BaseControllerTest
    {
        ...
        public async Task GetContainerById_ShouldReturnContainerWithAllData()
        {
            ...
            Assert.AreEqual(containerTest.ContainerName, content.ContainerName);
            Assert.AreEqual(containerTest.ContainerType.Name, content.ContainerType.Name);
            Assert.IsNotNull(containerTest.QuantityMax);
            Assert.AreEqual(containerTest.QuantityMax.Value, content.QuantityMax.Value);
            Assert.AreEqual(containerTest.QuantityMax.Unit, content.QuantityMax.Unit);
