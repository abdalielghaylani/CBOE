...
DEFINE privTableName = CBV_PRIVILEGES
DEFINE min_priv = CBV_SEARCH
DEFINE UserRole = CBV_USER
DEFINE AdminRole = CBV_ADMIN
DEFINE AppName = 'ChemBioViz Client'
DEFINE COEIdentifier = 'ChemBioViz Client'
DEFINE AdminTestUser = CBVADMIN
DEFINE UserTestUser = CBVUSER
