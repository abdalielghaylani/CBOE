...
namespace CambridgeSoft.COE.Framework.COEConfigurationService
{
    ...
    public class COEConfiguration
    {
        ...
        #region GetAllInstancesInConfig
        public static List<InstanceData> GetAllInstancesInConfig()
        {
            try
            {
                return DataPortal.Execute<GetAllInstancesInConfigCommand>(new GetAllInstancesInConfigCommand()).InstancesList;
            }
            catch (Exception)
            {
        ...
        [Serializable]
        internal class GetAllInstancesInConfigCommand : CommandBase
        {
            private List<InstanceData> instancesList;

            protected override void DataPortal_Execute()
            {
                instancesList = ConfigurationUtilities.GetAllInstancesInConfig();
            }

            public List<InstanceData> InstancesList { get { return instancesList; } }
        }
        #endregion

        #region GetInstanceData
        public static InstanceData GetInstanceData(string instanceName)
        {
            try
            {
                return DataPortal.Execute<GetInstanceInConfigCommand>(new GetInstanceInConfigCommand(instanceName)).Instance;
            }
            catch (Exception)
            {
        ...
        [Serializable]
        internal class GetInstanceInConfigCommand : CommandBase
        {
            private InstanceData _instance;
            private string _instanceName;

            public GetInstanceInConfigCommand(string instanceName)
            {
            ...
            protected override void DataPortal_Execute()
            {
                _instance = ConfigurationUtilities.GetInstanceData(_instanceName);
            }

            public InstanceData Instance { get { return _instance; } }
        }
        #endregion

        #region GetInstanceNameByDatabaseName
        public static string GetInstanceNameByDatabaseName(string database)
        {
            try
            {
                return DataPortal.Execute<GetInstanceNameByDatabaseNameCommand>(new GetInstanceNameByDatabaseNameCommand(database)).InstanceName;
            }
            catch (Exception)
            {
        ...
        [Serializable]
        internal class GetInstanceNameByDatabaseNameCommand : CommandBase
        {
            private string _instanceName;
            private string _database;

            public GetInstanceNameByDatabaseNameCommand(string database)
            {
                _database = database;
            }
            ...
            protected override void DataPortal_Execute()
            {
                _instanceName = ConfigurationUtilities.GetInstanceNameByDatabaseName(_database);
            }
        ...
        #region GetAllDBMSTypesInConfig
        public static List<DBMSTypeData> GetAllDBMSTypesInConfig()
        {
            try
            {
                return DataPortal.Execute<GetAllDBMSTypesInConfigCommand>(new GetAllDBMSTypesInConfigCommand()).DBMSTypeList;
            }
            catch (Exception)
            {
        ...
        [Serializable]
        internal class GetAllDBMSTypesInConfigCommand : CommandBase
        {
            private List<DBMSTypeData> dbmsTypeList;

            protected override void DataPortal_Execute()
            {
                dbmsTypeList = ConfigurationUtilities.GetAllDBMSTypesInConfig();
            }

            public List<DBMSTypeData> DBMSTypeList { get { return dbmsTypeList; } }
        }
        #endregion
    }
}
