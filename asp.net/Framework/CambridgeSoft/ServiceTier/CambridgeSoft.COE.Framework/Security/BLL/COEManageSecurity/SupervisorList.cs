...
namespace CambridgeSoft.COE.Framework.COESecurityService
{
      ...
      NameValueListBase<int, string>
    {
        ...
        private static SupervisorList _list;
        ...
        /// </summary>
        public static SupervisorList GetList()
        {
            SetDatabaseName();
            _list = DataPortal.Fetch<SupervisorList>
              (new Criteria(typeof(SupervisorList)));
            return _list;
        }
        ...
        private void DataPortal_Fetch(Criteria criteria)
        {
            ...
            try
            {
                ...
                // Coverity Fix CID - 11648
                if (_coeDAL != null)
                {
                    using (SafeDataReader dr = _coeDAL.GetPersonList())
                    {
                        FetchObject(dr);
                    }
                }
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            while (dr.Read())
            {
                this.Add(new NameValuePair(dr.GetInt16("PERSON_ID"), dr.GetString("DISPLAYTEXT")));
            }
            IsReadOnly = true;
        }
