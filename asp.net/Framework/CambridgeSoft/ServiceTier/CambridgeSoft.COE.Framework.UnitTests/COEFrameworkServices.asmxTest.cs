...
using System.Data;
using System.IO;
using CambridgeSoft.COE.Framework.UnitTests.FrameworkProxy;
...
namespace CambridgeSoft.COE.Framework.UnitTests
{
    ...
    {
        private static string _pathToDataviewXmls = Utilities.GetProjectBasePath("CambridgeSoft.COE.Framework.UnitTests") + @"\TestXML";
        private static string _pathToSearchXmls = Utilities.GetProjectBasePath("CambridgeSoft.COE.Framework.UnitTests") + @"\Search Tests\COESearchTest XML\OrderedSearchTestXml";
