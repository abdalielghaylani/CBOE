...
{
    class CSBR161660 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            #endregion
            #region Struct_Comments
            coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1']/COE:viewMode";
            InnerXml = XmlCode.ReadonlyStructureComments.Replace("\r\n", "").Trim();
            NewElementAttributes = "[@name='Structure ID']";
            InsertAttributes("name", "Structure ID");
            status = ManipulateNode(coeFormPath, "COE:formElement", "COE:formElement[@name='Identifiers']", "COE:formElement[@name='MW']");
            messages.Add(status);
            Reset();
            #endregion
            #endregion
            if (!_errorsInPatch)
                messages.Add("CSBR161660 Workflow was successfully fixed.");
            else
                messages.Add("CSBR161660 Workflow  was fixed with partial update.");
            return messages;
        }
            ...
            try
            {
                ...
                else
                {
                    if (InnerText != string.Empty)
                        ...
                        _newNode.InnerXml = InnerXml;
                    return "Form[4013]: " + _newElementPath + " was updated.";
                }
            }
            catch (Exception ex)
