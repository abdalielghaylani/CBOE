...
namespace CambridgeSoft.COE.Framework.COEDatabasePublishingService.UnitTests
{
    ...
    public class COEDatabaseBOTest
    {
        ...
        public static void MyClassInitialize()
        {
            ...
            defaultInstanceName = mainInstance.Name;
            CambridgeSoft.COE.Framework.NUnitTests.Helpers.Authentication.Logon();
        }
        ...
        {
            CambridgeSoft.COE.Framework.NUnitTests.Helpers.Authentication.Logoff();
        }
