...
function igwnb_initialize(nBarId,tBarId,tbUID,props,events,oItemArray,oTbPropArray,oTbEventArray)
{
	igtbar_initialize.apply(this,[tBarId,tbUID,oTbPropArray,oItemArray,oTbEventArray]);
	...
	if ((!ig_shared.IsIE || ig_shared.IsIE7) && this.Element.style.height == "1px" ) 
		this.Element.style.height = "";
	
	var items=oItemArray;
	if(items)
	{
