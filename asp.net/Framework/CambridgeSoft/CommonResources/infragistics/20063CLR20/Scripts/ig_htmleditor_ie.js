...
//js-version 6.07
//vs
function iged_init(ids,p1,p2,p3,p4)
{
	ids=ids.split("|");
	var id=ids[0];
	var elem=iged_el(ids[1]),ta=iged_el(id+"_t_a"),tb=iged_el(ids[3]);
	var o=new iged_new(id,ta,tb,p1,p2,p3,p4);
	...
	o._txt=function(txt,paste)
	{
		...
		var x,ii,e=this._elem,vv=new Array(),n="<a ",nx=" href",q="_$$_",t=txt.toLowerCase();
		while(true)
		{
			i=t.length-1;
			while(i>2)
			{
				if((ii=t.lastIndexOf(n,i))>=0)if((x=this._attrVal(t,ii+1,nx))!=null)
				{
			...
			if(n.length>3)break;
			n="<img ";nx=" src";t=txt.toLowerCase();
		}
