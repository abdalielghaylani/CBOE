<!--
 ...
 |
 | Modified javascript to make it Firefox and IE compatible by Facundo Galdeano (fgaldeano@xxxxxxxxxxxx)
 |
 +-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
         ...
         <HEAD>
            <SCRIPT>
               <xsl:comment><![CDATA[
                  function f(e){
                     if (e.className=="ci") {
                       if (e.firstChild.innerHTML.indexOf("\n")>0) fix(e,"cb");
                     }
                     if (e.className=="di") {
                       if (e.firstChild.innerHTML.indexOf("\n")>0) fix(e,"db");
                     } e.id="";
            ...
            <STYLE>
              BODY {font:x-small 'Verdana'; margin-right:1.5em}
                ...
                .e  {margin-left:1em; text-indent:-1em; margin-right:1em; word-wrap: break-word; }
   ...
   <xsl:template match="comment()">
      <DIV class="k">
         <SPAN>
            <A STYLE="visibility:hidden" class="b" onclick="cl(this)" 
               onfocus="h()">-</A>
            <SPAN class="m">
               <xsl:text>&lt;!--</xsl:text>
            </SPAN>
         ...
         <SCRIPT>f(document.getElementById('clean'));</SCRIPT>
      </DIV>
   </xsl:template>
   ...
   <xsl:template match="*[node()]">
      <DIV class="e">
         <DIV class="c">
            <A class="b" href="#" onclick="cl(this);" onfocus="h()">-</A>
            <SPAN class="m">&lt;</SPAN>
            <SPAN>
               <xsl:attribute name="class">
                  <xsl:if test="xsl:*">
