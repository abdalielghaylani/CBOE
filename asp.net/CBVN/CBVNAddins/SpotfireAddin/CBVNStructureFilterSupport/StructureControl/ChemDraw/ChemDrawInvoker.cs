...
namespace CBVNStructureFilterSupport.ChemDraw
{
    ...
    internal class ChemDrawInvoker
    {
        ...
        /// Loger
        /// </summary>
        private static readonly ILog Log = LogManager.GetLogger(typeof(ChemDrawInvoker));
        ...
        /// <summary>
        /// Launch OOP process CBVNStructureControlHost.exe to host one structure control
        /// </summary>
        /// <returns></returns>
