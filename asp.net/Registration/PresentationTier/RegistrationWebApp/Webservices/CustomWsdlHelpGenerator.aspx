                      ...
                      <form target="_blank" action='<%#TryPostUrl == null ? "" : TryPostUrl.AbsoluteUri%>' method="POST">                      
                        ...
                        <itemtemplate>
                          <tr>
                            <td class="frmText" style="color: #000000; font-weight: normal;"><%# XmlConvert.DecodeName(((MessagePart)Container.DataItem).Name) %>:</td>
                            <td>
                                <!-- DGB modified to support text area
                                <input class="frmInput" type="text" size="50" name="<%# XmlConvert.DecodeName(((MessagePart)Container.DataItem).Name) %>">-->
								<textarea class="frmInput" style="width: 600px; height: 60px;" name="<%# XmlConvert.DecodeName(((MessagePart)Container.DataItem).Name) %>"></textarea>
                            </td>
                          </tr>
                        </itemtemplate>                        
