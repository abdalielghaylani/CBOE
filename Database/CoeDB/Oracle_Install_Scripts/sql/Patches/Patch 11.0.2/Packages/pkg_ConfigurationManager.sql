...
AS
    ...
    PROCEDURE CreateOrUpdateParameter(ADescription IN VARCHAR2, AParameterGroup IN VARCHAR2, AParamName IN VARCHAR2, AParamValue IN VARCHAR2, AParamDescription IN VARCHAR2, AControlType IN VARCHAR2, AAllowedValues IN VARCHAR2, AIsAdmin IN VARCHAR2, AProcessorClass IN VARCHAR2:=NULL);
...
IS
    ...
    FUNCTION NewParameterNode(AParamName IN VARCHAR2, AParamValue IN VARCHAR2, AParamDescription IN VARCHAR2, AControlType IN VARCHAR2, AAllowedValues IN VARCHAR2, AIsAdmin IN VARCHAR2, AProcessorClass IN VARCHAR2:=NULL) RETURN xmlType IS
      LNewParam XMLTYPE;
      msg VARCHAR(32000);
    ...
    BEGIN
        ...
        SELECT XMLELEMENT("add",
               XMLATTRIBUTES(  AParamName as "name",
                              ...
                              AIsAdmin as "isAdmin",
                              AProcessorClass as "processorClass")) INTO LNewParam
        FROM dual;
    RETURN  LNewParam;
    ...
    PROCEDURE UpdateParameterNode(ADescription IN VARCHAR2, AParameterGroup IN VARCHAR2, AParamName IN VARCHAR2, AParamValue IN VARCHAR2, AParamDescription IN VARCHAR2, AControlType IN VARCHAR2, AAllowedValues IN VARCHAR2, AIsAdmin IN VARCHAR2, AProcessorClass IN VARCHAR2:=NULL) IS
      LNewParam XMLTYPE;
      LParameterPath VARCHAR2(2000);
      msg VARCHAR(32000);
    ...
    BEGIN
        ...
        -- Create the xml node for new parameter
        LNewParam := NewParameterNode(AParamName, LParamValue, LParamDescription, LControlType, LAllowedValues, LIsAdmin, LProcessorClass);
    ...
    -- AParameterGroup is the group where the parameter should be added
    -- The rest of the parameters correspond to the attributes of the entry in the configuration xml
    PROCEDURE CreateParameter(ADescription IN VARCHAR2, AParameterGroup IN VARCHAR2, AParamName IN VARCHAR2, AParamValue IN VARCHAR2, AParamDescription IN VARCHAR2, AControlType IN VARCHAR2, AAllowedValues IN VARCHAR2, AIsAdmin IN VARCHAR2, AProcessorClass IN VARCHAR2:=NULL) IS
      LNewParam XMLTYPE;
    ...
    BEGIN
        -- Create the xml node for new parameter
        LNewParam := NewParameterNode(AParamName, AParamValue, AParamDescription, AControlType, AAllowedValues, AIsAdmin, AProcessorClass);
    ...
    -- AParameterGroup is the group where the parameter should be added
    -- The rest of the parameters correspond to the attributes of the entry in the configuration xml
    PROCEDURE CreateOrUpdateParameter(ADescription IN VARCHAR2, AParameterGroup IN VARCHAR2, AParamName IN VARCHAR2, AParamValue IN VARCHAR2, AParamDescription IN VARCHAR2, AControlType IN VARCHAR2, AAllowedValues IN VARCHAR2, AIsAdmin IN VARCHAR2, AProcessorClass IN VARCHAR2) IS
      LParam XMLTYPE;
      msg VARCHAR(32000);
    BEGIN
        LParam:= GetParameter(ADescription, AParameterGroup, AParamName);
        if LParam is null then
          CreateParameter(ADescription, AParameterGroup, AParamName, AParamValue, AParamDescription, AControlType, AAllowedValues, AIsAdmin, AProcessorClass);
        else
          UpdateParameterNode(ADescription, AParameterGroup, AParamName, AParamValue, AParamDescription, AControlType, AAllowedValues, AIsAdmin, AProcessorClass);
        end if;
    EXCEPTION
        WHEN OTHERS THEN
        BEGIN
