<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest = "false" CodeFile="COEFormServiceTest.aspx.cs" Inherits="DataViewService" %>
...
<head runat="server">
    <title>COEFormService Sample Application</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <table style="width: 454px; height: 18px;">
            <tr>
        ...
        <igtab:UltraWebTab ID="UltraWebTab1" runat="server" AutoPostBack="True" BorderColor="White"
            ...
            Font-Size="8pt" Height="1px" OnTabClick="UltraWebTab1_TabClick" ThreeDEffect="False"
            Width="91%" SelectedTab="2">
        ...
        <table style="width: 654px; height: 352px">
            <tr>
                <td style="width: 90px">
                    Form Group</td>
                <td style="width: 138px">
                    &nbsp;<asp:TextBox ID="txtFormGroup" runat="server" Width="186px" ReadOnly="True"></asp:TextBox><asp:RangeValidator
                        ID="RangeValidator1" runat="server" ControlToValidate="txtFormGroup" ErrorMessage="Must be an Integer"
                        MaximumValue="999999999999" MinimumValue="0" Width="144px"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 90px">
            ...
            <tr>
                ...
                <td style="width: 138px; height: 66px;">
                    <asp:TextBox ID="txtCOEForm" runat="server" Height="48px" TextMode="MultiLine"
