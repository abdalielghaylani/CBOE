...
{
    /// <summary>
    /// Patch to update scientist frop down with logged in user id.
    /// </summary>
    class CSBR160789 : BugFixBaseCommand
    {
        ...
        public override List<string> Fix(List<System.Xml.XmlDocument> forms, List<System.Xml.XmlDocument> dataviews, List<System.Xml.XmlDocument> configurations, System.Xml.XmlDocument objectConfig, System.Xml.XmlDocument frameworkConfig)
        {
            ...
            {
                #region Update loggedin id
                coeFormPath = "//COE:detailsForm[@id='0']/COE:coeForms/COE:coeForm[@id='1002']/" + mode + "/COE:formElement[@name='SCIENTIST_ID']";
                InnerText = "&&loggedInUser";
                status = ManipulateNode(coeFormPath, "defaultValue", "", "");
                messages.Add(status);
                Reset();
                #endregion
            ...
            if (!_errorsInPatch)
                messages.Add("CSBR160789 Workflow was successfully fixed.");
            else
                messages.Add("CSBR160789 Workflow  was fixed with partial update.");
            return messages;
        }
            ...
            try
            {
                ...
                else
                {
                    if (InnerText != string.Empty)
                        ...
                        _newNode.InnerXml = InnerXml;
                    return "Form[4010]: " + _newElementPath + " was updated.";
                }
            }
            catch (Exception ex)
