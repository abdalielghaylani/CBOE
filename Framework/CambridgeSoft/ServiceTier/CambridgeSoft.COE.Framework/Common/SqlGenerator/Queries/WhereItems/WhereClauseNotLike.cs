...
namespace CambridgeSoft.COE.Framework.Common.SqlGenerator.Queries.WhereItems
{
    /// <summary>
    /// <para>
    /// This class implements a NOT LIKE comparison operator in a  SQL where clause.
    /// </para>
    /// <para>
    /// <b>Input</b>
    /// </para>
    /// <para>
    /// The WhereClauseNotLike class requires the following members to be initialized to the desired value:
    /// </para>
    /// <list type="bullet">
    ...
    /// </para>
    /// <para>
    /// Not Like operator is only supported on TextCriterias.
    ...
    /// 	&lt;textCriteria operator='NOTLIKE' trim='BOTH' caseSensitive='NO'&gt;	C1CCCCC1  
    /// 	&lt;/textCriteria&gt;
    ...
    /// </para>
    /// <para>
    /// [AND] (LOWER(Structure) NOT LIKE :0);
    /// </para>
    /// <para>
    ...
    /// </list>
    /// </summary>
    public class WhereClauseNotLike : WhereClauseBinaryOperation
    {
        #region Properties
        /// <summary>
        /// Where will be applied the wildcard. For instance if left is selected the generated not like will
        /// be in the form: FieldName Not Like('%FieldValue')
        /// </summary>
        ...
        /// <summary>
        /// Determines if the not like must be a Full word search.
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Encapsulates different sintaxis for the underlying RDBMS. If the not like operation will be case insensitive,
        ...
        /// <returns>A string for the underlying RDBMS, in the form of: FieldName Not Like('%FieldValue%')</returns>
        protected override string GetDependantString(DBMSType dataBaseType, List<Value> values)
        {
            if (TypesConversor.GetAbstractType(this.dataField.FieldType) != COEDataView.AbstractTypes.Text)
                throw new UnsupportedDataTypeException(Resources.InvalidTypeInLike);
            ...
            if (fullWordSearch)
            {
                ...
                builder.Append(leftOperator + " NOT LIKE '% ' || ");
                ...
                builder.Append(" OR " + leftOperator + " NOT LIKE ");
        ...
        {
            Regex multiWildCard = new Regex(@"(?<!(\\))\*");
            return multiWildCard.Replace(value, "%").Replace(@"\*", "*");
        }
