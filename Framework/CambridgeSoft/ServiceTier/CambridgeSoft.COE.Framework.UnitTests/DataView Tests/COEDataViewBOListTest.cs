...
namespace CambridgeSoft.COE.Framework.COEDataViewService.UnitTests
{
    ...
    {
        #region Variables
        private string _pathToXmls = Utilities.GetProjectBasePath("CambridgeSoft.COE.Framework.UnitTests") + @"\DataView Tests\COEDataViewTestXML";
        ...
        public void GetDataViewBOByID_Test()
        {
            ...
            PrivateObject thePrivateObject = new PrivateObject(typeof(COEDataViewBOList));
